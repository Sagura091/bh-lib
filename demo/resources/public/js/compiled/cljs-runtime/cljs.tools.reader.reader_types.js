...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_22413 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_22413(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_22414 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_22414(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22415 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22415(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22416 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22416(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22417 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22417(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22418 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22418(reader);
}
});
...
var G__22429 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__22430 = s.append(c);
c = G__22429;
s = G__22430;
continue;
}
