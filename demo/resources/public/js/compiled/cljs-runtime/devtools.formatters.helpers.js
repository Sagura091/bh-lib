...
var G__21900 = devtools.prefs.pref(v);
v = G__21900;
continue;
} else {
return v;
...
var and__4251__auto__ = cljs.core.not(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__4251__auto__){
var and__4251__auto____$1 = (!(cljs.core.var_QMARK_(value)));
...
}catch (e21669){var _e__19327__auto__ = e21669;
return false;
}})();
...
}catch (e21672){var _e__19327__auto__ = e21672;
return false;
}})();
...
}catch (e21676){var _e__19327__auto__ = e21676;
return false;
}}
}
});
...
var and__4251__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_(f)));
if(and__4251__auto____$1){
...
var or__4253__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
var and__4251__auto__ = (function (){var or__4253__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
var vec__21733 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21733,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21733,(1),null);
...
var and__4251__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__4251__auto__)){
...
return cljs.core.some((function (p1__21762_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21762_SHARP_);
}),template);
});
...
var temp__5751__auto__ = devtools.formatters.helpers.pref(pref_key);
if(cljs.core.truth_(temp__5751__auto__)){
