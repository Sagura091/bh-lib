goog.provide('bh_ui.utils.bounding_box');
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"bh-ui.utils.bounding-box",null,5,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["bh-ui.utils.bounding-box"], null);
}),null)),null,-1067862429,null);
bh_ui.utils.bounding_box.make_bounding_box = (function bh_ui$utils$bounding_box$make_bounding_box(lat,lon,delta){
...
bh_ui.utils.bounding_box.locations__GT_bounding_box = (function bh_ui$utils$bounding_box$locations__GT_bounding_box(locations){
...
bh_ui.utils.bounding_box.bounding_box__GT_locations = (function bh_ui$utils$bounding_box$bounding_box__GT_locations(p__59347){
var vec__59348 = p__59347;
var minLat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59348,(0),null);
var maxLat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59348,(1),null);
var minLon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59348,(2),null);
var maxLon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59348,(3),null);
var bounding_box = vec__59348;
...
//# sourceMappingURL=bh_ui.utils.bounding_box.js.map
