...
var G__38222 = clojure.zip.next(loc);
var G__38223 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(seen,node);
loc = G__38222;
seen = G__38223;
continue;
} else {
var G__38224 = clojure.zip.next(loc);
var G__38225 = seen;
loc = G__38224;
seen = G__38225;
continue;
...
var len__4864__auto___38226 = arguments.length;
var i__4865__auto___38227 = (0);
while(true){
if((i__4865__auto___38227 < len__4864__auto___38226)){
args__4870__auto__.push((arguments[i__4865__auto___38227]));

var G__38228 = (i__4865__auto___38227 + (1));
i__4865__auto___38227 = G__38228;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame.tracing.fn_body.cljs$lang$applyTo = (function (seq38218){
var G__38219 = cljs.core.first(seq38218);
var seq38218__$1 = cljs.core.next(seq38218);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38219,seq38218__$1);
}));
