...
re_com.simple_v_table.swap_BANG__sort_by_column = (function re_com$simple_v_table$swap_BANG__sort_by_column(p__50458,new_key_fn,new_comp){
var map__50459 = p__50458;
var map__50459__$1 = cljs.core.__destructure_map(map__50459);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50459__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50459__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
re_com.simple_v_table.column_header_item = (function re_com$simple_v_table$column_header_item(p__50460,parts,sort_by_column){
var map__50461 = p__50460;
var map__50461__$1 = cljs.core.__destructure_map(map__50461);
var column = map__50461__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50461__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50461__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50461__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50461__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50461__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50461__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var header_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50461__$1,new cljs.core.Keyword(null,"header-label","header-label",765876429));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50461__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var map__50464 = sort_by;
var map__50464__$1 = cljs.core.__destructure_map(map__50464);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50464__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479),row_label_fn);
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50464__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var map__50465 = cljs.core.deref(sort_by_column);
var map__50465__$1 = cljs.core.__destructure_map(map__50465);
var current_key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50465__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50465__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
return null;
})], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-column-header","simple-column-header",-1241463404),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__4652__auto__ = (function re_com$simple_v_table$column_header_renderer_$_iter__50466(s__50467){
return (new cljs.core.LazySeq(null,(function (){
var s__50467__$1 = s__50467;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__50467__$1);
if(temp__5753__auto__){
var s__50467__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50467__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__50467__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__50469 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__50468 = (0);
while(true){
if((i__50468 < size__4651__auto__)){
var column = cljs.core._nth(c__4650__auto__,i__50468);
cljs.core.chunk_append(b__50469,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null));

var G__50511 = (i__50468 + (1));
i__50468 = G__50511;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50469),re_com$simple_v_table$column_header_renderer_$_iter__50466(cljs.core.chunk_rest(s__50467__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50469),null);
}
} else {
var column = cljs.core.first(s__50467__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null),re_com$simple_v_table$column_header_renderer_$_iter__50466(cljs.core.rest(s__50467__$2)));
}
} else {
return null;
}
 ...
 */
re_com.simple_v_table.row_item = (function re_com$simple_v_table$row_item(row,p__50470,cell_style,parts){
var map__50471 = p__50470;
var map__50471__$1 = cljs.core.__destructure_map(map__50471);
var column = map__50471__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50471__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50471__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50471__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50471__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50471__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
...
return null;
}):null)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-row","simple-row",-252554766),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__4652__auto__ = (function re_com$simple_v_table$row_renderer_$_iter__50472(s__50473){
return (new cljs.core.LazySeq(null,(function (){
var s__50473__$1 = s__50473;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__50473__$1);
if(temp__5753__auto__){
var s__50473__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50473__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__50473__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__50475 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__50474 = (0);
while(true){
if((i__50474 < size__4651__auto__)){
var column = cljs.core._nth(c__4650__auto__,i__50474);
cljs.core.chunk_append(b__50475,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null));

var G__50512 = (i__50474 + (1));
i__50474 = G__50512;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50475),re_com$simple_v_table$row_renderer_$_iter__50472(cljs.core.chunk_rest(s__50473__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50475),null);
}
} else {
var column = cljs.core.first(s__50473__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null),re_com$simple_v_table$row_renderer_$_iter__50472(cljs.core.rest(s__50473__$2)));
}
} else {
return null;
}
...
re_com.simple_v_table.simple_v_table_parts_desc = ((re_com.config.include_args_desc_QMARK_)?cljs.core.into.cljs$core$IFn$_invoke$arity$2(re_com.simple_v_table.simple_v_table_exclusive_parts_desc,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50476_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__50476_SHARP_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.inc);
...
var len__4864__auto___50515 = arguments.length;
var i__4865__auto___50516 = (0);
while(true){
if((i__4865__auto___50516 < len__4864__auto___50515)){
args__4870__auto__.push((arguments[i__4865__auto___50516]));

var G__50517 = (i__4865__auto___50516 + (1));
i__4865__auto___50516 = G__50517;
continue;
} else {
}
break;
...
(re_com.simple_v_table.simple_v_table.cljs$core$IFn$_invoke$arity$variadic = (function (p__50483){
var map__50484 = p__50483;
var map__50484__$1 = cljs.core.__destructure_map(map__50484);
var args = map__50484__$1;
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50484__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
...
return (function() { 
var re_com$simple_v_table$simple_v_table_render__delegate = function (p__50485){
var map__50486 = p__50485;
var map__50486__$1 = cljs.core.__destructure_map(map__50486);
var args__$1 = map__50486__$1;
var cell_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"cell-style","cell-style",1087536089));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"model","model",331153215));
var on_leave_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"on-leave-row","on-leave-row",1361264390));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var on_enter_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"on-enter-row","on-enter-row",-139996948));
var row_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50486__$1,new cljs.core.Keyword(null,"row-height","row-height",527360749),(31));
var max_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"max-width","max-width",-1939924051));
var src__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var on_click_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"on-click-row","on-click-row",-383826673));
var table_row_line_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50486__$1,new cljs.core.Keyword(null,"table-row-line-color","table-row-line-color",680569135),"#EAEEF1");
var table_padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50486__$1,new cljs.core.Keyword(null,"table-padding","table-padding",-702873839),(19));
var column_header_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50486__$1,new cljs.core.Keyword(null,"column-header-height","column-header-height",-1680092558),(31));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"debug-as","debug-as",283322354));
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
var row_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"row-style","row-style",1352472052));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50486__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var fixed_column_border_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50486__$1,new cljs.core.Keyword(null,"fixed-column-border-color","fixed-column-border-color",2036669142),"#BBBEC0");
var column_header_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50486__$1,new cljs.core.Keyword(null,"column-header-renderer","column-header-renderer",-1886265578),re_com.simple_v_table.column_header_renderer);
var fixed_column_count = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50486__$1,new cljs.core.Keyword(null,"fixed-column-count","fixed-column-count",721535030),(0));
...
var map__50497 = temp__5751__auto__;
var map__50497__$1 = cljs.core.__destructure_map(map__50497);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50497__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50497__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50497__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
var G__50518__i = 0, G__50518__a = new Array(arguments.length -  0);
while (G__50518__i < G__50518__a.length) {G__50518__a[G__50518__i] = arguments[G__50518__i + 0]; ++G__50518__i;}
  p__50485 = new cljs.core.IndexedSeq(G__50518__a,0,null);
} 
return re_com$simple_v_table$simple_v_table_render__delegate.call(this,p__50485);};
re_com$simple_v_table$simple_v_table_render.cljs$lang$maxFixedArity = 0;
re_com$simple_v_table$simple_v_table_render.cljs$lang$applyTo = (function (arglist__50519){
var p__50485 = cljs.core.seq(arglist__50519);
return re_com$simple_v_table$simple_v_table_render__delegate(p__50485);
});
...
/** @this {Function} */
(re_com.simple_v_table.simple_v_table.cljs$lang$applyTo = (function (seq50482){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq50482));
}));
