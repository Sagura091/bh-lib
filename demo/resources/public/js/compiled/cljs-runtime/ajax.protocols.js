...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_42151 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_42151(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_42152 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_42152(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_42153 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_42153(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_42156 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_42156(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_42159 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_42159(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_42160 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_42160(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_42161 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_42161(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_42162 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_42162(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_42165 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_42165(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_42166 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_42166(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k42051,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__42098 = k42051;
var G__42098__$1 = (((G__42098 instanceof cljs.core.Keyword))?G__42098.fqn:null);
switch (G__42098__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k42051,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__42100){
var vec__42101 = p__42100;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42101,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42101,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__42050){
var self__ = this;
var G__42050__$1 = this;
return (new cljs.core.RecordIter((0),G__42050__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this42052,other42054){
var self__ = this;
var this42052__$1 = this;
return (((!((other42054 == null)))) && ((((this42052__$1.constructor === other42054.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42052__$1.status,other42054.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42052__$1.body,other42054.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42052__$1.status_text,other42054.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42052__$1.headers,other42054.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42052__$1.was_aborted,other42054.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42052__$1.__extmap,other42054.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k42051){
var self__ = this;
var this__4509__auto____$1 = this;
var G__42121 = k42051;
var G__42121__$1 = (((G__42121 instanceof cljs.core.Keyword))?G__42121.fqn:null);
switch (G__42121__$1) {
case "status":
case "body":
case "status-text":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k42051);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__42050){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__42123 = cljs.core.keyword_identical_QMARK_;
var expr__42124 = k__4511__auto__;
if(cljs.core.truth_((pred__42123.cljs$core$IFn$_invoke$arity$2 ? pred__42123.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__42124) : pred__42123.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__42124)))){
return (new ajax.protocols.Response(G__42050,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__42123.cljs$core$IFn$_invoke$arity$2 ? pred__42123.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__42124) : pred__42123.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__42124)))){
return (new ajax.protocols.Response(self__.status,G__42050,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__42123.cljs$core$IFn$_invoke$arity$2 ? pred__42123.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__42124) : pred__42123.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__42124)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__42050,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__42123.cljs$core$IFn$_invoke$arity$2 ? pred__42123.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__42124) : pred__42123.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__42124)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__42050,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__42123.cljs$core$IFn$_invoke$arity$2 ? pred__42123.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__42124) : pred__42123.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__42124)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__42050,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__42050),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__42050){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__42050,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__42074){
var extmap__4542__auto__ = (function (){var G__42145 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__42074,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__42074)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__42145);
} else {
return G__42145;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__42074),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__42074),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__42074),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__42074),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__42074),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
