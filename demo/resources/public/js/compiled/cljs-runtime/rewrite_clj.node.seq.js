...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k32296,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k32296,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__32305){
var vec__32306 = p__32305;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32306,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32306,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__32295){
var self__ = this;
var G__32295__$1 = this;
return (new cljs.core.RecordIter((0),G__32295__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this32297,other32298){
var self__ = this;
var this32297__$1 = this;
return (((!((other32298 == null)))) && ((((this32297__$1.constructor === other32298.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32297__$1.tag,other32298.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32297__$1.wrap_fn,other32298.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32297__$1.wrap_length,other32298.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32297__$1.seq_fn,other32298.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32297__$1.children,other32298.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32297__$1.__extmap,other32298.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__32328 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__32328) : self__.seq_fn.call(null,G__32328));
}));
...
var self__ = this;
var this$__$1 = this;
var G__32329 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__32329) : self__.wrap_fn.call(null,G__32329));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k32296){
var self__ = this;
var this__4509__auto____$1 = this;
var G__32334 = k32296;
var G__32334__$1 = (((G__32334 instanceof cljs.core.Keyword))?G__32334.fqn:null);
switch (G__32334__$1) {
case "tag":
case "wrap-fn":
case "wrap-length":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k32296);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__32295){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__32335 = cljs.core.keyword_identical_QMARK_;
var expr__32336 = k__4511__auto__;
if(cljs.core.truth_((pred__32335.cljs$core$IFn$_invoke$arity$2 ? pred__32335.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__32336) : pred__32335.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__32336)))){
return (new rewrite_clj.node.seq.SeqNode(G__32295,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32335.cljs$core$IFn$_invoke$arity$2 ? pred__32335.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__32336) : pred__32335.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__32336)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__32295,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32335.cljs$core$IFn$_invoke$arity$2 ? pred__32335.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__32336) : pred__32335.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__32336)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__32295,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32335.cljs$core$IFn$_invoke$arity$2 ? pred__32335.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__32336) : pred__32335.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__32336)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__32295,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32335.cljs$core$IFn$_invoke$arity$2 ? pred__32335.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__32336) : pred__32335.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__32336)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__32295,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__32295),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__32295){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__32295,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__32299){
var extmap__4542__auto__ = (function (){var G__32362 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__32299,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__32299)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__32362);
} else {
return G__32362;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__32299),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__32299),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__32299),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__32299),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__32299),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__32363_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__32363_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__32378_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__32378_SHARP_);
}),children);
});
