...
var syms = (function (){var iter__4652__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__32225(s__32226){
return (new cljs.core.LazySeq(null,(function (){
var s__32226__$1 = s__32226;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__32226__$1);
if(temp__5753__auto__){
var s__32226__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32226__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__32226__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__32228 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__32227 = (0);
while(true){
if((i__32227 < size__4651__auto__)){
var i = cljs.core._nth(c__4650__auto__,i__32227);
...
cljs.core.chunk_append(b__32228,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__32277 = (i__32227 + (1));
i__32227 = G__32277;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32228),rewrite_clj$node$fn$fn_walk_$_iter__32225(cljs.core.chunk_rest(s__32226__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32228),null);
}
} else {
var i = cljs.core.first(s__32226__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__32225(cljs.core.rest(s__32226__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__32224_SHARP_){
var or__4253__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__32224_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k32236,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__32246 = k32236;
var G__32246__$1 = (((G__32246 instanceof cljs.core.Keyword))?G__32246.fqn:null);
switch (G__32246__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k32236,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__32247){
var vec__32248 = p__32247;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32248,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32248,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__32235){
var self__ = this;
var G__32235__$1 = this;
return (new cljs.core.RecordIter((0),G__32235__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this32238,other32239){
var self__ = this;
var this32238__$1 = this;
return (((!((other32239 == null)))) && ((((this32238__$1.constructor === other32239.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32238__$1.children,other32239.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32238__$1.__extmap,other32239.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k32236){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k32236);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__32235){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__32263 = cljs.core.keyword_identical_QMARK_;
var expr__32264 = k__4511__auto__;
if(cljs.core.truth_((pred__32263.cljs$core$IFn$_invoke$arity$2 ? pred__32263.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__32264) : pred__32263.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__32264)))){
return (new rewrite_clj.node.fn.FnNode(G__32235,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__32235),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__32235){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__32235,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__32243){
var extmap__4542__auto__ = (function (){var G__32271 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__32243,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__32243)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__32271);
} else {
return G__32271;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__32243),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
