goog.provide('demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table');
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"demo.src.catalog.atom.example.misc.bh.meta-coc-bh-table",null,12,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["demo.src.catalog.atom.example.misc.meta-coc-bh-table"], null);
}),null)),null,499101803,null);
...
demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(bh_ui.atom.bhui.table.sample_meta_coc_data);
}
demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data_tools = (function demo$src$catalog$atom$example$misc$bh$meta_coc_bh_table$data_tools(){
...
return cljs.core.reset_BANG_(demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data,cljs.core.PersistentVector.EMPTY);
...
return cljs.core.reset_BANG_(demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data,bh_ui.atom.bhui.table.sample_meta_coc_data);
...
}),new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data)))));
}),new cljs.core.Keyword(null,"label","label",1718410804),"Add :new-item"], null)], null)], null);
});
demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data_update_example = (function demo$src$catalog$atom$example$misc$bh$meta_coc_bh_table$data_update_example(var_args){
...
return demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data_update_example.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});

(demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data_update_example.cljs$core$IFn$_invoke$arity$variadic = (function (p__59496){
var map__59497 = p__59496;
var map__59497__$1 = cljs.core.__destructure_map(map__59497);
var params = map__59497__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59497__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var container_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59497__$1,new cljs.core.Keyword(null,"container-id","container-id",1274665684));
var component_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59497__$1,new cljs.core.Keyword(null,"component-id","component-id",1551113783));
...
(demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data_update_example.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data_update_example.cljs$lang$applyTo = (function (seq59492){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq59492));
}));

demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.example = (function demo$src$catalog$atom$example$misc$bh$meta_coc_bh_table$example(){
var component_id = "table-with-meta-and-coc-demo";
var G__59500 = "Basic Table with meta-data, showing available Chain-of-Custody data";
var G__59501 = "Table using HTML tags\n\n> And with Chain-of-Custody!!\n\n> Feel free to use the controls at the bottom to change the data and see how the Table responds.";
var G__59502 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [woolybear.ad.layout.centered,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"extra-classes","extra-classes",-630819843),new cljs.core.Keyword(null,"width-50","width-50",718512332)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data_update_example,new cljs.core.Keyword(null,"data","data",-232669377),demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.data], null)], null);
var G__59503 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol("table","table","table/table",1267492441,null),new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Symbol("table","sample-meta-coc-data","table/sample-meta-coc-data",1178175994,null)], null);
return (woolybear.ad.utils.demo.cljs$core$IFn$_invoke$arity$4 ? woolybear.ad.utils.demo.cljs$core$IFn$_invoke$arity$4(G__59500,G__59501,G__59502,G__59503) : woolybear.ad.utils.demo.call(null,G__59500,G__59501,G__59502,G__59503));
});

//# sourceMappingURL=demo.src.catalog.atom.example.misc.bh.meta_coc_bh_table.js.map
