...
if((c === "\n")){
var G__32684 = escape_QMARK_;
var G__32685 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__32684;
lines = G__32685;
continue;
} else {
buf.append(c);

var G__32686 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__32687 = lines;
escape_QMARK_ = G__32686;
lines = G__32687;
continue;
...
var G__32675 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__32675) : rewrite_clj.node.string_node.call(null,G__32675));
});
...
var G__32677 = cljs.core.re_pattern(regex);
var G__32678 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__32677,G__32678) : rewrite_clj.node.token_node.call(null,G__32677,G__32678));
});
