...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__27796){
var map__27797 = p__27796;
var map__27797__$1 = cljs.core.__destructure_map(map__27797);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27797__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27797__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27797__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27797__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__27798_27825 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__27799_27826 = null;
var count__27800_27827 = (0);
var i__27801_27828 = (0);
while(true){
if((i__27801_27828 < count__27800_27827)){
var vec__27812_27829 = chunk__27799_27826.cljs$core$IIndexed$_nth$arity$2(null,i__27801_27828);
var k_27830 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27812_27829,(0),null);
var cb_27831 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27812_27829,(1),null);
try{var G__27816_27832 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_27831.cljs$core$IFn$_invoke$arity$1 ? cb_27831.cljs$core$IFn$_invoke$arity$1(G__27816_27832) : cb_27831.call(null,G__27816_27832));
}catch (e27815){var e_27833 = e27815;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_27830,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_27833], 0));
}

var G__27834 = seq__27798_27825;
var G__27835 = chunk__27799_27826;
var G__27836 = count__27800_27827;
var G__27837 = (i__27801_27828 + (1));
seq__27798_27825 = G__27834;
chunk__27799_27826 = G__27835;
count__27800_27827 = G__27836;
i__27801_27828 = G__27837;
continue;
} else {
var temp__5753__auto___27838 = cljs.core.seq(seq__27798_27825);
if(temp__5753__auto___27838){
var seq__27798_27839__$1 = temp__5753__auto___27838;
if(cljs.core.chunked_seq_QMARK_(seq__27798_27839__$1)){
var c__4679__auto___27840 = cljs.core.chunk_first(seq__27798_27839__$1);
var G__27841 = cljs.core.chunk_rest(seq__27798_27839__$1);
var G__27842 = c__4679__auto___27840;
var G__27843 = cljs.core.count(c__4679__auto___27840);
var G__27844 = (0);
seq__27798_27825 = G__27841;
chunk__27799_27826 = G__27842;
count__27800_27827 = G__27843;
i__27801_27828 = G__27844;
continue;
} else {
var vec__27817_27845 = cljs.core.first(seq__27798_27839__$1);
var k_27846 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27817_27845,(0),null);
var cb_27847 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27817_27845,(1),null);
try{var G__27821_27848 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_27847.cljs$core$IFn$_invoke$arity$1 ? cb_27847.cljs$core$IFn$_invoke$arity$1(G__27821_27848) : cb_27847.call(null,G__27821_27848));
}catch (e27820){var e_27849 = e27820;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_27846,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_27849], 0));
}

var G__27850 = cljs.core.next(seq__27798_27839__$1);
var G__27851 = null;
var G__27852 = (0);
var G__27853 = (0);
seq__27798_27825 = G__27850;
chunk__27799_27826 = G__27851;
count__27800_27827 = G__27852;
i__27801_27828 = G__27853;
continue;
}
} else {
}
