...
var len__4864__auto___21492 = arguments.length;
var i__4865__auto___21493 = (0);
while(true){
if((i__4865__auto___21493 < len__4864__auto___21492)){
args__4870__auto__.push((arguments[i__4865__auto___21493]));

var G__21519 = (i__4865__auto___21493 + (1));
i__4865__auto___21493 = G__21519;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__21303_21520 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__21304_21521 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__21305_21522 = true;
var _STAR_print_fn_STAR__temp_val__21306_21523 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__21305_21522);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__21306_21523);

try{var _STAR_print_level_STAR__orig_val__21307_21524 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__21308_21525 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__21308_21525);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__21307_21524);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__21304_21521);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__21303_21520);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq21302){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21302));
}));
...
var new_formatters = current_formatters.filter((function (p1__21323_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__21323_SHARP_)));
}));
...
var G__21331_21566 = f;
var target__19320__auto___21567 = G__21331_21566;
if(cljs.core.truth_(target__19320__auto___21567)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21331_21566)].join(''),"\n","target__19320__auto__"].join('')));
}

(target__19320__auto___21567["toString"] = (function (){
...
var G__21345_21568 = "%c%s";
var G__21346_21569 = "color:transparent";
var G__21347_21570 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__21345_21568,G__21346_21569,G__21347_21570) : f.call(null,G__21345_21568,G__21346_21569,G__21347_21570));
...
var args__4870__auto__ = [];
var len__4864__auto___21571 = arguments.length;
var i__4865__auto___21572 = (0);
while(true){
if((i__4865__auto___21572 < len__4864__auto___21571)){
args__4870__auto__.push((arguments[i__4865__auto___21572]));

var G__21580 = (i__4865__auto___21572 + (1));
i__4865__auto___21572 = G__21580;
continue;
} else {
}
break;
...
var vec__21421 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21421,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21421,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__21581__delegate = function (add_fmt,add_args){
...
var G__21581 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__21582__i = 0, G__21582__a = new Array(arguments.length -  1);
while (G__21582__i < G__21582__a.length) {G__21582__a[G__21582__i] = arguments[G__21582__i + 1]; ++G__21582__i;}
  add_args = new cljs.core.IndexedSeq(G__21582__a,0,null);
} 
return G__21581__delegate.call(this,add_fmt,add_args);};
G__21581.cljs$lang$maxFixedArity = 1;
G__21581.cljs$lang$applyTo = (function (arglist__21583){
var add_fmt = cljs.core.first(arglist__21583);
var add_args = cljs.core.rest(arglist__21583);
return G__21581__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq21383){
var G__21384 = cljs.core.first(seq21383);
var seq21383__$1 = cljs.core.next(seq21383);
var G__21385 = cljs.core.first(seq21383__$1);
var seq21383__$2 = cljs.core.next(seq21383__$1);
var G__21386 = cljs.core.first(seq21383__$2);
var seq21383__$3 = cljs.core.next(seq21383__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21384,G__21385,G__21386,seq21383__$3);
}));
...
var seq__21443 = cljs.core.seq(features);
var chunk__21444 = null;
var count__21445 = (0);
var i__21446 = (0);
while(true){
if((i__21446 < count__21445)){
var feature = chunk__21444.cljs$core$IIndexed$_nth$arity$2(null,i__21446);
...
var G__21588 = seq__21443;
var G__21589 = chunk__21444;
var G__21590 = count__21445;
var G__21591 = (i__21446 + (1));
seq__21443 = G__21588;
chunk__21444 = G__21589;
count__21445 = G__21590;
i__21446 = G__21591;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__21443);
if(temp__5753__auto__){
var seq__21443__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__21443__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__21443__$1);
var G__21594 = cljs.core.chunk_rest(seq__21443__$1);
var G__21595 = c__4679__auto__;
var G__21596 = cljs.core.count(c__4679__auto__);
var G__21597 = (0);
seq__21443 = G__21594;
chunk__21444 = G__21595;
count__21445 = G__21596;
i__21446 = G__21597;
continue;
} else {
var feature = cljs.core.first(seq__21443__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__21598 = cljs.core.next(seq__21443__$1);
var G__21599 = null;
var G__21600 = (0);
var G__21601 = (0);
seq__21443 = G__21598;
chunk__21444 = G__21599;
count__21445 = G__21600;
i__21446 = G__21601;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o21471 = temp__5751__auto__;
return (o21471["version"]);
} else {
return null;
}
})() == null);
