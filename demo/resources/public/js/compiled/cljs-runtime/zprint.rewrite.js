...
var G__33516 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__33516;
continue;
} else {
var G__33517 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__33517;
continue;
}
} else {
var G__33518 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__33518;
continue;
}
}
...
var G__33466 = zloc;
var G__33467 = (function (){var G__33468 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__33469 = zloc;
var G__33469__$1 = (((G__33469 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__33469) : rewrite_clj.zip.node.call(null,G__33469)));
if((G__33469__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__33469__$1) : zprint.zutil.edn_STAR_.call(null,G__33469__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__33468) : rewrite_clj.zip.root.call(null,G__33468));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__33466,G__33467) : rewrite_clj.zip.replace.call(null,G__33466,G__33467));
});
/**
...
var G__33519 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__33519;
continue;
}
break;
...
var G__33520 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__33521 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__33520;
out = G__33521;
continue;
} else {
...
var G__33522 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__33523 = cljs.core.next(new_loc);
var G__33524 = replaced_loc;
nloc = G__33522;
new_loc = G__33523;
last_loc = G__33524;
continue;
...
return zprint.rewrite.sort_val((function (){var G__33502 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__33502) : rewrite_clj.zip.down.call(null,G__33502));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__33509_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__33509_SHARP_) : rewrite_clj.zip.tag.call(null,p1__33509_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__33509_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__33509_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
