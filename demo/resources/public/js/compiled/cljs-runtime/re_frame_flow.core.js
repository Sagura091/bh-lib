...
var G__27093 = cljs.core.PersistentHashSet.EMPTY;
var G__27093__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(result))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__27093,cljs.core.first(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(result))):G__27093);
var G__27093__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236).cljs$core$IFn$_invoke$arity$1(result))?clojure.set.union.cljs$core$IFn$_invoke$arity$2(G__27093__$1,cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236).cljs$core$IFn$_invoke$arity$1(result))))):G__27093__$1);
var G__27093__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"dispatch-later","dispatch-later",291951390).cljs$core$IFn$_invoke$arity$1(result))?(function (p1__27092_SHARP_){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__27092_SHARP_,cljs.core.first(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"dispatch-later","dispatch-later",291951390).cljs$core$IFn$_invoke$arity$1(result))));
} else {
return clojure.set.union.cljs$core$IFn$_invoke$arity$2(p1__27092_SHARP_,cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.first,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009)),cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,new cljs.core.Keyword(null,"dispatch-later","dispatch-later",291951390).cljs$core$IFn$_invoke$arity$1(result)))));
}
})(G__27093__$2):G__27093__$2);
var G__27093__$4 = (cljs.core.truth_(new cljs.core.Keyword(null,"on-success","on-success",1786904109).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http","http",382524695).cljs$core$IFn$_invoke$arity$1(result)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__27093__$3,cljs.core.first(new cljs.core.Keyword(null,"on-success","on-success",1786904109).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http","http",382524695).cljs$core$IFn$_invoke$arity$1(result)))):G__27093__$3);
var G__27093__$5 = (cljs.core.truth_(new cljs.core.Keyword(null,"on-success","on-success",1786904109).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http-xhrio","http-xhrio",1846166714).cljs$core$IFn$_invoke$arity$1(result)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__27093__$4,cljs.core.first(new cljs.core.Keyword(null,"on-success","on-success",1786904109).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http-xhrio","http-xhrio",1846166714).cljs$core$IFn$_invoke$arity$1(result)))):G__27093__$4);
var G__27093__$6 = (cljs.core.truth_(new cljs.core.Keyword(null,"on-failure","on-failure",842888245).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http","http",382524695).cljs$core$IFn$_invoke$arity$1(result)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__27093__$5,cljs.core.first(new cljs.core.Keyword(null,"on-failure","on-failure",842888245).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http","http",382524695).cljs$core$IFn$_invoke$arity$1(result)))):G__27093__$5);
var G__27093__$7 = (cljs.core.truth_(new cljs.core.Keyword(null,"on-failure","on-failure",842888245).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http-xhrio","http-xhrio",1846166714).cljs$core$IFn$_invoke$arity$1(result)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__27093__$6,cljs.core.first(new cljs.core.Keyword(null,"on-failure","on-failure",842888245).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http-xhrio","http-xhrio",1846166714).cljs$core$IFn$_invoke$arity$1(result)))):G__27093__$6);
return clojure.set.union.cljs$core$IFn$_invoke$arity$2(G__27093__$7,cljs.core.set(cljs.core.keys(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(result,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),new cljs.core.Keyword(null,"dispatch-later","dispatch-later",291951390),new cljs.core.Keyword(null,"http","http",382524695),new cljs.core.Keyword(null,"http-xhrio","http-xhrio",1846166714)], 0)))));
...
var nodes = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27100_SHARP_){
return re_frame_flow.core.id__GT_node(p1__27100_SHARP_,cljs.core.boolean$((p1__27100_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__27100_SHARP_.cljs$core$IFn$_invoke$arity$1(dispatches) : p1__27100_SHARP_.call(null,dispatches))));
}),cljs.core.cons(k,v));
...
re_frame_flow.core.get_id__GT_node_map = (function re_frame_flow$core$get_id__GT_node_map(p__27101){
var map__27102 = p__27101;
var map__27102__$1 = cljs.core.__destructure_map(map__27102);
var handlers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27102__$1,new cljs.core.Keyword(null,"handlers","handlers",79528781));
var dispatches = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27102__$1,new cljs.core.Keyword(null,"dispatches","dispatches",-331249187));
var kind__GT_id__GT_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27102__$1,new cljs.core.Keyword(null,"kind->id->handler","kind->id->handler",-214642779));
...
var new_context = ((re_frame.trace.is_trace_enabled_QMARK_())?(function (){var _STAR_current_trace_STAR__orig_val__27106 = re_frame.trace._STAR_current_trace_STAR_;
var _STAR_current_trace_STAR__temp_val__27107 = re_frame.trace.start_trace(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"op-type","op-type",-1636141668),new cljs.core.Keyword("event","handler","event/handler",-295903150),new cljs.core.Keyword(null,"operation","operation",-1267664310),re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,new cljs.core.Keyword(null,"original-event","original-event",2121330403))], null));
(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__temp_val__27107);

try{try{var map__27111 = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__27111__$1 = cljs.core.__destructure_map(map__27111);
var coeffects = map__27111__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27111__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var result_27141__$1 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(result,new cljs.core.Keyword(null,"db","db",993250759));
var deps_27142 = re_frame_flow.core.get_deps(result_27141__$1);
...
var end__26414__auto___27143 = re_frame.interop.now();
var duration__26415__auto___27144 = (end__26414__auto___27143 - new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(re_frame.trace._STAR_current_trace_STAR_));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(re_frame.trace.traces,cljs.core.conj,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"duration","duration",1444101068),duration__26415__auto___27144,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"end","end",-268185958),re_frame.interop.now()], 0)));

re_frame.trace.run_tracing_callbacks_BANG_(end__26414__auto___27143);
} else {
}
}}finally {(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__orig_val__27106);
}})():(function (){var map__27112 = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__27112__$1 = cljs.core.__destructure_map(map__27112);
var coeffects = map__27112__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27112__$1,new cljs.core.Keyword(null,"event","event",301435442));
var result = (handler_fn.cljs$core$IFn$_invoke$arity$2 ? handler_fn.cljs$core$IFn$_invoke$arity$2(coeffects,event) : handler_fn.call(null,coeffects,event));
var result_27145__$1 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(result,new cljs.core.Keyword(null,"db","db",993250759));
var deps_27146 = re_frame_flow.core.get_deps(result_27145__$1);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(re_frame_flow.core.state_STAR_,(function (state,id__$1,v){
var state__$1 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"handlers","handlers",79528781),id__$1], null),clojure.set.union,v);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"id->node-map","id->node-map",1816082127),re_frame_flow.core.get_id__GT_node_map(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"handlers","handlers",79528781),new cljs.core.Keyword(null,"handlers","handlers",79528781).cljs$core$IFn$_invoke$arity$1(state__$1),new cljs.core.Keyword(null,"dispatches","dispatches",-331249187),new cljs.core.Keyword(null,"dispatches","dispatches",-331249187).cljs$core$IFn$_invoke$arity$1(state__$1),new cljs.core.Keyword(null,"kind->id->handler","kind->id->handler",-214642779),cljs.core.deref(re_frame.registrar.kind__GT_id__GT_handler)], null)));
}),id,deps_27146);
...
return (fexpr__27116.cljs$core$IFn$_invoke$arity$2 ? fexpr__27116.cljs$core$IFn$_invoke$arity$2(id,handler) : fexpr__27116.call(null,id,handler));
})()], null));
});
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__27119_SHARP_){
var or__4253__auto__ = new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(p1__27119_SHARP_));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var G__27121 = p1__27119_SHARP_;
var G__27121__$1 = (((G__27121 == null))?null:new cljs.core.Keyword(null,"source","source",-433931539).cljs$core$IFn$_invoke$arity$1(G__27121));
var G__27121__$2 = (((G__27121__$1 == null))?null:re_frame_flow.core.kw__GT_str(G__27121__$1));
if((G__27121__$2 == null)){
return null;
} else {
return (dispatch_node_ids.cljs$core$IFn$_invoke$arity$1 ? dispatch_node_ids.cljs$core$IFn$_invoke$arity$1(G__27121__$2) : dispatch_node_ids.call(null,G__27121__$2));
}
}
}),elements_STAR_);
})());
var _ = (function (){var seq__27122 = cljs.core.seq(elements_STAR___$1);
var chunk__27123 = null;
var count__27124 = (0);
var i__27125 = (0);
while(true){
if((i__27125 < count__27124)){
var el = chunk__27123.cljs$core$IIndexed$_nth$arity$2(null,i__27125);
...
var G__27151 = seq__27122;
var G__27152 = chunk__27123;
var G__27153 = count__27124;
var G__27154 = (i__27125 + (1));
seq__27122 = G__27151;
chunk__27123 = G__27152;
count__27124 = G__27153;
i__27125 = G__27154;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__27122);
if(temp__5753__auto__){
var seq__27122__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__27122__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__27122__$1);
var G__27155 = cljs.core.chunk_rest(seq__27122__$1);
var G__27156 = c__4679__auto__;
var G__27157 = cljs.core.count(c__4679__auto__);
var G__27158 = (0);
seq__27122 = G__27155;
chunk__27123 = G__27156;
count__27124 = G__27157;
i__27125 = G__27158;
continue;
} else {
var el = cljs.core.first(seq__27122__$1);
if(cljs.core.truth_(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(el))){
re_frame_flow.core.dagre_graph.setNode(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(el),cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),width,new cljs.core.Keyword(null,"height","height",1025178622),height], null)));
} else {
re_frame_flow.core.dagre_graph.setEdge(new cljs.core.Keyword(null,"source","source",-433931539).cljs$core$IFn$_invoke$arity$1(el),new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(el));
...
var G__27159 = cljs.core.next(seq__27122__$1);
var G__27160 = null;
var G__27161 = (0);
var G__27162 = (0);
seq__27122 = G__27159;
chunk__27123 = G__27160;
count__27124 = G__27161;
i__27125 = G__27162;
continue;
}
} else {
...
return cljs.core.reset_BANG_(elements,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27120_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__27120_SHARP_),p1__27120_SHARP_],null));
}),elements_STAR___$2)));
});
...
return cljs.core.cons(id,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__27126_SHARP_){
return re_frame_flow.core.traverse_path.cljs$core$IFn$_invoke$arity$3(m,state__$1,p1__27126_SHARP_);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27129_SHARP_){
var or__4253__auto__ = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(p1__27129_SHARP_);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var G__27130 = new cljs.core.Keyword(null,"source","source",-433931539).cljs$core$IFn$_invoke$arity$1(p1__27129_SHARP_);
return (sources.cljs$core$IFn$_invoke$arity$1 ? sources.cljs$core$IFn$_invoke$arity$1(G__27130) : sources.call(null,G__27130));
}
}),elements);
});
