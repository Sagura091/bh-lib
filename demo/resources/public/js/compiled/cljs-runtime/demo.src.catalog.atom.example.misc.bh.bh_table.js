goog.provide('demo.src.catalog.atom.example.misc.bh.bh_table');
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"demo.src.catalog.atom.example.misc.bh.bh-table",null,12,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["demo.src.catalog.atom.example.misc.bh-table"], null);
}),null)),null,1992706954,null);
...
return cljs.core.reset_BANG_(demo.src.catalog.atom.example.misc.bh.bh_table.data,bh_ui.atom.bhui.table.sample_data);
...
return cljs.core.reset_BANG_(demo.src.catalog.atom.example.misc.bh.bh_table.data,(bh_ui.atom.bhui.table.random_data.cljs$core$IFn$_invoke$arity$0 ? bh_ui.atom.bhui.table.random_data.cljs$core$IFn$_invoke$arity$0() : bh_ui.atom.bhui.table.random_data.call(null)));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(demo.src.catalog.atom.example.misc.bh.bh_table.data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),new cljs.core.Keyword(null,"uv","uv",-1197749379)], null),(10000));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(demo.src.catalog.atom.example.misc.bh.bh_table.data,cljs.core.conj,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"Page Q",new cljs.core.Keyword(null,"uv","uv",-1197749379),(1100),new cljs.core.Keyword(null,"pv","pv",55024340),(1100),new cljs.core.Keyword(null,"tv","tv",-1805207359),(1100),new cljs.core.Keyword(null,"amt","amt",-1785711538),(1100)], null));
...
return cljs.core.reset_BANG_(demo.src.catalog.atom.example.misc.bh.bh_table.data,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2((2),cljs.core.deref(demo.src.catalog.atom.example.misc.bh.bh_table.data))));
...
return cljs.core.reset_BANG_(demo.src.catalog.atom.example.misc.bh.bh_table.data,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(x,new cljs.core.Keyword(null,"new-item","new-item",-1489242961),(1750));
}),cljs.core.deref(demo.src.catalog.atom.example.misc.bh.bh_table.data))));
}),new cljs.core.Keyword(null,"label","label",1718410804),"Add :new-item"], null)], null)], null);
});
demo.src.catalog.atom.example.misc.bh.bh_table.data_update_example = (function demo$src$catalog$atom$example$misc$bh$bh_table$data_update_example(var_args){
