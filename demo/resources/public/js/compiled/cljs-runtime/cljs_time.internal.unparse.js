...
var periods__$1 = cljs.core.vec((function (){var G__49490 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49489_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__49489_SHARP_,(0),(3));
}),G__49490);
} else {
return G__49490;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__49496){
var vec__49497 = p__49496;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49497,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49497,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__49500 = pattern;
switch (G__49500) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49500)].join('')));
...
return p1__49501_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__49502_SHARP_){
return p1__49502_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__49503_SHARP_){
return p1__49503_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__49504_SHARP_){
return p1__49504_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__49505_SHARP_){
return p1__49505_SHARP_.getHours();
});

break;
case "day":
return (function (p1__49506_SHARP_){
return p1__49506_SHARP_.getDate();
});

break;
case "month":
return (function (p1__49507_SHARP_){
return p1__49507_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__49508_SHARP_){
return p1__49508_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__49510){
var vec__49511 = p__49510;
var seq__49512 = cljs.core.seq(vec__49511);
var first__49513 = cljs.core.first(seq__49512);
var seq__49512__$1 = cljs.core.next(seq__49512);
var key = first__49513;
var args = seq__49512__$1;
var G__49514 = key;
...
break;
case "ordinal-suffix":
var vec__49515 = (function (){var G__49518 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__49518) : syntax_list.call(null,G__49518));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49515,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49514__$1)].join('')));
...
var d = value;
var G__49522 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__49523 = G__49522;
var seq__49524 = cljs.core.seq(vec__49523);
var first__49525 = cljs.core.first(seq__49524);
var seq__49524__$1 = cljs.core.next(seq__49524);
var unparser = first__49525;
var more = seq__49524__$1;
var s = "";
var d__$1 = d;
var G__49522__$1 = G__49522;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__49532 = G__49522__$1;
...
var unparser__$1 = first__49534;
var more__$1 = seq__49533__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__49535 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49535,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49535,(1),null);
var G__49564 = d__$3;
var G__49565 = more__$1;
var G__49566 = s__$3;
d__$1 = G__49564;
G__49522__$1 = G__49565;
s__$1 = G__49566;
continue;
}
break;
