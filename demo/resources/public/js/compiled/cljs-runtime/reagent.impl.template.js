...
var G__23220 = o;
reagent.impl.template.goog$module$goog$object.set(G__23220,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23238__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__23238 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__23239__i = 0, G__23239__a = new Array(arguments.length -  0);
while (G__23239__i < G__23239__a.length) {G__23239__a[G__23239__i] = arguments[G__23239__i + 0]; ++G__23239__i;}
  args = new cljs.core.IndexedSeq(G__23239__a,0,null);
} 
return G__23238__delegate.call(this,args);};
G__23238.cljs$lang$maxFixedArity = 0;
G__23238.cljs$lang$applyTo = (function (arglist__23240){
var args = cljs.core.seq(arglist__23240);
return G__23238__delegate(args);
});
...
var G__23221 = o;
reagent.impl.template.goog$module$goog$object.set(G__23221,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__23222 = props;
var G__23222__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23222,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23222);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23222__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23223 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23223,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23223;
}
})(),id_class);
...
var G__23224 = (cljs.core.count(argv) - first_child);
switch (G__23224) {
case (0):
...
var vec__23225 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23225,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23225,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23225,(2),null);
...
var temp__5757__auto___23245 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___23245 == null)){
} else {
var key_23246 = temp__5757__auto___23245;
(jsprops.key = key_23246);
}
...
var temp__5757__auto___23247 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___23247 == null)){
} else {
var key_23248 = temp__5757__auto___23247;
(jsprops.key = key_23248);
}
...
var temp__5757__auto___23249 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___23249 == null)){
} else {
var key_23250 = temp__5757__auto___23249;
(jsprops.key = key_23250);
}
...
var temp__5757__auto___23251 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___23251 == null)){
} else {
var key_23252 = temp__5757__auto___23251;
(jsprops.key = key_23252);
}
...
var temp__5757__auto___23253 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___23253 == null)){
} else {
var key_23254 = temp__5757__auto___23253;
(jsprops.key = key_23254);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23228_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23228_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23229 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23229,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23229,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template23235 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template23235 = (function (opts,id,fn_to_element,parse_fn,meta23236){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23235.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23237,meta23236__$1){
var self__ = this;
var _23237__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23235(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23236__$1));
}));

(reagent.impl.template.t_reagent$impl$template23235.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23237){
var self__ = this;
var _23237__$1 = this;
return self__.meta23236;
}));

(reagent.impl.template.t_reagent$impl$template23235.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23235.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23235.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23235.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23235.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23235.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23236","meta23236",-573220370,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23235.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23235.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23235");

(reagent.impl.template.t_reagent$impl$template23235.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template23235");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23235.
 */
reagent.impl.template.__GT_t_reagent$impl$template23235 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template23235(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta23236){
return (new reagent.impl.template.t_reagent$impl$template23235(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta23236));
});

}

return (new reagent.impl.template.t_reagent$impl$template23235(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
