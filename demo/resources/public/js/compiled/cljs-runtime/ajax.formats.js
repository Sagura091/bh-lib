...
var G__42700 = request;
var G__42701 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__42700,G__42701) : ajax.formats.get_format.call(null,G__42700,G__42701));
} else {
...
return cljs.core.some((function (p1__42720_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__42720_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__42750){
var map__42751 = p__42750;
var map__42751__$1 = cljs.core.__destructure_map(map__42751);
var request = map__42751__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42751__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__42760 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__42760.cljs$core$IFn$_invoke$arity$1 ? fexpr__42760.cljs$core$IFn$_invoke$arity$1(response) : fexpr__42760.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__42763){
var map__42764 = p__42763;
var map__42764__$1 = cljs.core.__destructure_map(map__42764);
var request = map__42764__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42764__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__42761_SHARP_){
return ajax.formats.get_accept_entries(request,p1__42761_SHARP_);
