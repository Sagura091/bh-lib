...
var vec__56829 = temp__5751__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56829,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56829,(1),null);
...
var len__4864__auto___56862 = arguments.length;
var i__4865__auto___56863 = (0);
while(true){
if((i__4865__auto___56863 < len__4864__auto___56862)){
args__4870__auto__.push((arguments[i__4865__auto___56863]));

var G__56864 = (i__4865__auto___56863 + (1));
i__4865__auto___56863 = G__56864;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__56835){
var map__56836 = p__56835;
var map__56836__$1 = cljs.core.__destructure_map(map__56836);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56836__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56836__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56836__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__56837 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56837,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56837,(1),null);
...
var size = first__56849;
var rest_size_seq = seq__56848__$1;
var vec__56850 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56850,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56850,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq56832){
var G__56833 = cljs.core.first(seq56832);
var seq56832__$1 = cljs.core.next(seq56832);
var G__56834 = cljs.core.first(seq56832__$1);
var seq56832__$2 = cljs.core.next(seq56832__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56833,G__56834,seq56832__$2);
}));
...
var map__56854 = smallest;
var map__56854__$1 = cljs.core.__destructure_map(map__56854);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56854__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__56869 = tail;
var G__56870 = current_smallest;
var G__56871 = (total_nodes_visited + (1));
var G__56872 = depth;
nodes = G__56869;
current_smallest = G__56870;
total_nodes_visited = G__56871;
depth = G__56872;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__56856_56873 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__56856_56873) : reporter_fn.call(null,G__56856_56873));

var temp__5751__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5751__auto__){
var children = temp__5751__auto__;
var G__56874 = children;
var G__56875 = new_smallest;
var G__56876 = (total_nodes_visited + (1));
var G__56877 = (depth + (1));
nodes = G__56874;
current_smallest = G__56875;
total_nodes_visited = G__56876;
depth = G__56877;
continue;
} else {
var G__56878 = tail;
var G__56879 = new_smallest;
var G__56880 = (total_nodes_visited + (1));
var G__56881 = depth;
nodes = G__56878;
current_smallest = G__56879;
total_nodes_visited = G__56880;
depth = G__56881;
continue;
}
}
...
var G__56858_56882 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__56858_56882) : reporter_fn.call(null,G__56858_56882));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__56857_SHARP_){
var G__56859 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__56857_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__56859) : reporter_fn.call(null,G__56859));
}));
var G__56860_56883 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__56860_56883) : reporter_fn.call(null,G__56860_56883));
