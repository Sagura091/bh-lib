...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__50253_SHARP_,p2__50254_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__50253_SHARP_,p2__50254_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function re_com$tour$initialise_tour_$_iter__50257(s__50258){
return (new cljs.core.LazySeq(null,(function (){
var s__50258__$1 = s__50258;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__50258__$1);
if(temp__5753__auto__){
var s__50258__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50258__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__50258__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__50260 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__50259 = (0);
while(true){
if((i__50259 < size__4651__auto__)){
var step = cljs.core._nth(c__4650__auto__,i__50259);
cljs.core.chunk_append(b__50260,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__50285 = (i__50259 + (1));
i__50259 = G__50285;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50260),re_com$tour$initialise_tour_$_iter__50257(cljs.core.chunk_rest(s__50258__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50260),null);
}
} else {
var step = cljs.core.first(s__50258__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__50257(cljs.core.rest(s__50258__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__50266 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__50266.cljs$core$IFn$_invoke$arity$1 ? fexpr__50266.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__50266.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__50268 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__50268.cljs$core$IFn$_invoke$arity$1 ? fexpr__50268.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__50268.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__50269 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__50269.cljs$core$IFn$_invoke$arity$1 ? fexpr__50269.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__50269.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__50271 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__50271.cljs$core$IFn$_invoke$arity$1 ? fexpr__50271.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__50271.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__50272 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__50272.cljs$core$IFn$_invoke$arity$1 ? fexpr__50272.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__50272.call(null,tour));
})(),true);
} else {
return null;
}
