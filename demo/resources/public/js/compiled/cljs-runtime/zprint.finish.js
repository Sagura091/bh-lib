...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__31538_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__31538_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__31538_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__31539){
var vec__31540 = p__31539;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31540,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31540,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__31543,s,color,element,idx){
var map__31544 = p__31543;
var map__31544__$1 = cljs.core.__destructure_map(map__31544);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31544__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31544__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31544__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__31547 = (function (){var or__4253__auto__ = color;
...
var fexpr__31546 = (function (){var G__31548 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__31548) : style_map.call(null,G__31548));
})();
return (fexpr__31546.cljs$core$IFn$_invoke$arity$1 ? fexpr__31546.cljs$core$IFn$_invoke$arity$1(G__31547) : fexpr__31546.call(null,G__31547));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__31549){
var vec__31550 = p__31549;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31550,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31550,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31550,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__31553){
var vec__31554 = p__31553;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31554,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31554,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31554,(2),null);
...
var G__31624 = cljs.core.next(ssv);
var G__31625 = (this_ssv == null);
var G__31626 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__31627 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__31624;
doing_nil_QMARK_ = G__31625;
last_elide = G__31626;
out = G__31627;
continue;
}
...
var vec__31562 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31562,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31562,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31562,(2),null);
...
var G__31628 = cljs.core.next(remaining_cvec);
var G__31629 = new_idx;
var G__31630 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__31628;
idx = G__31629;
out = G__31630;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__31575,cursor_vec){
var vec__31576 = p__31575;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31576,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31576,(1),null);
var focus_vec = vec__31576;
...
var vec__31580 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31580,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31580,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__31583){
var vec__31584 = p__31583;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31584,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31584,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__31592,existing_count){
var vec__31593 = p__31592;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31593,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31593,(1),null);
...
return cljs.core.filterv((function (p1__31588_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__31588_SHARP_))));
...
var vec__31602 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31602,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31602,(1),null);
var cvec_element = vec__31602;
if((cvec_element == null)){
var G__31639 = cljs.core.next(cvec_nl);
var G__31640 = (idx + (1));
var G__31641 = start;
var G__31642 = out;
cvec_nl = G__31639;
...
var G__31643 = cljs.core.next(cvec_nl);
var G__31644 = (idx + (1));
var G__31645 = idx;
var G__31646 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__31643;
idx = G__31644;
start = G__31645;
out = G__31646;
...
var G__31648 = cljs.core.next(cvec_nl);
var G__31649 = (idx + (1));
var G__31650 = (idx + (1));
var G__31651 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__31648;
idx = G__31649;
start = G__31650;
out = G__31651;
...
var G__31652 = cljs.core.next(cvec_nl);
var G__31653 = (idx + (1));
var G__31654 = idx;
var G__31655 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__31652;
idx = G__31653;
start = G__31654;
out = G__31655;
...
var G__31656 = cljs.core.next(cvec_nl);
var G__31657 = (idx + (1));
var G__31658 = start;
var G__31659 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__31656;
idx = G__31657;
start = G__31658;
out = G__31659;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__31607_SHARP_,p2__31606_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__31606_SHARP_)){
return cljs.core.reduced(p1__31607_SHARP_);
} else {
return (p1__31607_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__31609,p__31610){
var vec__31611 = p__31609;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31611,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31611,(1),null);
var vec__31614 = p__31610;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31614,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31614,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__31619,cvec,focus_vec){
var map__31620 = p__31619;
var map__31620__$1 = cljs.core.__destructure_map(map__31620);
var options = map__31620__$1;
var map__31621 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31620__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__31621__$1 = cljs.core.__destructure_map(map__31621);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31621__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31621__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31621__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31618_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__31618_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
