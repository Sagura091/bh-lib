...
var G__33208 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__33208__$1 = (((G__33208 == null))?null:cljs.core.iterate((function (loc){
...
var G__33208__$2 = (((G__33208__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__33208__$1));
var G__33208__$3 = (((G__33208__$2 == null))?null:cljs.core.last(G__33208__$2));
if((G__33208__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__33208__$3);
}
} else {
return zloc;
}
...
var G__33218 = rewrite_clj.zip.move.right(v);
var G__33219 = rewrite_clj.zip.move.up(v);
loc = G__33218;
parent = G__33219;
continue;
} else {
var G__33220 = rewrite_clj.zip.move.right(v0);
var G__33221 = parent;
loc = G__33220;
parent = G__33221;
continue;
...
var G__33222 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__33223 = rewrite_clj.zip.move.up(v);
loc = G__33222;
parent = G__33223;
continue;
} else {
var G__33224 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__33225 = parent;
loc = G__33224;
parent = G__33225;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__33214 = zloc;
var G__33214__$1 = (((G__33214 == null))?null:rewrite_clj.zip.move.down(G__33214));
var G__33214__$2 = (((G__33214__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__33214__$1,k));
if((G__33214__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__33214__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__33215 = rewrite_clj.zip.move.down(zloc);
var G__33215__$1 = (((G__33215 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__33215));
if((G__33215__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__33215__$1);
}
})(),k);
}
});
