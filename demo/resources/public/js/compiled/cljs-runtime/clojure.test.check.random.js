...
var clojure$test$check$random$IRandom$rand_long$dyn_51132 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_51132(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_51135 = (function (rng){
var x__4550__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_51135(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_51136 = (function (rng){
var x__4550__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_51136(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_51137 = (function (rng,n){
var x__4550__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_51137(rng,n);
}
});
...
var G__51092 = z;
if(((24) > (function (){var G__51095 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__51095) : clojure.test.check.random.longs.bit_count.call(null,G__51095));
})())){
return clojure.test.check.random.longs.bit_xor(G__51092,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__51092;
}
});
...
var G__51139 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__51140 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__51139;
ret = G__51140;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__51120){
var map__51121 = p__51120;
var map__51121__$1 = cljs.core.__destructure_map(map__51121);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51121__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__51122 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51122,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51122,(1),null);
