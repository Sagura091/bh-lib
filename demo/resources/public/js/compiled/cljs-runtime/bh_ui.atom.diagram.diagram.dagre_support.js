goog.provide('bh_ui.atom.diagram.diagram.dagre_support');
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"bh-ui.atom.diagram.diagram.dagre-support",null,7,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["bh-ui.atom.diagram.diagram.dagre-support"], null);
}),null)),null,182059822,null);
/**
 ...
 *   
 */
bh_ui.atom.diagram.diagram.dagre_support.dagre_graph = (function bh_ui$atom$diagram$diagram$dagre_support$dagre_graph(var_args){
var G__59034 = arguments.length;
switch (G__59034) {
case 2:
return bh_ui.atom.diagram.diagram.dagre_support.dagre_graph.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));

break;
case 1:
return bh_ui.atom.diagram.diagram.dagre_support.dagre_graph.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));
...
(bh_ui.atom.diagram.diagram.dagre_support.dagre_graph.cljs$core$IFn$_invoke$arity$2 = (function (nodes,edges){
...
(bh_ui.atom.diagram.diagram.dagre_support.dagre_graph.cljs$core$IFn$_invoke$arity$1 = (function (graph){
return bh_ui.atom.diagram.diagram.dagre_support.dagre_graph.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"nodes","nodes",-2099585805).cljs$core$IFn$_invoke$arity$1(graph),new cljs.core.Keyword(null,"edges","edges",-694791395).cljs$core$IFn$_invoke$arity$1(graph));
}));

(bh_ui.atom.diagram.diagram.dagre_support.dagre_graph.cljs$lang$maxFixedArity = 2);
 ...
 *   
 */
bh_ui.atom.diagram.diagram.dagre_support.build_layout = (function bh_ui$atom$diagram$diagram$dagre_support$build_layout(var_args){
var G__59036 = arguments.length;
switch (G__59036) {
case 2:
return bh_ui.atom.diagram.diagram.dagre_support.build_layout.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));

break;
case 1:
return bh_ui.atom.diagram.diagram.dagre_support.build_layout.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));
...
(bh_ui.atom.diagram.diagram.dagre_support.build_layout.cljs$core$IFn$_invoke$arity$2 = (function (nodes,edges){
var dagreGraph = bh_ui.atom.diagram.diagram.dagre_support.dagre_graph.cljs$core$IFn$_invoke$arity$2(nodes,edges);
var nodeWidth = (172);
var nodeHeight = (36);
...
(bh_ui.atom.diagram.diagram.dagre_support.build_layout.cljs$core$IFn$_invoke$arity$1 = (function (graph){
return bh_ui.atom.diagram.diagram.dagre_support.build_layout.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"nodes","nodes",-2099585805).cljs$core$IFn$_invoke$arity$1(graph),new cljs.core.Keyword(null,"edges","edges",-694791395).cljs$core$IFn$_invoke$arity$1(graph));
}));

(bh_ui.atom.diagram.diagram.dagre_support.build_layout.cljs$lang$maxFixedArity = 2);

bh_ui.atom.diagram.diagram.dagre_support.dump_dagre = (function bh_ui$atom$diagram$diagram$dagre_support$dump_dagre(dagreGraph){
...
//# sourceMappingURL=bh_ui.atom.diagram.diagram.dagre_support.js.map
