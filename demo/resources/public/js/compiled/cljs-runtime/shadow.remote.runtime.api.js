...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_60839 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_60839(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_60840 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_60840(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_60841 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_60841(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_60842 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_60842(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_60843 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_60843(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_60844 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_60844(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__60836,callback){
var map__60837 = p__60836;
var map__60837__$1 = cljs.core.__destructure_map(map__60837);
var input = map__60837__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60837__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60837__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
