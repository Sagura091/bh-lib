...
var clojure$test$check$results$Result$pass_QMARK_$dyn_56825 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_56825(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_56826 = (function (result){
var x__4550__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_56826(result);
}
});
