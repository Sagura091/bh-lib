...
var i_38509 = (0);
while(true){
if((i_38509 < arr.length)){
(arr[i_38509] = null);

var G__38510 = (i_38509 + (1));
i_38509 = G__38510;
continue;
} else {
}
...
var i_38522 = (self__.level + (1));
while(true){
if((i_38522 <= (new_level + (1)))){
(update[i_38522] = self__.header);

var G__38523 = (i_38522 + (1));
i_38522 = G__38523;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_38525 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_38525[i]));
} else {
x__$2.forward.push((((i < links_38525.length))?(links_38525[i]):null));
}

if((i < links_38525.length)){
(links_38525[i] = x__$2);
} else {
links_38525.push(x__$2);
}
...
var i_38527 = (0);
while(true){
if((i_38527 <= self__.level)){
var links_38528 = (update[i_38527]).forward;
if((x__$1 === (((i_38527 < links_38528.length))?(links_38528[i_38527]):null))){
(links_38528[i_38527] = (x__$1.forward[i_38527]));

var G__38529 = (i_38527 + (1));
i_38527 = G__38529;
continue;
} else {
var G__38530 = (i_38527 + (1));
i_38527 = G__38530;
continue;
}
} else {
...
var G__38532 = nx;
var G__38533 = (level__$1 - (1));
x = G__38532;
level__$1 = G__38533;
continue;
} else {
var G__38534 = x;
var G__38535 = (level__$1 - (1));
x = G__38534;
level__$1 = G__38535;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__38537 = nx;
var G__38538 = (level__$1 - (1));
x = G__38537;
level__$1 = G__38538;
continue;
} else {
var G__38539 = x;
var G__38540 = (level__$1 - (1));
x = G__38539;
level__$1 = G__38540;
continue;
}
