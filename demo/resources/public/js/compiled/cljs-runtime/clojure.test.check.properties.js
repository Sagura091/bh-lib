...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k57075,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57075,else__4505__auto__);
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57074){
var self__ = this;
var G__57074__$1 = this;
return (new cljs.core.RecordIter((0),G__57074__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error","error",-978969032)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57076,other57077){
var self__ = this;
var this57076__$1 = this;
return (((!((other57077 == null)))) && ((((this57076__$1.constructor === other57077.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57076__$1.error,other57077.error)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57076__$1.__extmap,other57077.__extmap)))))));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k57075){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k57075);

}
}));

(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__57074){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__57099 = cljs.core.keyword_identical_QMARK_;
var expr__57100 = k__4511__auto__;
if(cljs.core.truth_((pred__57099.cljs$core$IFn$_invoke$arity$2 ? pred__57099.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"error","error",-978969032),expr__57100) : pred__57099.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__57100)))){
return (new clojure.test.check.properties.ErrorResult(G__57074,self__.__meta,self__.__extmap,null));
} else {
return (new clojure.test.check.properties.ErrorResult(self__.error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__57074),null));
}
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__57074){
var self__ = this;
var this__4501__auto____$1 = this;
return (new clojure.test.check.properties.ErrorResult(self__.error,G__57074,self__.__extmap,self__.__hash));
}));
 ...
 */
clojure.test.check.properties.map__GT_ErrorResult = (function clojure$test$check$properties$map__GT_ErrorResult(G__57078){
var extmap__4542__auto__ = (function (){var G__57105 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__57078,new cljs.core.Keyword(null,"error","error",-978969032));
if(cljs.core.record_QMARK_(G__57078)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57105);
} else {
return G__57105;
}
})();
return (new clojure.test.check.properties.ErrorResult(new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(G__57078),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
