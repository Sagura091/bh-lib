...
var vec__35183 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__35187 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35187,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35187,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35183,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35183,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__35190){
var vec__35196 = p__35190;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35196,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35196,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35199,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35199,(1),null);
...
var vec__35204 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35204,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35204,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35204,(2),null);
var vec__35207 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35207,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35207,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35207,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__35211){
var vec__35212 = p__35211;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35212,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35212,(1),null);
...
var vec__35215 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35215,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35215,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35215,(2),null);
...
var vec__35222 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35222,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35222,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35222,(2),null);
var tuple = vec__35222;
...
var G__35331 = cljs.core.next(style_vec);
var G__35332 = ends_w_blanks_QMARK_;
var G__35333 = tuple;
var G__35334 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__35331;
previous_ends_w_blanks_QMARK_ = G__35332;
previous_tuple = G__35333;
out = G__35334;
continue;
}
break;
...
var len__4864__auto___35335 = arguments.length;
var i__4865__auto___35336 = (0);
while(true){
if((i__4865__auto___35336 < len__4864__auto___35335)){
args__4870__auto__.push((arguments[i__4865__auto___35336]));

var G__35337 = (i__4865__auto___35336 + (1));
i__4865__auto___35336 = G__35337;
continue;
} else {
}
break;
...
var vec__35230 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35230,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35230,(1),null);
...
var result = (function (){var G__35233 = zprint.core.parse_string_all_options(rest_options);
var G__35234 = zprint.core.zprint_str_internal;
var G__35235 = ":parse-string-all? call";
var G__35236 = (function (){var G__35237 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__35237) : zprint.zutil.edn_STAR_.call(null,G__35237));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__35233,G__35234,G__35235,G__35236) : zprint.core.process_multiple_forms.call(null,G__35233,G__35234,G__35235,G__35236));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__35242 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35242,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35242,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq35227){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35228,G__35229,seq35227__$2);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___35344 = arguments.length;
var i__4865__auto___35345 = (0);
while(true){
if((i__4865__auto___35345 < len__4864__auto___35344)){
args__4870__auto__.push((arguments[i__4865__auto___35345]));

var G__35346 = (i__4865__auto___35345 + (1));
i__4865__auto___35345 = G__35346;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq35249){
var G__35250 = cljs.core.first(seq35249);
var seq35249__$1 = cljs.core.next(seq35249);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35250,seq35249__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq35251){
var G__35252 = cljs.core.first(seq35251);
var seq35251__$1 = cljs.core.next(seq35251);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35252,seq35251__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___35357 = arguments.length;
var i__4865__auto___35358 = (0);
while(true){
if((i__4865__auto___35358 < len__4864__auto___35357)){
args__4870__auto__.push((arguments[i__4865__auto___35358]));

var G__35359 = (i__4865__auto___35358 + (1));
i__4865__auto___35358 = G__35359;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq35260){
var G__35261 = cljs.core.first(seq35260);
var seq35260__$1 = cljs.core.next(seq35260);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35261,seq35260__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___35362 = arguments.length;
var i__4865__auto___35363 = (0);
while(true){
if((i__4865__auto___35363 < len__4864__auto___35362)){
args__4870__auto__.push((arguments[i__4865__auto___35363]));

var G__35364 = (i__4865__auto___35363 + (1));
i__4865__auto___35363 = G__35364;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq35267){
var G__35268 = cljs.core.first(seq35267);
var seq35267__$1 = cljs.core.next(seq35267);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35268,seq35267__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__35277,form){
var vec__35278 = p__35277;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35278,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35278,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35278,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35278,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__35281 = (cljs.core.truth_((function (){var and__4251__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4251__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35281,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35281,(1),null);
...
var G__35372 = cljs.core.next(sos);
var G__35373 = comment_QMARK_;
var G__35374 = (function (){var or__4253__auto__ = (!(empty_string_QMARK_));
if(or__4253__auto__){
return or__4253__auto__;
} else {
...
var G__35375 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__35372;
previous_comment_QMARK_ = G__35373;
start_interpolating_QMARK_ = G__35374;
out = G__35375;
continue;
}
break;
...
try{var vec__35310 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35310,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35310,(1),null);
...
var vec__35313 = (cljs.core.truth_((function (){var or__4253__auto__ = range_start__$1;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35313,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35313,(1),null);
...
var vec__35316 = (cljs.core.truth_((function (){var and__4251__auto__ = actual_start;
if(cljs.core.truth_(and__4251__auto__)){
return actual_end;
} else {
return and__4251__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35316,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35316,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35316,(2),null);
...
var forms = (function (){var G__35319 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__35319) : zprint.zutil.edn_STAR_.call(null,G__35319));
})();
