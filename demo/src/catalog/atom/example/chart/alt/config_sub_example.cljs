(ns catalog.atom.example.chart.alt.config-sub-example
  (:require [catalog.atom.utils :as e]
            [bh-ui.utils :as ui-utils]
            [bh-ui.utils.helpers :as h]
            [catalog.atom.example.chart.alt.show-data :as sd]
            [re-com.core :as rc]
            [reagent.core :as r]
            [taoensso.timbre :as log]))

(log/info "catalog.atom.example.chart.bar-chart.data-sub-example")
