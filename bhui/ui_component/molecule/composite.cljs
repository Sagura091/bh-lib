(ns ui-component.molecule.composite
...
"
  (:require [ui-component.atom.bhui.table :as bhui-table]
            [ui-component.atom.diagram.editable-digraph :as digraph]
            [ui-component.atom.diagram.diagram.composite-dag-support :as dag-support]
            [ui-component.atom.experimental.ui-element :as e]
            [ui-component.atom.re-com.label :as rc-label]
            [ui-component.atom.re-com.slider :as rc-slider]
            [ui-component.atom.re-com.table :as rc-table]
            [ui-component.atom.resium.globe :as r-globe]
            [ui-component.atom.worldwind.globe :as ww-globe]
            [ui-component.atom.leaflet.globe :as l-globe]
            [ui-component.molecule.composite.util.digraph :as dig]
            ...
            [ui-component.atom.component-registry :as registry]
...
(log/info "ui-component.molecule.composite")
...
(comment
  (do
    (def config @ui-component.molecule.composite.coverage-plan/ui-definition)
    ...
    (def configuration (assoc @ui-component.molecule.composite.coverage-plan/ui-definition
                         :graph graph
...
(comment
  (def configuration @ui-component.molecule.composite.coverage-plan/ui-definition)
...
(comment
  (do
    ...
    (def graph (apply lg/digraph (ui/compute-edges @ui-component.molecule.composite.coverage-plan/ui-definition)))
    (def configuration
      (assoc @ui-component.molecule.composite.coverage-plan/ui-definition
        :graph graph
...
(comment
  (do
    (def data @ui-component.molecule.composite.coverage-plan/ui-definition)
    (def graph (apply lg/digraph (ui/compute-edges @ui-component.molecule.composite.coverage-plan/ui-definition)))
    (def nodes (lg/nodes graph))
