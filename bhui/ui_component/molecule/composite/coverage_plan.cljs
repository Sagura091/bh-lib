(ns ui-component.molecule.composite.coverage-plan
  "provide a composed UI for a \"Coverage Plan\" which shows targets and satellite coverage areas
  on a 3D globe"
  (:require [ui-component.atom.bhui.color-picker :as picker]
            [ui-component.molecule.composite.coverage-plan.support :as s]
            [ui-component.utils :as ui-utils]
            [ui-component.utils.color :as c]
...
(log/info "ui-component.molecule.composite.coverage-plan")
