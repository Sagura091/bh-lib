(ns ui-component.atom.worldwind.globe.shape
  (:require ["worldwindjs" :as WorldWind]
            [ui-component.atom.worldwind.globe.location :as location]
            [ui-component.atom.worldwind.globe.shape.attributes :as attributes]
            [taoensso.timbre :as log]))


(log/info "ui-component.atom.worldwind.globe.shape")
