(ns bh-ui.atom.worldwind.globe.react-support
  (:require ["worldwindjs" :as WorldWind]
            [reagent.core :as r]
            [reagent.dom :as rdom]
            [clojure.set :as set]
            [bh-ui.atom.worldwind.globe.projection :as proj]
            [bh-ui.atom.worldwind.globe.globe-time :as gt]
            [bh-ui.atom.worldwind.globe.layer :as l]
            [bh-ui.atom.worldwind.globe.layer.controls :as controls]
            [bh-ui.atom.worldwind.globe.layer.coordinates :as coords]
            [taoensso.timbre :as log]))


(log/info "bh-ui.atom.worldwind.globe.react-support")
