...
(def ui-definition {:mol/components  {; ui components
                                      ...
                                      ; remote data sources
                                      :topic/target-data         {:atm/role :source/local :atm/kind :source/local :atm/default-data remote-targets}
                                      :topic/satellite-data      {:atm/role :source/local :atm/kind :source/local :atm/default-data remote-satellites}
                                      :topic/coverage-data       {:atm/role :source/local :atm/kind :source/local :atm/default-data remote-coverages}
                                      :topic/glm-data            {:atm/role :source/local :atm/kind :source/local :atm/default-data glm}
                                      :topic/meso-data           {:atm/role :source/local :atm/kind :source/local :atm/default-data meso}
                                      ...
                                      :topic/selected-targets    {:atm/role :source/local :atm/kind :source/local :atm/default-data #{"Fire-prst-0001"
                                      ...
                                      :topic/selected-satellites {:atm/role :source/local :atm/kind :source/local :atm/default-data #{"abi-16-meso-1" "abi-16-meso-2"
                                      ...
                                      :topic/selected-imagery    {:atm/role :source/local :atm/kind :source/local :atm/default-data #{"glm-1" "abi-17-FD" "abi-16-meso-1"}}

                                      :topic/target-filter       {:atm/role :source/local :atm/kind :source/local :atm/default-data ""}
                                      :topic/current-slider      {:atm/role :source/local :atm/kind :source/local :atm/default-data 0}
                                      :topic/colored-targets     {:atm/role :source/local :atm/kind :source/local}
                                      :topic/colored-satellites  {:atm/role :source/local :atm/kind :source/local}}
...
(comment
  ...
  (bh/utils-handle-change-path [:coverage-plan-demo-ww.grid-widget :blackboard :topic.colored-targets] []
    new-colors)
