 ...
 */
(self["webpackChunkbh_rccst"] = self["webpackChunkbh_rccst"] || []).push([["node_modules_astrouxds_astro-web-components_dist_esm_rux-radio-group_entry_js"],{
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   rux_radio_group: () => (/* binding */ RuxRadioGroup)\n/* harmony export */ });\n/* harmony import */ var _index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-b64764b4.js */ \"./node_modules/@astrouxds/astro-web-components/dist/esm/index-b64764b4.js\");\n/* harmony import */ var _FormFieldMessage_9a3fc22c_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FormFieldMessage-9a3fc22c.js */ \"./node_modules/@astrouxds/astro-web-components/dist/esm/FormFieldMessage-9a3fc22c.js\");\n/* harmony import */ var _utils_73490106_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils-73490106.js */ \"./node_modules/@astrouxds/astro-web-components/dist/esm/utils-73490106.js\");\n\n\n\n\nconst ruxRadioGroupCss = \".rux-help-text{margin-top:0.625rem;color:var(--color-text-primary);font-size:var(--font-body-2-font-size);font-family:var(--font-body-2-font-family);font-weight:var(--font-body-2-font-weight);letter-spacing:var(--font-body-2-letter-spacing)}.rux-error-text{display:flex;align-items:center;text-align:left;width:fit-content;-webkit-order:3;order:3;margin-top:0.625rem;color:var(--color-text-error);font-size:var(--font-body-2-bold-font-size);font-family:var(--font-body-2-bold-font-family);font-weight:var(--font-body-2-bold-font-weight);letter-spacing:var(--font-body-2-bold-letter-spacing)}.rux-error-text svg{margin-right:0.625rem}:host{--radiogroup-border-color:var(--color-border-interactive-muted);display:block}.hidden,:host([hidden]){display:none}::slotted(rux-radio){display:block;margin-bottom:0.625rem}::slotted(rux-radio:last-of-type){margin-bottom:0}.rux-radio-group{padding:1rem;border:1px solid var(--radiogroup-border-color, #2b659b);border-radius:var(--radius-base)}.rux-radio-group--invalid{border:1px solid var(--color-border-error)}.rux-label{margin-bottom:var(--spacing-input-label-top)}.rux-label__asterisk{margin-left:4px}\";\n\nconst RuxRadioGroup = class {\n  constructor(hostRef) {\n    (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);\n    this.ruxChange = (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, \"ruxchange\", 7);\n    this.hasLabelSlot = false;\n    /**\n     * Presentational only. Renders the Radio Group as invalid.\n     */\n    this.invalid = false;\n    /**\n     * Marks that a selection from the radio-group is requried.\n     */\n    this.required = false;\n    /**\n     * The name of the radio group - submitted with form data. Must match the name of the radios in the group.\n     */\n    this.name = '';\n  }\n  emitChange() {\n    this.ruxChange.emit(this.value);\n  }\n  handleLabelChange() {\n    this._handleSlotChange();\n  }\n  connectedCallback() {\n    this._handleClick = this._handleClick.bind(this);\n    this._handleSlotChange = this._handleSlotChange.bind(this);\n  }\n  disconnectedCallback() {\n    this.el.shadowRoot.removeEventListener('slotchange', this._handleSlotChange);\n  }\n  componentWillLoad() {\n    const radios = Array.from(this.el.querySelectorAll('rux-radio'));\n    if (radios.length > 1 && !this.value) {\n      this.value = radios[0].getAttribute('value');\n    }\n    this._handleSlotChange();\n  }\n  get hasLabel() {\n    return this.label ? true : this.hasLabelSlot;\n  }\n  _handleClick(e) {\n    const selectedRadio = e.target && e.target.closest('rux-radio');\n    if (selectedRadio && !selectedRadio.disabled) {\n      const oldValue = this.value;\n      const newValue = selectedRadio.value;\n      if (newValue !== oldValue) {\n        this.value = newValue;\n      }\n    }\n  }\n  _selectedRadioIsDisabled() {\n    const radio = this.el.querySelector(`rux-radio[value=\"${this.value}\"]`);\n    return radio && radio.disabled;\n  }\n  _handleSlotChange() {\n    this.hasLabelSlot = (0,_utils_73490106_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'label');\n  }\n  render() {\n    if (this.value) {\n      (0,_utils_73490106_js__WEBPACK_IMPORTED_MODULE_2__.r)(true, this.el, this.name, this.value, this._selectedRadioIsDisabled());\n    }\n    return ((0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this._handleClick }, (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(\"div\", { class: \"rux-form-field\", part: \"form-field\" }, (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(\"div\", { class: {\n        'rux-label': true,\n        hidden: !this.hasLabel,\n      }, part: \"label\" }, (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(\"slot\", { onSlotchange: this._handleSlotChange, name: \"label\" }, this.label, this.required && ((0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(\"span\", { part: \"required\", class: \"rux-label__asterisk\" }, \"*\")))), (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(\"div\", { class: {\n        'rux-radio-group': true,\n        'rux-radio-group--invalid': this.invalid,\n      }, role: \"radiogroup\", part: \"radiogroup\" }, (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(\"slot\", null))), (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(_FormFieldMessage_9a3fc22c_js__WEBPACK_IMPORTED_MODULE_1__.F, { errorText: this.errorText, helpText: this.helpText })));\n  }\n  get el() { return (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.g)(this); }\n  static get watchers() { return {\n    \"value\": [\"emitChange\"],\n    \"label\": [\"handleLabelChange\"]\n  }; }\n};\nRuxRadioGroup.style = ruxRadioGroupCss;\n\n\n\n\n//# sourceURL=webpack://bh.rccst/./node_modules/@astrouxds/astro-web-components/dist/esm/rux-radio-group.entry.js?");
