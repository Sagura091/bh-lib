 ...
 */
(self["webpackChunkbh_rccst"] = self["webpackChunkbh_rccst"] || []).push([["node_modules_astrouxds_astro-web-components_dist_esm_rux-classification-marking_entry_js"],{
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   rux_classification_marking: () => (/* binding */ RuxClassificationMarking)\n/* harmony export */ });\n/* harmony import */ var _index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-b64764b4.js */ \"./node_modules/@astrouxds/astro-web-components/dist/esm/index-b64764b4.js\");\n/* harmony import */ var _utils_73490106_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils-73490106.js */ \"./node_modules/@astrouxds/astro-web-components/dist/esm/utils-73490106.js\");\n\n\n\nconst ruxClassificationMarkingCss = \":host{display:block}:host([hidden]){display:none}.rux-classification{font-family:var(--font-body-1-bold-font-family);font-size:var(--font-body-1-bold-font-size);font-weight:var(--font-body-1-bold-font-weight);letter-spacing:var(--font-body-1-bold-letter-spacing);color:var(--color-text-white);background-color:var(--classification-banner-color-background-unclassified);text-transform:uppercase}.rux-classification--banner{z-index:1000;display:flex;justify-content:center;align-items:center;min-height:26px;transition:top 10.5s ease;overflow-wrap:anywhere;color:var(--color-text-white);background-color:var(--classification-banner-color-background-unclassified);position:sticky;top:0;left:0;flex-wrap:nowrap;flex-grow:1;width:100%}.rux-classification--banner__footer{bottom:0;top:inherit;position:sticky}.rux-classification--tag{width:fit-content;padding:0.1875rem 0.625rem;border-radius:var(--radius-base);font-family:var(--font-body-2-bold-font-family);font-size:var(--font-body-2-bold-font-size);font-weight:var(--font-body-2-bold-font-weight);letter-spacing:var(--font-body-2-bold-letter-spacing)}:host([classification=top-secret-sci]) .rux-classification{background-color:var(--classification-banner-color-background-topsecretsci);color:var(--color-text-black)}:host([classification=top-secret]) .rux-classification{background-color:var(--classification-banner-color-background-topsecret);color:var(--color-text-black)}:host([classification=secret]) .rux-classification{background-color:var(--classification-banner-color-background-secret)}:host([classification=confidential]) .rux-classification{background-color:var(--classification-banner-color-background-confidential)}:host([classification=cui]) .rux-classification,:host([classification=controlled]) .rux-classification{background-color:var(--classification-banner-color-background-cui)}:host([classification=unclassified]) .rux-classification{background-color:var(--classification-banner-color-background-unclassified)}\";\n\nconst RuxClassificationMarking = class {\n  constructor(hostRef) {\n    (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);\n    /**\n     * Defines which classification marking will be displayed.\n     */\n    this.classification = 'unclassified';\n    /**\n     * Declares the marking as a `tag` rather than the default banner style\n     */\n    this.tag = false;\n    this.isWrapper = (0,_utils_73490106_js__WEBPACK_IMPORTED_MODULE_1__.h)(this.el);\n  }\n  _handleSlotChange() {\n    this.isWrapper = (0,_utils_73490106_js__WEBPACK_IMPORTED_MODULE_1__.h)(this.el);\n  }\n  connectedCallback() {\n    this._handleSlotChange = this._handleSlotChange.bind(this);\n  }\n  disconnectedCallback() {\n    this.el.shadowRoot.removeEventListener('slotchange', this._handleSlotChange);\n  }\n  get type() {\n    return this.tag ? 'tag' : 'banner';\n  }\n  _getDisplayData() {\n    const markings = {\n      banner: {\n        cui: 'cui',\n        controlled: 'controlled',\n        confidential: 'confidential',\n        secret: 'secret',\n        'top-secret': 'top secret',\n        'top-secret-sci': 'top secret//sci',\n        unclassified: 'unclassified',\n      },\n      tag: {\n        cui: 'cui',\n        controlled: 'cui',\n        confidential: 'c',\n        secret: 's',\n        'top-secret': 'ts',\n        'top-secret-sci': 'TS//SCI',\n        unclassified: 'u',\n      },\n    };\n    const text = markings[this.type][this.classification];\n    return text;\n  }\n  render() {\n    const { isWrapper, label, tag, type } = this;\n    return ((0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(\"div\", { class: {\n        'rux-classification': true,\n        'rux-classification--tag': type === 'tag',\n        'rux-classification--banner': type === 'banner',\n      }, part: \"tag header\" }, this._getDisplayData(), label), (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(\"slot\", null), isWrapper && !tag && ((0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(\"div\", { class: {\n        'rux-classification': true,\n        'rux-classification--banner': type === 'banner',\n        'rux-classification--banner__footer': isWrapper === true,\n      }, part: \"footer-banner footer\" }, this._getDisplayData(), label))));\n  }\n  get el() { return (0,_index_b64764b4_js__WEBPACK_IMPORTED_MODULE_0__.g)(this); }\n};\nRuxClassificationMarking.style = ruxClassificationMarkingCss;\n\n\n\n\n//# sourceURL=webpack://bh.rccst/./node_modules/@astrouxds/astro-web-components/dist/esm/rux-classification-marking.entry.js?");
