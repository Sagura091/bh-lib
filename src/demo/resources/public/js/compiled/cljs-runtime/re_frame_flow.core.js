...
var G__24753 = cljs.core.PersistentHashSet.EMPTY;
var G__24753__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(result))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24753,cljs.core.first(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(result))):G__24753);
var G__24753__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236).cljs$core$IFn$_invoke$arity$1(result))?clojure.set.union.cljs$core$IFn$_invoke$arity$2(G__24753__$1,cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236).cljs$core$IFn$_invoke$arity$1(result))))):G__24753__$1);
var G__24753__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"dispatch-later","dispatch-later",291951390).cljs$core$IFn$_invoke$arity$1(result))?(function (p1__24752_SHARP_){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__24752_SHARP_,cljs.core.first(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"dispatch-later","dispatch-later",291951390).cljs$core$IFn$_invoke$arity$1(result))));
} else {
return clojure.set.union.cljs$core$IFn$_invoke$arity$2(p1__24752_SHARP_,cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.first,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009)),cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,new cljs.core.Keyword(null,"dispatch-later","dispatch-later",291951390).cljs$core$IFn$_invoke$arity$1(result)))));
}
})(G__24753__$2):G__24753__$2);
var G__24753__$4 = (cljs.core.truth_(new cljs.core.Keyword(null,"on-success","on-success",1786904109).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http","http",382524695).cljs$core$IFn$_invoke$arity$1(result)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24753__$3,cljs.core.first(new cljs.core.Keyword(null,"on-success","on-success",1786904109).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http","http",382524695).cljs$core$IFn$_invoke$arity$1(result)))):G__24753__$3);
var G__24753__$5 = (cljs.core.truth_(new cljs.core.Keyword(null,"on-success","on-success",1786904109).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http-xhrio","http-xhrio",1846166714).cljs$core$IFn$_invoke$arity$1(result)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24753__$4,cljs.core.first(new cljs.core.Keyword(null,"on-success","on-success",1786904109).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http-xhrio","http-xhrio",1846166714).cljs$core$IFn$_invoke$arity$1(result)))):G__24753__$4);
var G__24753__$6 = (cljs.core.truth_(new cljs.core.Keyword(null,"on-failure","on-failure",842888245).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http","http",382524695).cljs$core$IFn$_invoke$arity$1(result)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24753__$5,cljs.core.first(new cljs.core.Keyword(null,"on-failure","on-failure",842888245).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http","http",382524695).cljs$core$IFn$_invoke$arity$1(result)))):G__24753__$5);
var G__24753__$7 = (cljs.core.truth_(new cljs.core.Keyword(null,"on-failure","on-failure",842888245).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http-xhrio","http-xhrio",1846166714).cljs$core$IFn$_invoke$arity$1(result)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24753__$6,cljs.core.first(new cljs.core.Keyword(null,"on-failure","on-failure",842888245).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"http-xhrio","http-xhrio",1846166714).cljs$core$IFn$_invoke$arity$1(result)))):G__24753__$6);
return clojure.set.union.cljs$core$IFn$_invoke$arity$2(G__24753__$7,cljs.core.set(cljs.core.keys(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(result,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),new cljs.core.Keyword(null,"dispatch-later","dispatch-later",291951390),new cljs.core.Keyword(null,"http","http",382524695),new cljs.core.Keyword(null,"http-xhrio","http-xhrio",1846166714)], 0)))));
...
var nodes = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24760_SHARP_){
return re_frame_flow.core.id__GT_node(p1__24760_SHARP_,cljs.core.boolean$((p1__24760_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__24760_SHARP_.cljs$core$IFn$_invoke$arity$1(dispatches) : p1__24760_SHARP_.call(null,dispatches))));
}),cljs.core.cons(k,v));
...
re_frame_flow.core.get_id__GT_node_map = (function re_frame_flow$core$get_id__GT_node_map(p__24764){
var map__24765 = p__24764;
var map__24765__$1 = cljs.core.__destructure_map(map__24765);
var handlers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24765__$1,new cljs.core.Keyword(null,"handlers","handlers",79528781));
var dispatches = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24765__$1,new cljs.core.Keyword(null,"dispatches","dispatches",-331249187));
var kind__GT_id__GT_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24765__$1,new cljs.core.Keyword(null,"kind->id->handler","kind->id->handler",-214642779));
var fx = new cljs.core.Keyword(null,"fx","fx",-1237829572).cljs$core$IFn$_invoke$arity$1(kind__GT_id__GT_handler);
var events__$1 = new cljs.core.Keyword(null,"event","event",301435442).cljs$core$IFn$_invoke$arity$1(kind__GT_id__GT_handler);
...
var color = (cljs.core.truth_((id.cljs$core$IFn$_invoke$arity$1 ? id.cljs$core$IFn$_invoke$arity$1(dispatches) : id.call(null,dispatches)))?"orange":(cljs.core.truth_((id.cljs$core$IFn$_invoke$arity$1 ? id.cljs$core$IFn$_invoke$arity$1(fx) : id.call(null,fx)))?"red":((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"db-handler","db-handler",579530098),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cljs.core.last((id.cljs$core$IFn$_invoke$arity$1 ? id.cljs$core$IFn$_invoke$arity$1(events__$1) : id.call(null,events__$1))))))?"#336edc":"green"
)));
...
var new_context = ((re_frame.trace.is_trace_enabled_QMARK_())?(function (){var _STAR_current_trace_STAR__orig_val__24769 = re_frame.trace._STAR_current_trace_STAR_;
var _STAR_current_trace_STAR__temp_val__24770 = re_frame.trace.start_trace(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"op-type","op-type",-1636141668),new cljs.core.Keyword("event","handler","event/handler",-295903150),new cljs.core.Keyword(null,"operation","operation",-1267664310),re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,new cljs.core.Keyword(null,"original-event","original-event",2121330403))], null));
(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__temp_val__24770);

try{try{var map__24772 = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__24772__$1 = cljs.core.__destructure_map(map__24772);
var coeffects = map__24772__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24772__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var result_24811__$1 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(result,new cljs.core.Keyword(null,"db","db",993250759));
var deps_24812 = re_frame_flow.core.get_deps(result_24811__$1);
...
var end__24074__auto___24813 = re_frame.interop.now();
var duration__24075__auto___24814 = (end__24074__auto___24813 - new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(re_frame.trace._STAR_current_trace_STAR_));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(re_frame.trace.traces,cljs.core.conj,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"duration","duration",1444101068),duration__24075__auto___24814,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"end","end",-268185958),re_frame.interop.now()], 0)));

re_frame.trace.run_tracing_callbacks_BANG_(end__24074__auto___24813);
} else {
}
}}finally {(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__orig_val__24769);
}})():(function (){var map__24774 = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__24774__$1 = cljs.core.__destructure_map(map__24774);
var coeffects = map__24774__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24774__$1,new cljs.core.Keyword(null,"event","event",301435442));
var result = (handler_fn.cljs$core$IFn$_invoke$arity$2 ? handler_fn.cljs$core$IFn$_invoke$arity$2(coeffects,event) : handler_fn.call(null,coeffects,event));
var result_24815__$1 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(result,new cljs.core.Keyword(null,"db","db",993250759));
var deps_24816 = re_frame_flow.core.get_deps(result_24815__$1);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(re_frame_flow.core.state_STAR_,(function (state,id__$1,v){
var state__$1 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"handlers","handlers",79528781),id__$1], null),clojure.set.union,v);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"id->node-map","id->node-map",1816082127),re_frame_flow.core.get_id__GT_node_map(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"handlers","handlers",79528781),new cljs.core.Keyword(null,"handlers","handlers",79528781).cljs$core$IFn$_invoke$arity$1(state__$1),new cljs.core.Keyword(null,"dispatches","dispatches",-331249187),new cljs.core.Keyword(null,"dispatches","dispatches",-331249187).cljs$core$IFn$_invoke$arity$1(state__$1),new cljs.core.Keyword(null,"kind->id->handler","kind->id->handler",-214642779),cljs.core.deref(re_frame.registrar.kind__GT_id__GT_handler)], null)));
}),id,deps_24816);
...
return (fexpr__24776.cljs$core$IFn$_invoke$arity$2 ? fexpr__24776.cljs$core$IFn$_invoke$arity$2(id,handler) : fexpr__24776.call(null,id,handler));
})()], null));
});
...
re_frame_flow.core.Graph = shadow.js.shim.module$dagre.graphlib.Graph;
...
re_frame_flow.core.react_flow_pro = reagent.core.adapt_react_class(shadow.js.shim.module$react_flow_renderer.ReactFlowProvider);
re_frame_flow.core.react_flow = reagent.core.adapt_react_class(shadow.js.shim.module$react_flow_renderer.default);
re_frame_flow.core.background = reagent.core.adapt_react_class(shadow.js.shim.module$react_flow_renderer.Background);
re_frame_flow.core.controls = reagent.core.adapt_react_class(shadow.js.shim.module$react_flow_renderer.Controls);
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__24779_SHARP_){
var or__4253__auto__ = new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(p1__24779_SHARP_));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var G__24785 = p1__24779_SHARP_;
var G__24785__$1 = (((G__24785 == null))?null:new cljs.core.Keyword(null,"source","source",-433931539).cljs$core$IFn$_invoke$arity$1(G__24785));
var G__24785__$2 = (((G__24785__$1 == null))?null:re_frame_flow.core.kw__GT_str(G__24785__$1));
if((G__24785__$2 == null)){
return null;
} else {
return (dispatch_node_ids.cljs$core$IFn$_invoke$arity$1 ? dispatch_node_ids.cljs$core$IFn$_invoke$arity$1(G__24785__$2) : dispatch_node_ids.call(null,G__24785__$2));
}
}
}),elements_STAR_);
})());
var _ = (function (){var seq__24787 = cljs.core.seq(elements_STAR___$1);
var chunk__24788 = null;
var count__24789 = (0);
var i__24790 = (0);
while(true){
if((i__24790 < count__24789)){
var el = chunk__24788.cljs$core$IIndexed$_nth$arity$2(null,i__24790);
...
var G__24820 = seq__24787;
var G__24821 = chunk__24788;
var G__24822 = count__24789;
var G__24823 = (i__24790 + (1));
seq__24787 = G__24820;
chunk__24788 = G__24821;
count__24789 = G__24822;
i__24790 = G__24823;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__24787);
if(temp__5753__auto__){
var seq__24787__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__24787__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__24787__$1);
var G__24824 = cljs.core.chunk_rest(seq__24787__$1);
var G__24825 = c__4679__auto__;
var G__24826 = cljs.core.count(c__4679__auto__);
var G__24827 = (0);
seq__24787 = G__24824;
chunk__24788 = G__24825;
count__24789 = G__24826;
i__24790 = G__24827;
continue;
} else {
var el = cljs.core.first(seq__24787__$1);
if(cljs.core.truth_(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(el))){
re_frame_flow.core.dagre_graph.setNode(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(el),cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),width,new cljs.core.Keyword(null,"height","height",1025178622),height], null)));
} else {
re_frame_flow.core.dagre_graph.setEdge(new cljs.core.Keyword(null,"source","source",-433931539).cljs$core$IFn$_invoke$arity$1(el),new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(el));
...
var G__24828 = cljs.core.next(seq__24787__$1);
var G__24829 = null;
var G__24830 = (0);
var G__24831 = (0);
seq__24787 = G__24828;
chunk__24788 = G__24829;
count__24789 = G__24830;
i__24790 = G__24831;
continue;
}
} else {
...
var ___$1 = shadow.js.shim.module$dagre.layout(re_frame_flow.core.dagre_graph);
...
return cljs.core.reset_BANG_(elements,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24780_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__24780_SHARP_),p1__24780_SHARP_],null));
}),elements_STAR___$2)));
});
...
return cljs.core.cons(id,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__24791_SHARP_){
return re_frame_flow.core.traverse_path.cljs$core$IFn$_invoke$arity$3(m,state__$1,p1__24791_SHARP_);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__24799_SHARP_){
var or__4253__auto__ = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(p1__24799_SHARP_);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var G__24800 = new cljs.core.Keyword(null,"source","source",-433931539).cljs$core$IFn$_invoke$arity$1(p1__24799_SHARP_);
return (sources.cljs$core$IFn$_invoke$arity$1 ? sources.cljs$core$IFn$_invoke$arity$1(G__24800) : sources.call(null,G__24800));
}
}),elements);
});
