...
var G__30855 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__30855__$1 = (((G__30855 == null))?null:cljs.core.iterate((function (loc){
...
var G__30855__$2 = (((G__30855__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__30855__$1));
var G__30855__$3 = (((G__30855__$2 == null))?null:cljs.core.last(G__30855__$2));
if((G__30855__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__30855__$3);
}
} else {
return zloc;
}
...
var G__30866 = rewrite_clj.zip.move.right(v);
var G__30867 = rewrite_clj.zip.move.up(v);
loc = G__30866;
parent = G__30867;
continue;
} else {
var G__30868 = rewrite_clj.zip.move.right(v0);
var G__30869 = parent;
loc = G__30868;
parent = G__30869;
continue;
...
var G__30871 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__30872 = rewrite_clj.zip.move.up(v);
loc = G__30871;
parent = G__30872;
continue;
} else {
var G__30873 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__30874 = parent;
loc = G__30873;
parent = G__30874;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__30860 = zloc;
var G__30860__$1 = (((G__30860 == null))?null:rewrite_clj.zip.move.down(G__30860));
var G__30860__$2 = (((G__30860__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__30860__$1,k));
if((G__30860__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__30860__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__30861 = rewrite_clj.zip.move.down(zloc);
var G__30861__$1 = (((G__30861 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__30861));
if((G__30861__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__30861__$1);
}
})(),k);
}
});
