...
var G__23368 = o;
reagent.impl.template.goog$module$goog$object.set(G__23368,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23386__delegate = function (args){
...
while (G__23387__i < G__23387__a.length) {G__23387__a[G__23387__i] = arguments[G__23387__i + 0]; ++G__23387__i;}
  args = new cljs.core.IndexedSeq(G__23387__a,0,null);
} 
return G__23386__delegate.call(this,args);};
G__23386.cljs$lang$maxFixedArity = 0;
G__23386.cljs$lang$applyTo = (function (arglist__23388){
var args = cljs.core.seq(arglist__23388);
return G__23386__delegate(args);
});
...
var G__23369 = o;
reagent.impl.template.goog$module$goog$object.set(G__23369,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__23389__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__23389 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__23390__i = 0, G__23390__a = new Array(arguments.length -  0);
while (G__23390__i < G__23390__a.length) {G__23390__a[G__23390__i] = arguments[G__23390__i + 0]; ++G__23390__i;}
  args = new cljs.core.IndexedSeq(G__23390__a,0,null);
} 
return G__23389__delegate.call(this,args);};
G__23389.cljs$lang$maxFixedArity = 0;
G__23389.cljs$lang$applyTo = (function (arglist__23391){
var args = cljs.core.seq(arglist__23391);
return G__23389__delegate(args);
});
...
var G__23370 = props;
var G__23370__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23370,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23370);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23370__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23371 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23371,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23371;
}
})(),id_class);
...
var G__23372 = (cljs.core.count(argv) - first_child);
switch (G__23372) {
case (0):
...
var vec__23373 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23373,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23373,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23373,(2),null);
...
var temp__5757__auto___23395 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___23395 == null)){
} else {
var key_23396 = temp__5757__auto___23395;
(jsprops.key = key_23396);
}
...
var temp__5757__auto___23398 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___23398 == null)){
} else {
var key_23400 = temp__5757__auto___23398;
(jsprops.key = key_23400);
}
...
var temp__5757__auto___23405 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___23405 == null)){
} else {
var key_23406 = temp__5757__auto___23405;
(jsprops.key = key_23406);
}
...
var temp__5757__auto___23410 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___23410 == null)){
} else {
var key_23413 = temp__5757__auto___23410;
(jsprops.key = key_23413);
}
...
var temp__5757__auto___23415 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___23415 == null)){
} else {
var key_23417 = temp__5757__auto___23415;
(jsprops.key = key_23417);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23376_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23376_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23377 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23377,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23377,(1),null);
...
break;
default:
var G__23420 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__23421 = compiler;
v = G__23420;
compiler = G__23421;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template23383 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template23383 = (function (opts,id,fn_to_element,parse_fn,meta23384){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23383.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23385,meta23384__$1){
var self__ = this;
var _23385__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23383(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23384__$1));
}));

(reagent.impl.template.t_reagent$impl$template23383.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23385){
var self__ = this;
var _23385__$1 = this;
return self__.meta23384;
}));

(reagent.impl.template.t_reagent$impl$template23383.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23383.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23383.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23383.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23383.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23383.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23384","meta23384",-197897380,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23383.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23383.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23383");

(reagent.impl.template.t_reagent$impl$template23383.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template23383");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23383.
 */
reagent.impl.template.__GT_t_reagent$impl$template23383 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template23383(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta23384){
return (new reagent.impl.template.t_reagent$impl$template23383(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta23384));
});

}

return (new reagent.impl.template.t_reagent$impl$template23383(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
