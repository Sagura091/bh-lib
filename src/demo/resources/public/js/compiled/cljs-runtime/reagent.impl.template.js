...
var G__43453 = o;
reagent.impl.template.goog$module$goog$object.set(G__43453,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__43471__delegate = function (args){
...
while (G__43472__i < G__43472__a.length) {G__43472__a[G__43472__i] = arguments[G__43472__i + 0]; ++G__43472__i;}
  args = new cljs.core.IndexedSeq(G__43472__a,0,null);
} 
return G__43471__delegate.call(this,args);};
G__43471.cljs$lang$maxFixedArity = 0;
G__43471.cljs$lang$applyTo = (function (arglist__43473){
var args = cljs.core.seq(arglist__43473);
return G__43471__delegate(args);
});
...
var G__43454 = o;
reagent.impl.template.goog$module$goog$object.set(G__43454,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__43474__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__43475__i < G__43475__a.length) {G__43475__a[G__43475__i] = arguments[G__43475__i + 0]; ++G__43475__i;}
  args = new cljs.core.IndexedSeq(G__43475__a,0,null);
} 
return G__43474__delegate.call(this,args);};
...
return G__43474__delegate(args);
});
...
var G__43455 = props;
var G__43455__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43455,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__43455);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43455__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__43456 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43456,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__43456;
}
})(),id_class);
...
var G__43457 = (cljs.core.count(argv) - first_child);
switch (G__43457) {
case (0):
...
var vec__43458 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43458,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43458,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43458,(2),null);
...
var temp__5757__auto___43478 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___43478 == null)){
} else {
var key_43479 = temp__5757__auto___43478;
(jsprops.key = key_43479);
}
...
var temp__5757__auto___43480 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___43480 == null)){
} else {
var key_43481 = temp__5757__auto___43480;
(jsprops.key = key_43481);
}
...
var temp__5757__auto___43482 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___43482 == null)){
} else {
var key_43483 = temp__5757__auto___43482;
(jsprops.key = key_43483);
}
...
var temp__5757__auto___43484 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___43484 == null)){
} else {
var key_43485 = temp__5757__auto___43484;
(jsprops.key = key_43485);
}
...
var temp__5757__auto___43486 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___43486 == null)){
} else {
var key_43487 = temp__5757__auto___43486;
(jsprops.key = key_43487);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43461_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__43461_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__43462 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43462,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43462,(1),null);
...
break;
default:
var G__43489 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__43490 = compiler;
v = G__43489;
compiler = G__43490;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template43468 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template43468 = (function (opts,id,fn_to_element,parse_fn,meta43469){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta43469 = meta43469;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template43468.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43470,meta43469__$1){
var self__ = this;
var _43470__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template43468(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta43469__$1));
}));

(reagent.impl.template.t_reagent$impl$template43468.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43470){
var self__ = this;
var _43470__$1 = this;
return self__.meta43469;
}));

(reagent.impl.template.t_reagent$impl$template43468.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template43468.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template43468.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template43468.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template43468.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template43468.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta43469","meta43469",969493482,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template43468.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template43468.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template43468");

(reagent.impl.template.t_reagent$impl$template43468.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template43468");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template43468.
 */
reagent.impl.template.__GT_t_reagent$impl$template43468 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template43468(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta43469){
return (new reagent.impl.template.t_reagent$impl$template43468(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta43469));
});

}

return (new reagent.impl.template.t_reagent$impl$template43468(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
