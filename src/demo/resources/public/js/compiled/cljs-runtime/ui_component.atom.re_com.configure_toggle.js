goog.provide('ui_component.atom.re_com.configure_toggle');
/**
 ...
 *   
 */
ui_component.atom.re_com.configure_toggle.configure_toggle = (function ui_component$atom$re_com$configure_toggle$configure_toggle(var_args){
var G__51101 = arguments.length;
switch (G__51101) {
case 2:
return ui_component.atom.re_com.configure_toggle.configure_toggle.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));

break;
case 1:
return ui_component.atom.re_com.configure_toggle.configure_toggle.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));
...
(ui_component.atom.re_com.configure_toggle.configure_toggle.cljs$core$IFn$_invoke$arity$2 = (function (show_QMARK_,fn_to_apply){
...
(ui_component.atom.re_com.configure_toggle.configure_toggle.cljs$core$IFn$_invoke$arity$1 = (function (show_QMARK_){
return ui_component.atom.re_com.configure_toggle.configure_toggle.cljs$core$IFn$_invoke$arity$2(show_QMARK_,null);
}));

(ui_component.atom.re_com.configure_toggle.configure_toggle.cljs$lang$maxFixedArity = 2);


//# sourceMappingURL=ui_component.atom.re_com.configure_toggle.js.map
