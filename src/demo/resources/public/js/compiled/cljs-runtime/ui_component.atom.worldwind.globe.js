...
return ui_component.atom.worldwind.globe.globe_STAR_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4871__auto__);
});

(ui_component.atom.worldwind.globe.globe_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (props,children){
...
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ui_component.atom.worldwind.globe.projection.projections,(0));
}
})(),new cljs.core.Keyword(null,"layers","layers",1944875032),reagent.core.children(this$)], 0));
}),new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),cljs.core.partial.cljs$core$IFn$_invoke$arity$3(ui_component.atom.worldwind.globe.react_support.component_did_mount,dom_node,state),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),cljs.core.partial.cljs$core$IFn$_invoke$arity$3(ui_component.atom.worldwind.globe.react_support.component_did_update,dom_node,state),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function() { 
var G__59613__delegate = function (props__$1,children__$1){
...
return ui_component.atom.worldwind.globe.DEFAULT_BACKGROUND_COLOR;
}
})();
...
var G__59613 = function (props__$1,var_args){
var children__$1 = null;
if (arguments.length > 1) {
var G__59614__i = 0, G__59614__a = new Array(arguments.length -  1);
while (G__59614__i < G__59614__a.length) {G__59614__a[G__59614__i] = arguments[G__59614__i + 1]; ++G__59614__i;}
  children__$1 = new cljs.core.IndexedSeq(G__59614__a,0,null);
} 
return G__59613__delegate.call(this,props__$1,children__$1);};
G__59613.cljs$lang$maxFixedArity = 1;
G__59613.cljs$lang$applyTo = (function (arglist__59615){
var props__$1 = cljs.core.first(arglist__59615);
var children__$1 = cljs.core.rest(arglist__59615);
return G__59613__delegate(props__$1,children__$1);
});
...
(ui_component.atom.worldwind.globe.globe_STAR_.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(ui_component.atom.worldwind.globe.globe_STAR_.cljs$lang$applyTo = (function (seq59602){
var G__59603 = cljs.core.first(seq59602);
var seq59602__$1 = cljs.core.next(seq59602);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__59603,seq59602__$1);
}));

ui_component.atom.worldwind.globe.globe_inter = (function ui_component$atom$worldwind$globe$globe_inter(var_args){
var args__4870__auto__ = [];
var len__4864__auto___59616 = arguments.length;
var i__4865__auto___59617 = (0);
while(true){
if((i__4865__auto___59617 < len__4864__auto___59616)){
args__4870__auto__.push((arguments[i__4865__auto___59617]));

var G__59618 = (i__4865__auto___59617 + (1));
i__4865__auto___59617 = G__59618;
continue;
} else {
}
break;
...
return ui_component.atom.worldwind.globe.globe_inter.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});

(ui_component.atom.worldwind.globe.globe_inter.cljs$core$IFn$_invoke$arity$variadic = (function (p__59605){
var map__59606 = p__59605;
var map__59606__$1 = cljs.core.__destructure_map(map__59606);
var shapes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59606__$1,new cljs.core.Keyword(null,"shapes","shapes",1897594879));
var current_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59606__$1,new cljs.core.Keyword(null,"current-time","current-time",-1609407134));
var component_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59606__$1,new cljs.core.Keyword(null,"component-id","component-id",1551113783));
var shape_layers = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(ui_component.atom.worldwind.globe.shape.make_shape,shapes));
var all_layer = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,ui_component.atom.worldwind.globe.base_layers(component_id),shape_layers);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [ui_component.atom.worldwind.globe.globe_STAR_,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"id","id",-1388402092),component_id,new cljs.core.Keyword(null,"time","time",1385887882),cljs_time.coerce.to_date(current_time),new cljs.core.Keyword(null,"projection","projection",-412523042),"3D",new cljs.core.Keyword(null,"min-max","min-max",-1415739170),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"background-color","background-color",570434026),new cljs.core.Keyword(null,"black","black",1294279647),new cljs.core.Keyword(null,"border-radius","border-radius",419594011),"3px",new cljs.core.Keyword(null,"width","width",-384071477),"100%",new cljs.core.Keyword(null,"height","height",1025178622),"100%"], null)], null),all_layer], null);
}));

(ui_component.atom.worldwind.globe.globe_inter.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(ui_component.atom.worldwind.globe.globe_inter.cljs$lang$applyTo = (function (seq59604){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq59604));
}));

ui_component.atom.worldwind.globe.globe = (function ui_component$atom$worldwind$globe$globe(var_args){
var args__4870__auto__ = [];
...
var argseq__4871__auto__ = ((((0) < args__4870__auto__.length))?(new cljs.core.IndexedSeq(args__4870__auto__.slice((0)),(0),null)):null);
return ui_component.atom.worldwind.globe.globe.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});

(ui_component.atom.worldwind.globe.globe.cljs$core$IFn$_invoke$arity$variadic = (function (p__59608){
var map__59609 = p__59608;
var map__59609__$1 = cljs.core.__destructure_map(map__59609);
var shapes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59609__$1,new cljs.core.Keyword(null,"shapes","shapes",1897594879));
var current_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59609__$1,new cljs.core.Keyword(null,"current-time","current-time",-1609407134));
var component_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59609__$1,new cljs.core.Keyword(null,"component-id","component-id",1551113783));
var container_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59609__$1,new cljs.core.Keyword(null,"container-id","container-id",1274665684));
var s = ui_component.utils.helpers.resolve_value(shapes);
var t = ui_component.utils.helpers.resolve_value(current_time);
return (function (){
return new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [ui_component.atom.worldwind.globe.globe_inter,new cljs.core.Keyword(null,"shapes","shapes",1897594879),cljs.core.deref(s),new cljs.core.Keyword(null,"current-time","current-time",-1609407134),(function (){var or__4253__auto__ = cljs.core.deref(t);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
(ui_component.atom.worldwind.globe.globe.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(ui_component.atom.worldwind.globe.globe.cljs$lang$applyTo = (function (seq59607){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq59607));
}));

ui_component.atom.worldwind.globe.meta_data = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("ww","globe","ww/globe",662160797),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"ui-component","ui-component",-389059207),new cljs.core.Keyword(null,"component","component",1555936782),ui_component.atom.worldwind.globe.globe,new cljs.core.Keyword(null,"ports","ports",-1014790862),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"shapes","shapes",1897594879),new cljs.core.Keyword("port","sink","port/sink",185875552),new cljs.core.Keyword(null,"current-time","current-time",-1609407134),new cljs.core.Keyword("port","sink","port/sink",185875552)], null)], null)], null);
re_frame.core.dispatch_sync(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"register-meta","register-meta",1726375773),ui_component.atom.worldwind.globe.meta_data], null));

//# sourceMappingURL=ui_component.atom.worldwind.globe.js.map
