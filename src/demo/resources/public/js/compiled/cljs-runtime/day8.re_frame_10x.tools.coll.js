...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__50298_SHARP_,p2__50297_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__50297_SHARP_) : pred.call(null,p2__50297_SHARP_)))){
return p1__50298_SHARP_;
} else {
return null;
}
}),v);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__50299_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__50299_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__50299_SHARP_) <= ending)));
}));
});
/**
 ...
 */
day8.re_frame_10x.tools.coll.dissoc_in = (function day8$re_frame_10x$tools$coll$dissoc_in(m,p__50300){
var vec__50301 = p__50300;
var seq__50302 = cljs.core.seq(vec__50301);
var first__50303 = cljs.core.first(seq__50302);
var seq__50302__$1 = cljs.core.next(seq__50302);
var k = first__50303;
var ks = seq__50302__$1;
if(ks){
