...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__27725_SHARP_,p2__27724_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__27724_SHARP_) : pred.call(null,p2__27724_SHARP_)))){
return p1__27725_SHARP_;
} else {
return null;
}
}),v);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__27726_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__27726_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__27726_SHARP_) <= ending)));
}));
});
/**
 ...
 */
day8.re_frame_10x.tools.coll.dissoc_in = (function day8$re_frame_10x$tools$coll$dissoc_in(m,p__27727){
var vec__27728 = p__27727;
var seq__27729 = cljs.core.seq(vec__27728);
var first__27730 = cljs.core.first(seq__27729);
var seq__27729__$1 = cljs.core.next(seq__27729);
var k = first__27730;
var ks = seq__27729__$1;
if(ks){
