...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__50300_SHARP_,p2__50299_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__50299_SHARP_) : pred.call(null,p2__50299_SHARP_)))){
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__50301_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__50301_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__50301_SHARP_) <= ending)));
}));
});
/**
 ...
 */
day8.re_frame_10x.tools.coll.dissoc_in = (function day8$re_frame_10x$tools$coll$dissoc_in(m,p__50302){
var vec__50303 = p__50302;
var seq__50304 = cljs.core.seq(vec__50303);
var first__50305 = cljs.core.first(seq__50304);
var seq__50304__$1 = cljs.core.next(seq__50304);
var k = first__50305;
var ks = seq__50304__$1;
if(ks){
