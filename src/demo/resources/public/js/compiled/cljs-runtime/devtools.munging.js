...
var o21499 = temp__5751__auto__;
var temp__5751__auto____$1 = (o21499["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o21500 = temp__5751__auto____$1;
return (o21500["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19615__auto__ = f;
return (o__19615__auto__["toString"]).call(o__19615__auto__);
} else {
return "";
}
}catch (e21516){var _ = e21516;
return "";
}});
...
try{var o__19615__auto___21833 = t;
(o__19615__auto___21833["cljs$lang$ctorPrWriter"]).call(o__19615__auto___21833,t,writer);
}catch (e21592){var __21834 = e21592;
}
...
var char_code = (function (){var o__19615__auto__ = (new String(char$));
return (o__19615__auto__["charCodeAt"]).call(o__19615__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19615__auto__ = String;
return (o__19615__auto__["fromCharCode"]).call(o__19615__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21597 = num_code;
switch (G__21597) {
case (1):
return (185);
...
var o__19615__auto__ = String;
return (o__19615__auto__["fromCharCode"]).call(o__19615__auto__,superscript_code);
});
/**
...
}catch (e21601){var _e__19648__auto__ = e21601;
return false;
}})())){
...
var vec__21605 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21605,(0),null);
...
var len__4864__auto___21836 = arguments.length;
var i__4865__auto___21837 = (0);
while(true){
if((i__4865__auto___21837 < len__4864__auto___21836)){
args__4870__auto__.push((arguments[i__4865__auto___21837]));

var G__21838 = (i__4865__auto___21837 + (1));
i__4865__auto___21837 = G__21838;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21616){
var vec__21617 = p__21616;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21617,(0),null);
...
var G__21839 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__21840 = cljs.core.butlast(remaining_tokens);
name_tokens = G__21839;
remaining_tokens = G__21840;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21614){
var G__21615 = cljs.core.first(seq21614);
var seq21614__$1 = cljs.core.next(seq21614);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21615,seq21614__$1);
}));
...
var vec__21623 = cljs.core.split_with((function (p1__21622_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__21622_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21623,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21623,(1),null);
...
var vec__21629 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21629,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21629,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__21842 = cljs.core.rest(remaining_tokens);
var G__21843 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__21842;
name_tokens = G__21843;
continue;
} else {
...
var vec__21635 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21635,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21635,(1),null);
var vec__21638 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21638,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21638,(1),null);
var vec__21641 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21641,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21641,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21641,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21641,(3),null);
...
var vec__21647 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21647,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21647,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21647,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21647,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21647,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21647,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__21650 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21650,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21650,(1),null);
var vec__21653 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21653,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21653,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__21658 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__21658) : devtools.munging.parse_fn_info_deep.call(null,G__21658));
})()));
}
} else {
return fn_info;
...
var G__21849 = (arity + (1));
var G__21850 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21672){
var vec__21673 = p__21672;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21673,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21673,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21703_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__21703_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21705_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__21705_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___21851 = arguments.length;
var i__4865__auto___21852 = (0);
while(true){
if((i__4865__auto___21852 < len__4864__auto___21851)){
args__4870__auto__.push((arguments[i__4865__auto___21852]));

var G__21853 = (i__4865__auto___21852 + (1));
i__4865__auto___21852 = G__21853;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21717){
var vec__21718 = p__21717;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21718,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21715){
var G__21716 = cljs.core.first(seq21715);
var seq21715__$1 = cljs.core.next(seq21715);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21716,seq21715__$1);
}));
...
var map__21773 = options;
var map__21773__$1 = cljs.core.__destructure_map(map__21773);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21773__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21773__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21773__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21773__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21774 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21774,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21774,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21774,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21774,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21774,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21774,(5),null);
...
var o__19615__auto__ = f;
return (o__19615__auto__["getBasis"]).call(o__19615__auto__);
});
/**
...
}catch (e21796){var _e__19648__auto__ = e21796;
...
var G__21861 = (obj[cljs.core.first(path)]);
var G__21862 = cljs.core.rest(path);
obj = G__21861;
path = G__21862;
continue;
} else {
...
var _STAR_ = (function (accum,p__21806){
var vec__21811 = p__21806;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21811,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21811,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21814){
var vec__21815 = p__21814;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21815,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21815,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21815,(2),null);
...
var post_process = (function (p__21829){
var vec__21830 = p__21829;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21830,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21830,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21824_SHARP_){
return (obj[cljs.core.first(p1__21824_SHARP_)]);
}),sorted_matches);
