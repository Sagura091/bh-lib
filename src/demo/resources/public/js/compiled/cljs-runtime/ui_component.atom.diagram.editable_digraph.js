 ...
 *     
 */
ui_component.atom.diagram.editable_digraph.input_handles = (function ui_component$atom$diagram$editable_digraph$input_handles(label,inputs,position){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386)], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (idx,p__59184){
var vec__59185 = p__59184;
var target = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59185,(0),null);
var ports = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59185,(1),null);
var vec__59188 = ports;
var source_port = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59188,(0),null);
var target_port = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59188,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),shadow.js.shim.module$react_flow_renderer.Handle,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),target_port,new cljs.core.Keyword(null,"type","type",1174270348),"target",new cljs.core.Keyword(null,"position","position",-2011731912),position,new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([ui_component.atom.diagram.editable_digraph.handle_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"left","left",-399115937),((20) + ((10) * idx))], null)], 0))], null)], null);
}),inputs)))], null);
});
/**
 * 
 ...
 *     
 */
ui_component.atom.diagram.editable_digraph.output_handles = (function ui_component$atom$diagram$editable_digraph$output_handles(label,outputs,position){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386)], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (idx,p__59191){
var vec__59192 = p__59191;
var target = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59192,(0),null);
var ports = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59192,(1),null);
var vec__59195 = ports;
var source_port = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59195,(0),null);
var target_port = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59195,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),shadow.js.shim.module$react_flow_renderer.Handle,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),source_port,new cljs.core.Keyword(null,"type","type",1174270348),"source",new cljs.core.Keyword(null,"position","position",-2011731912),position,new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([ui_component.atom.diagram.editable_digraph.handle_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"right","right",-452581833),((20) + ((10) * idx))], null)], 0))], null)], null);
}),outputs)))], null);
});
ui_component.atom.diagram.editable_digraph.apply_handles = (function ui_component$atom$diagram$editable_digraph$apply_handles(label,inputs,outputs,input_position,output_position){
var i = cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p__59198){
var vec__59199 = p__59198;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59199,(0),null);
var vec__59202 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59199,(1),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59202,(0),null);
var d = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59202,(1),null);
...
var o = cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p__59205){
var vec__59206 = p__59205;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59206,(0),null);
var vec__59209 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59206,(1),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59209,(0),null);
var d = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59209,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,s,d], null);
...
ui_component.atom.diagram.editable_digraph.input_handles(label,in_out,input_position);

ui_component.atom.diagram.editable_digraph.input_handles(label,in_only,input_position);

return ui_component.atom.diagram.editable_digraph.output_handles(label,out_only,output_position);
});
ui_component.atom.diagram.editable_digraph.color_black = "#000000";
ui_component.atom.diagram.editable_digraph.color_white = "#ffffff";
ui_component.atom.diagram.editable_digraph.on_drag_start = (function ui_component$atom$diagram$editable_digraph$on_drag_start(node_type,event){
event.dataTransfer.setData("editable-flow",node_type);

return (event.dataTransfer.effectAllowed = "move");
});
ui_component.atom.diagram.editable_digraph.on_drag_over = (function ui_component$atom$diagram$editable_digraph$on_drag_over(event){
event.preventDefault();

return (event.dataTransfer.dropEffect = "move");
});
ui_component.atom.diagram.editable_digraph.on_drop = (function ui_component$atom$diagram$editable_digraph$on_drop(component_id,reactFlowInstance,set_nodes_fn,wrapper,event){
event.preventDefault();
...
var position = (function (){var G__59213 = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"x","x",2099068185),(x - reactFlowBounds.left),new cljs.core.Keyword(null,"y","y",-1757859776),(y - reactFlowBounds.top)], null));
var fexpr__59212 = cljs.core.deref(reactFlowInstance).project;
return (fexpr__59212.cljs$core$IFn$_invoke$arity$1 ? fexpr__59212.cljs$core$IFn$_invoke$arity$1(G__59213) : fexpr__59212.call(null,G__59213));
})();
...
var G__59214 = (function (nds){
return nds.concat(cljs.core.clj__GT_js(new_node));
});
return (set_nodes_fn.cljs$core$IFn$_invoke$arity$1 ? set_nodes_fn.cljs$core$IFn$_invoke$arity$1(G__59214) : set_nodes_fn.call(null,G__59214));
} else {
return null;
}
});
ui_component.atom.diagram.editable_digraph.make_draggable_node = (function ui_component$atom$diagram$editable_digraph$make_draggable_node(p__59216){
var vec__59217 = p__59216;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59217,(0),null);
var map__59220 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59217,(1),null);
var map__59220__$1 = cljs.core.__destructure_map(map__59220);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59220__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59220__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59220__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var text_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59220__$1,new cljs.core.Keyword(null,"text-color","text-color",1728708298));
var node = vec__59217;
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.draggable","div.draggable",-249226727),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"align-items","align-items",-267946462),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"width","width",-384071477),new cljs.core.Keyword(null,"background","background",-863952629),new cljs.core.Keyword(null,"cursor","cursor",1011937484),new cljs.core.Keyword(null,"padding","padding",1660304693),new cljs.core.Keyword(null,"justify-content","justify-content",-1990475787),new cljs.core.Keyword(null,"display","display",242065432),new cljs.core.Keyword(null,"border-radius","border-radius",419594011),new cljs.core.Keyword(null,"margin-bottom","margin-bottom",388334941),new cljs.core.Keyword(null,"height","height",1025178622)],[new cljs.core.Keyword(null,"center","center",-748944368),text_color,"150px",color,new cljs.core.Keyword(null,"grab","grab",-31757349),"2px",new cljs.core.Keyword(null,"center","center",-748944368),new cljs.core.Keyword(null,"flex","flex",-1425124628),"3px","5px","50px"]),new cljs.core.Keyword(null,"onDragStart","onDragStart",-2108300997),(function (p1__59215_SHARP_){
return ui_component.atom.diagram.editable_digraph.on_drag_start(type,p1__59215_SHARP_);
...
ui_component.atom.diagram.editable_digraph.details_panel = (function ui_component$atom$diagram$editable_digraph$details_panel(components,component_id,node){
var details = cljs.core.get.cljs$core$IFn$_invoke$arity$2(node,"data");
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [ui_component.molecule.composite.util.node_config_ui.make_config_panel,details], null);
});
ui_component.atom.diagram.editable_digraph.tool_panel = (function ui_component$atom$diagram$editable_digraph$tool_panel(open_details_QMARK_,components,component_id,tool_types){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#tool-panel","div#tool-panel",1621560191),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"display","display",242065432),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"justify-content","justify-content",-1990475787),new cljs.core.Keyword(null,"center","center",-748944368),new cljs.core.Keyword(null,"align-items","align-items",-267946462),new cljs.core.Keyword(null,"center","center",-748944368),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"width","width",-384071477),"20%",new cljs.core.Keyword(null,"height","height",1025178622),"100%",new cljs.core.Keyword(null,"border-radius","border-radius",419594011),"5px",new cljs.core.Keyword(null,"padding","padding",1660304693),"15px 10px",new cljs.core.Keyword(null,"background","background",-863952629),new cljs.core.Keyword(null,"white","white",-483998618),new cljs.core.Keyword(null,"box-shadow","box-shadow",1600206755),"5px 5px 5px #888888"], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"src","src",-1651076051),(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"ui_component/atom/diagram/editable_digraph.cljs",new cljs.core.Keyword(null,"line","line",212345235),217], null)),new cljs.core.Keyword(null,"gap","gap",80255254),"2px",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"src","src",-1651076051),(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"ui_component/atom/diagram/editable_digraph.cljs",new cljs.core.Keyword(null,"line","line",212345235),219], null)),new cljs.core.Keyword(null,"gap","gap",80255254),"2px",new cljs.core.Keyword(null,"justify","justify",-722524056),new cljs.core.Keyword(null,"center","center",-748944368),new cljs.core.Keyword(null,"align","align",1964212802),new cljs.core.Keyword(null,"center","center",-748944368),new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2(ui_component.atom.diagram.editable_digraph.make_draggable_node,tool_types))], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.line,new cljs.core.Keyword(null,"size","size",1098693007),"2px"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),"20%",new cljs.core.Keyword(null,"height","height",1025178622),"100%"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [ui_component.molecule.composite.util.node_config_ui.make_config_panel,cljs.core.deref(open_details_QMARK_)], null)], null)], null)], null)], null);
});
ui_component.atom.diagram.editable_digraph.flow_STAR_ = (function ui_component$atom$diagram$editable_digraph$flow_STAR_(var_args){
var args__4870__auto__ = [];
var len__4864__auto___59241 = arguments.length;
var i__4865__auto___59242 = (0);
while(true){
if((i__4865__auto___59242 < len__4864__auto___59241)){
args__4870__auto__.push((arguments[i__4865__auto___59242]));

var G__59243 = (i__4865__auto___59242 + (1));
i__4865__auto___59242 = G__59243;
continue;
} else {
}
break;
...
return ui_component.atom.diagram.editable_digraph.flow_STAR_.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});

(ui_component.atom.diagram.editable_digraph.flow_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (p__59222){
var map__59223 = p__59222;
var map__59223__$1 = cljs.core.__destructure_map(map__59223);
var params = map__59223__$1;
var zoom_on_scroll = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"zoom-on-scroll","zoom-on-scroll",-1018757347));
var edges = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"edges","edges",-694791395));
var on_change_nodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"on-change-nodes","on-change-nodes",1794690531));
var flowInstance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"flowInstance","flowInstance",-856699256));
var edge_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"edge-types","edge-types",1188284328));
var on_change_edges = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"on-change-edges","on-change-edges",-1237562934));
var on_drop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"on-drop","on-drop",1867868491));
var node_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"node-types","node-types",1539943342));
var connectFn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"connectFn","connectFn",-1166539665));
var nodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"nodes","nodes",-2099585805));
var minimap_styles = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"minimap-styles","minimap-styles",2078942134));
var component_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"component-id","component-id",1551113783));
var on_drag_over = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"on-drag-over","on-drag-over",-93410408));
var preventScrolling = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"preventScrolling","preventScrolling",1085718552));
...
(ui_component.atom.diagram.editable_digraph.flow_STAR_.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(ui_component.atom.diagram.editable_digraph.flow_STAR_.cljs$lang$applyTo = (function (seq59221){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq59221));
}));

ui_component.atom.diagram.editable_digraph.editable_flow = (function ui_component$atom$diagram$editable_digraph$editable_flow(var_args){
var args__4870__auto__ = [];
...
var argseq__4871__auto__ = ((((0) < args__4870__auto__.length))?(new cljs.core.IndexedSeq(args__4870__auto__.slice((0)),(0),null)):null);
return ui_component.atom.diagram.editable_digraph.editable_flow.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});

(ui_component.atom.diagram.editable_digraph.editable_flow.cljs$core$IFn$_invoke$arity$variadic = (function (p__59225){
var map__59226 = p__59225;
var map__59226__$1 = cljs.core.__destructure_map(map__59226);
var params = map__59226__$1;
var zoom_on_scroll = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"zoom-on-scroll","zoom-on-scroll",-1018757347));
var edges = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"edges","edges",-694791395));
var flowInstance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"flowInstance","flowInstance",-856699256));
var edge_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"edge-types","edge-types",1188284328));
var on_drop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"on-drop","on-drop",1867868491));
var node_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"node-types","node-types",1539943342));
var connectFn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"connectFn","connectFn",-1166539665));
var force_layout_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"force-layout?","force-layout?",714323314));
var nodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"nodes","nodes",-2099585805));
var minimap_styles = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"minimap-styles","minimap-styles",2078942134));
var component_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"component-id","component-id",1551113783));
var on_drag_over = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"on-drag-over","on-drag-over",-93410408));
var preventScrolling = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59226__$1,new cljs.core.Keyword(null,"preventScrolling","preventScrolling",1085718552));
var map__59227 = (cljs.core.truth_(force_layout_QMARK_)?ui_component.atom.diagram.diagram.dagre_support.build_layout.cljs$core$IFn$_invoke$arity$2(nodes,edges):new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"nodes","nodes",-2099585805),nodes,new cljs.core.Keyword(null,"edges","edges",-694791395),edges], null));
var map__59227__$1 = cljs.core.__destructure_map(map__59227);
var n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59227__$1,new cljs.core.Keyword(null,"nodes","nodes",-2099585805));
var e = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59227__$1,new cljs.core.Keyword(null,"edges","edges",-694791395));
var vec__59228 = shadow.js.shim.module$react_flow_renderer.useNodesState(cljs.core.clj__GT_js(n));
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59228,(0),null);
var set_nodes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59228,(1),null);
var on_change_nodes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59228,(2),null);
var vec__59231 = shadow.js.shim.module$react_flow_renderer.useEdgesState(cljs.core.clj__GT_js(e));
var es = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59231,(0),null);
var set_edges = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59231,(1),null);
var on_change_edges = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59231,(2),null);
...
var argseq__4871__auto__ = ((((0) < args__4870__auto__.length))?(new cljs.core.IndexedSeq(args__4870__auto__.slice((0)),(0),null)):null);
return ui_component.atom.diagram.editable_digraph.component.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});

(ui_component.atom.diagram.editable_digraph.component.cljs$core$IFn$_invoke$arity$variadic = (function (p__59235){
var map__59236 = p__59235;
var map__59236__$1 = cljs.core.__destructure_map(map__59236);
var zoom_on_scroll = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59236__$1,new cljs.core.Keyword(null,"zoom-on-scroll","zoom-on-scroll",-1018757347));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59236__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var edge_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59236__$1,new cljs.core.Keyword(null,"edge-types","edge-types",1188284328));
var node_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59236__$1,new cljs.core.Keyword(null,"node-types","node-types",1539943342));
var connectFn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59236__$1,new cljs.core.Keyword(null,"connectFn","connectFn",-1166539665));
var force_layout_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59236__$1,new cljs.core.Keyword(null,"force-layout?","force-layout?",714323314));
var tool_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59236__$1,new cljs.core.Keyword(null,"tool-types","tool-types",1018386515));
var container_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59236__$1,new cljs.core.Keyword(null,"container-id","container-id",1274665684));
var minimap_styles = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59236__$1,new cljs.core.Keyword(null,"minimap-styles","minimap-styles",2078942134));
var component_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59236__$1,new cljs.core.Keyword(null,"component-id","component-id",1551113783));
var preventScrolling = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59236__$1,new cljs.core.Keyword(null,"preventScrolling","preventScrolling",1085718552));
...
var n_types = cljs.core.clj__GT_js(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__59237){
var vec__59238 = p__59237;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59238,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59238,(1),null);
...
return (function (){
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"src","src",-1651076051),(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"ui_component/atom/diagram/editable_digraph.cljs",new cljs.core.Keyword(null,"line","line",212345235),313], null)),new cljs.core.Keyword(null,"gap","gap",80255254),"10px",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [ui_component.atom.diagram.editable_digraph.tool_panel,open_details_QMARK_,new cljs.core.Keyword(null,"components","components",-1073188942).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(d)),component_id,tool_types], null),new cljs.core.PersistentVector(null, 28, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f>","f>",1484564198),ui_component.atom.diagram.editable_digraph.editable_flow,new cljs.core.Keyword(null,"component-id","component-id",1551113783),component_id,new cljs.core.Keyword(null,"nodes","nodes",-2099585805),new cljs.core.Keyword(null,"nodes","nodes",-2099585805).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(d)),new cljs.core.Keyword(null,"edges","edges",-694791395),new cljs.core.Keyword(null,"edges","edges",-694791395).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(d)),new cljs.core.Keyword(null,"node-types","node-types",1539943342),n_types,new cljs.core.Keyword(null,"edge-types","edge-types",1188284328),edge_types,new cljs.core.Keyword(null,"on-drop","on-drop",1867868491),ui_component.atom.diagram.editable_digraph.on_drop,new cljs.core.Keyword(null,"on-drag-over","on-drag-over",-93410408),ui_component.atom.diagram.editable_digraph.on_drag_over,new cljs.core.Keyword(null,"minimap-styles","minimap-styles",2078942134),(function (){var or__4253__auto__ = minimap_styles;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
(ui_component.atom.diagram.editable_digraph.component.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(ui_component.atom.diagram.editable_digraph.component.cljs$lang$applyTo = (function (seq59234){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq59234));
}));


//# sourceMappingURL=ui_component.atom.diagram.editable_digraph.js.map
