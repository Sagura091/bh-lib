...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k52189,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k52189,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__52209){
var vec__52211 = p__52209;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52211,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52211,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__52188){
var self__ = this;
var G__52188__$1 = this;
return (new cljs.core.RecordIter((0),G__52188__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this52190,other52191){
var self__ = this;
var this52190__$1 = this;
return (((!((other52191 == null)))) && ((((this52190__$1.constructor === other52191.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52190__$1.tag,other52191.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52190__$1.prefix,other52191.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52190__$1.sym,other52191.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52190__$1.children,other52191.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52190__$1.__extmap,other52191.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k52189){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k52189);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__52188){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__52256 = cljs.core.keyword_identical_QMARK_;
var expr__52257 = k__4511__auto__;
if(cljs.core.truth_((pred__52256.cljs$core$IFn$_invoke$arity$2 ? pred__52256.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__52257) : pred__52256.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__52257)))){
return (new rewrite_clj.node.quote.QuoteNode(G__52188,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52256.cljs$core$IFn$_invoke$arity$2 ? pred__52256.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__52257) : pred__52256.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__52257)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__52188,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52256.cljs$core$IFn$_invoke$arity$2 ? pred__52256.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__52257) : pred__52256.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__52257)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__52188,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52256.cljs$core$IFn$_invoke$arity$2 ? pred__52256.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__52257) : pred__52256.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__52257)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__52188,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__52188),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__52188){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__52188,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__52196){
var extmap__4542__auto__ = (function (){var G__52268 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__52196,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__52196)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__52268);
} else {
return G__52268;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__52196),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__52196),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__52196),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__52196),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
var G__52302 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__52302;
continue;
}
break;
...
var G__52303 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__52303;
continue;
}
break;
...
var G__52308 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__52308;
continue;
}
break;
...
var G__52309 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__52309;
continue;
}
break;
