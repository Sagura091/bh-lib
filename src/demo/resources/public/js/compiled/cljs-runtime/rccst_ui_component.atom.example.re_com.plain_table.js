...
rccst_ui_component.atom.example.re_com.plain_table.data = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(rccst_ui_component.atom.example.re_com.plain_table.sample_data);
}
rccst_ui_component.atom.example.re_com.plain_table.cell_styling_fn = (function rccst_ui_component$atom$example$re_com$plain_table$cell_styling_fn(p__59303,p__59304){
var map__59305 = p__59303;
var map__59305__$1 = cljs.core.__destructure_map(map__59305);
var row = map__59305__$1;
var amt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59305__$1,new cljs.core.Keyword(null,"amt","amt",-1785711538));
var uv = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59305__$1,new cljs.core.Keyword(null,"uv","uv",-1197749379));
var pv = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59305__$1,new cljs.core.Keyword(null,"pv","pv",55024340));
var map__59306 = p__59304;
var map__59306__$1 = cljs.core.__destructure_map(map__59306);
var column = map__59306__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59306__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
rccst_ui_component.atom.example.re_com.plain_table.table_column_headers = (function rccst_ui_component$atom$example$re_com$plain_table$table_column_headers(data,rows,width,height){
...
return cljs.core.reset_BANG_(rccst_ui_component.atom.example.re_com.plain_table.data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(rccst_ui_component.atom.example.re_com.plain_table.sample_data,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.PersistentVector.EMPTY));
...
return cljs.core.reset_BANG_(rccst_ui_component.atom.example.re_com.plain_table.data,rccst_ui_component.atom.example.re_com.plain_table.sample_data);
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(rccst_ui_component.atom.example.re_com.plain_table.data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),(0),new cljs.core.Keyword(null,"uv","uv",-1197749379)], null),(10000));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(rccst_ui_component.atom.example.re_com.plain_table.data,cljs.core.assoc,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(rccst_ui_component.atom.example.re_com.plain_table.data)),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"Page Q",new cljs.core.Keyword(null,"uv","uv",-1197749379),(1100),new cljs.core.Keyword(null,"pv","pv",55024340),(1100),new cljs.core.Keyword(null,"tv","tv",-1805207359),(1100),new cljs.core.Keyword(null,"amt","amt",-1785711538),(1100)], null)));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(rccst_ui_component.atom.example.re_com.plain_table.data,cljs.core.assoc,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2((2),new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(rccst_ui_component.atom.example.re_com.plain_table.data)))));
...
}),new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(rccst_ui_component.atom.example.re_com.plain_table.data))))));
}),new cljs.core.Keyword(null,"label","label",1718410804),"Add :new-item"], null)], null)], null);
});
rccst_ui_component.atom.example.re_com.plain_table.data_update_example = (function rccst_ui_component$atom$example$re_com$plain_table$data_update_example(var_args){
var args__4870__auto__ = [];
var len__4864__auto___59337 = arguments.length;
var i__4865__auto___59338 = (0);
while(true){
if((i__4865__auto___59338 < len__4864__auto___59337)){
args__4870__auto__.push((arguments[i__4865__auto___59338]));

var G__59339 = (i__4865__auto___59338 + (1));
i__4865__auto___59338 = G__59339;
continue;
} else {
}
break;
...
return rccst_ui_component.atom.example.re_com.plain_table.data_update_example.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});

(rccst_ui_component.atom.example.re_com.plain_table.data_update_example.cljs$core$IFn$_invoke$arity$variadic = (function (p__59335){
var map__59336 = p__59335;
var map__59336__$1 = cljs.core.__destructure_map(map__59336);
var params = map__59336__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59336__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var container_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59336__$1,new cljs.core.Keyword(null,"container-id","container-id",1274665684));
var component_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59336__$1,new cljs.core.Keyword(null,"component-id","component-id",1551113783));
return (function (){
return new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"src","src",-1651076051),(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"rccst_ui_component/atom/example/re_com/plain_table.cljs",new cljs.core.Keyword(null,"line","line",212345235),100], null)),new cljs.core.Keyword(null,"class","class",-2030961996),"data-update-example",new cljs.core.Keyword(null,"gap","gap",80255254),"10px",new cljs.core.Keyword(null,"width","width",-384071477),"100%",new cljs.core.Keyword(null,"height","height",1025178622),"100%",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.chart-part","div.chart-part",1045862618),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),"100%",new cljs.core.Keyword(null,"height","height",1025178622),"90%"], null)], null),new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.simple_v_table,new cljs.core.Keyword(null,"src","src",-1651076051),(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"rccst_ui_component/atom/example/re_com/plain_table.cljs",new cljs.core.Keyword(null,"line","line",212345235),106], null)),new cljs.core.Keyword(null,"model","model",331153215),reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(data))),new cljs.core.Keyword(null,"columns","columns",1998437288),rccst_ui_component.atom.example.re_com.plain_table.table_column_headers(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(data)),(5),(200),(25)),new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613),cljs.core.count(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(data))),new cljs.core.Keyword(null,"table-row-line-color","table-row-line-color",680569135),"#00fff0",new cljs.core.Keyword(null,"cell-style","cell-style",1087536089),rccst_ui_component.atom.example.re_com.plain_table.cell_styling_fn,new cljs.core.Keyword(null,"parts","parts",849007691),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"simple-wrapper","simple-wrapper",-507652041),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"border","border",1444987323),false], null)], null)], null)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.data-tools-part","div.data-tools-part",1281903232),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"width","width",-384071477),"100%"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [rccst_ui_component.atom.example.re_com.plain_table.show,data], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [rccst_ui_component.atom.example.re_com.plain_table.data_tools], null)], null)], null)], null);
});
}));

(rccst_ui_component.atom.example.re_com.plain_table.data_update_example.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(rccst_ui_component.atom.example.re_com.plain_table.data_update_example.cljs$lang$applyTo = (function (seq59334){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq59334));
}));

rccst_ui_component.atom.example.re_com.plain_table.example = (function rccst_ui_component$atom$example$re_com$plain_table$example(){
return woolybear.ad.demo.src.catalog.utils.demo.cljs$core$IFn$_invoke$arity$variadic("Raw Re-com Table (WIP)",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Trying to debug re-renders on data change\n\n> Looks like the component _may_ be broken...",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [woolybear.ad.layout.centered,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"extra-classes","extra-classes",-630819843),new cljs.core.Keyword(null,"width-50","width-50",718512332)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [rccst_ui_component.atom.example.re_com.plain_table.data_update_example,new cljs.core.Keyword(null,"data","data",-232669377),rccst_ui_component.atom.example.re_com.plain_table.data], null)], null)], 0));
});

//# sourceMappingURL=rccst_ui_component.atom.example.re_com.plain_table.js.map
