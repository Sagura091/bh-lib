...
}catch (e50246){if((e50246 instanceof Error)){
var _ = e50246;
...
}catch (e50260){if((e50260 instanceof Error)){
var _ = e50260;
...
var seq__50261 = cljs.core.seq(day8.re_frame_10x.fx.local_storage.all_keys());
var chunk__50262 = null;
var count__50263 = (0);
var i__50264 = (0);
while(true){
if((i__50264 < count__50263)){
var k = chunk__50262.cljs$core$IIndexed$_nth$arity$2(null,i__50264);
...
var G__50280 = seq__50261;
var G__50281 = chunk__50262;
var G__50282 = count__50263;
var G__50283 = (i__50264 + (1));
seq__50261 = G__50280;
chunk__50262 = G__50281;
count__50263 = G__50282;
i__50264 = G__50283;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__50261);
if(temp__5753__auto__){
var seq__50261__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50261__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__50261__$1);
var G__50284 = cljs.core.chunk_rest(seq__50261__$1);
var G__50285 = c__4679__auto__;
var G__50286 = cljs.core.count(c__4679__auto__);
var G__50287 = (0);
seq__50261 = G__50284;
chunk__50262 = G__50285;
count__50263 = G__50286;
i__50264 = G__50287;
continue;
} else {
var k = cljs.core.first(seq__50261__$1);
if(clojure.string.starts_with_QMARK_(k,day8.re_frame_10x.fx.local_storage.safe_prefix)){
day8.re_frame_10x.fx.local_storage.storage.remove(k);
} else {
}
...
var G__50288 = cljs.core.next(seq__50261__$1);
var G__50289 = null;
var G__50290 = (0);
var G__50291 = (0);
seq__50261 = G__50288;
chunk__50262 = G__50289;
count__50263 = G__50290;
i__50264 = G__50291;
continue;
}
} else {
...
/** @this {Function} */
(day8.re_frame_10x.fx.local_storage.save.cljs$lang$applyTo = (function (seq50266){
var G__50267 = cljs.core.first(seq50266);
var seq50266__$1 = cljs.core.next(seq50266);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50267,seq50266__$1);
}));

(day8.re_frame_10x.fx.local_storage.save.cljs$lang$maxFixedArity = (1));

day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_cofx(new cljs.core.Keyword("day8.re-frame-10x.fx.local-storage","load","day8.re-frame-10x.fx.local-storage/load",1482432658),(function (coeffects,p__50277){
var map__50278 = p__50277;
var map__50278__$1 = cljs.core.__destructure_map(map__50278);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50278__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var or = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50278__$1,new cljs.core.Keyword(null,"or","or",235744169));
