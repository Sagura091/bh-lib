...
}catch (e27653){if((e27653 instanceof Error)){
var _ = e27653;
...
}catch (e27665){if((e27665 instanceof Error)){
var _ = e27665;
...
var seq__27669 = cljs.core.seq(day8.re_frame_10x.fx.local_storage.all_keys());
var chunk__27670 = null;
var count__27671 = (0);
var i__27672 = (0);
while(true){
if((i__27672 < count__27671)){
var k = chunk__27670.cljs$core$IIndexed$_nth$arity$2(null,i__27672);
...
var G__27699 = seq__27669;
var G__27700 = chunk__27670;
var G__27701 = count__27671;
var G__27702 = (i__27672 + (1));
seq__27669 = G__27699;
chunk__27670 = G__27700;
count__27671 = G__27701;
i__27672 = G__27702;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__27669);
if(temp__5753__auto__){
var seq__27669__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__27669__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__27669__$1);
var G__27703 = cljs.core.chunk_rest(seq__27669__$1);
var G__27704 = c__4679__auto__;
var G__27705 = cljs.core.count(c__4679__auto__);
var G__27706 = (0);
seq__27669 = G__27703;
chunk__27670 = G__27704;
count__27671 = G__27705;
i__27672 = G__27706;
continue;
} else {
var k = cljs.core.first(seq__27669__$1);
if(clojure.string.starts_with_QMARK_(k,day8.re_frame_10x.fx.local_storage.safe_prefix)){
day8.re_frame_10x.fx.local_storage.storage.remove(k);
} else {
}
...
var G__27707 = cljs.core.next(seq__27669__$1);
var G__27708 = null;
var G__27709 = (0);
var G__27710 = (0);
seq__27669 = G__27707;
chunk__27670 = G__27708;
count__27671 = G__27709;
i__27672 = G__27710;
continue;
}
} else {
...
var len__4864__auto___27712 = arguments.length;
var i__4865__auto___27713 = (0);
while(true){
if((i__4865__auto___27713 < len__4864__auto___27712)){
args_arr__4885__auto__.push((arguments[i__4865__auto___27713]));

var G__27714 = (i__4865__auto___27713 + (1));
i__4865__auto___27713 = G__27714;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.fx.local_storage.save.cljs$lang$applyTo = (function (seq27693){
var G__27694 = cljs.core.first(seq27693);
var seq27693__$1 = cljs.core.next(seq27693);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27694,seq27693__$1);
}));

(day8.re_frame_10x.fx.local_storage.save.cljs$lang$maxFixedArity = (1));

day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_cofx(new cljs.core.Keyword("day8.re-frame-10x.fx.local-storage","load","day8.re-frame-10x.fx.local-storage/load",1482432658),(function (coeffects,p__27696){
var map__27697 = p__27696;
var map__27697__$1 = cljs.core.__destructure_map(map__27697);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27697__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var or = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27697__$1,new cljs.core.Keyword(null,"or","or",235744169));
