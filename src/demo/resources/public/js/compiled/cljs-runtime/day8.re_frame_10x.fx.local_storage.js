...
}catch (e50239){if((e50239 instanceof Error)){
var _ = e50239;
...
}catch (e50250){if((e50250 instanceof Error)){
var _ = e50250;
...
var seq__50254 = cljs.core.seq(day8.re_frame_10x.fx.local_storage.all_keys());
var chunk__50255 = null;
var count__50256 = (0);
var i__50257 = (0);
while(true){
if((i__50257 < count__50256)){
var k = chunk__50255.cljs$core$IIndexed$_nth$arity$2(null,i__50257);
...
var G__50280 = seq__50254;
var G__50281 = chunk__50255;
var G__50282 = count__50256;
var G__50283 = (i__50257 + (1));
seq__50254 = G__50280;
chunk__50255 = G__50281;
count__50256 = G__50282;
i__50257 = G__50283;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__50254);
if(temp__5753__auto__){
var seq__50254__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50254__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__50254__$1);
var G__50284 = cljs.core.chunk_rest(seq__50254__$1);
var G__50285 = c__4679__auto__;
var G__50286 = cljs.core.count(c__4679__auto__);
var G__50287 = (0);
seq__50254 = G__50284;
chunk__50255 = G__50285;
count__50256 = G__50286;
i__50257 = G__50287;
continue;
} else {
var k = cljs.core.first(seq__50254__$1);
if(clojure.string.starts_with_QMARK_(k,day8.re_frame_10x.fx.local_storage.safe_prefix)){
day8.re_frame_10x.fx.local_storage.storage.remove(k);
} else {
}
...
var G__50288 = cljs.core.next(seq__50254__$1);
var G__50289 = null;
var G__50290 = (0);
var G__50291 = (0);
seq__50254 = G__50288;
chunk__50255 = G__50289;
count__50256 = G__50290;
i__50257 = G__50291;
continue;
}
} else {
...
args_arr__4885__auto__.push((arguments[i__4865__auto___50294]));
...
/** @this {Function} */
(day8.re_frame_10x.fx.local_storage.save.cljs$lang$applyTo = (function (seq50261){
var G__50262 = cljs.core.first(seq50261);
var seq50261__$1 = cljs.core.next(seq50261);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50262,seq50261__$1);
}));

(day8.re_frame_10x.fx.local_storage.save.cljs$lang$maxFixedArity = (1));

day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_cofx(new cljs.core.Keyword("day8.re-frame-10x.fx.local-storage","load","day8.re-frame-10x.fx.local-storage/load",1482432658),(function (coeffects,p__50272){
var map__50273 = p__50272;
var map__50273__$1 = cljs.core.__destructure_map(map__50273);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50273__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var or = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50273__$1,new cljs.core.Keyword(null,"or","or",235744169));
