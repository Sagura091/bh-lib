...
var clojure$test$check$results$Result$pass_QMARK_$dyn_78570 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_78570(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_78571 = (function (result){
var x__4550__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_78571(result);
}
});
