...
var clojure$test$check$results$Result$pass_QMARK_$dyn_56863 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_56863(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_56864 = (function (result){
var x__4550__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_56864(result);
}
});
