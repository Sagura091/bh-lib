...
var clojure$test$check$results$Result$pass_QMARK_$dyn_78559 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_78559(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_78560 = (function (result){
var x__4550__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_78560(result);
}
});
