...
var temp__5751__auto__ = cljs.core.deref(devtools.hints.processed_errors);
...
var reader = (function (){var or__4253__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4253__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return (128);
...
var map__39886 = top_item;
var map__39886__$1 = cljs.core.__destructure_map(map__39886);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39886__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39886__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39886__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e39885){var _e = e39885;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___39913 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___39913)){
var seen_errors_39914 = temp__5751__auto___39913;
if(cljs.core.truth_(seen_errors_39914.has(self))){
} else {
seen_errors_39914.add(self);

var temp__5753__auto___39915 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___39915)){
var sense_39916 = temp__5753__auto___39915;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_39916)].join(''));
} else {
}
}
} else {
...
var temp__5753__auto__ = devtools.hints.error_object_sense(error);
if(cljs.core.truth_(temp__5753__auto__)){
var sense = temp__5753__auto__;
