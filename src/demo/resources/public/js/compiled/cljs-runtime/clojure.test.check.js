...
var vec__56867 = temp__5751__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56867,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56867,(1),null);
...
var len__4864__auto___56900 = arguments.length;
var i__4865__auto___56901 = (0);
while(true){
if((i__4865__auto___56901 < len__4864__auto___56900)){
args__4870__auto__.push((arguments[i__4865__auto___56901]));

var G__56902 = (i__4865__auto___56901 + (1));
i__4865__auto___56901 = G__56902;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__56873){
var map__56874 = p__56873;
var map__56874__$1 = cljs.core.__destructure_map(map__56874);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56874__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56874__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56874__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__56875 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56875,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56875,(1),null);
...
var size = first__56887;
var rest_size_seq = seq__56886__$1;
var vec__56888 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56888,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56888,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq56870){
var G__56871 = cljs.core.first(seq56870);
var seq56870__$1 = cljs.core.next(seq56870);
var G__56872 = cljs.core.first(seq56870__$1);
var seq56870__$2 = cljs.core.next(seq56870__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56871,G__56872,seq56870__$2);
}));
...
var map__56892 = smallest;
var map__56892__$1 = cljs.core.__destructure_map(map__56892);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56892__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__56907 = tail;
var G__56908 = current_smallest;
var G__56909 = (total_nodes_visited + (1));
var G__56910 = depth;
nodes = G__56907;
current_smallest = G__56908;
total_nodes_visited = G__56909;
depth = G__56910;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__56894_56911 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__56894_56911) : reporter_fn.call(null,G__56894_56911));

var temp__5751__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5751__auto__){
var children = temp__5751__auto__;
var G__56912 = children;
var G__56913 = new_smallest;
var G__56914 = (total_nodes_visited + (1));
var G__56915 = (depth + (1));
nodes = G__56912;
current_smallest = G__56913;
total_nodes_visited = G__56914;
depth = G__56915;
continue;
} else {
var G__56916 = tail;
var G__56917 = new_smallest;
var G__56918 = (total_nodes_visited + (1));
var G__56919 = depth;
nodes = G__56916;
current_smallest = G__56917;
total_nodes_visited = G__56918;
depth = G__56919;
continue;
}
}
...
var G__56896_56920 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__56896_56920) : reporter_fn.call(null,G__56896_56920));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__56895_SHARP_){
var G__56897 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__56895_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__56897) : reporter_fn.call(null,G__56897));
}));
var G__56898_56921 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__56898_56921) : reporter_fn.call(null,G__56898_56921));
