...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k52634,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__52643 = k52634;
var G__52643__$1 = (((G__52643 instanceof cljs.core.Keyword))?G__52643.fqn:null);
switch (G__52643__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k52634,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__52657){
var vec__52658 = p__52657;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52658,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52658,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this52635,other52636){
var self__ = this;
var this52635__$1 = this;
return (((!((other52636 == null)))) && ((((this52635__$1.constructor === other52636.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52635__$1.tag,other52636.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52635__$1.wrap_fn,other52636.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52635__$1.wrap_length,other52636.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52635__$1.seq_fn,other52636.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52635__$1.children,other52636.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52635__$1.__extmap,other52636.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__52684 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__52684) : self__.seq_fn.call(null,G__52684));
}));
...
var self__ = this;
var this$__$1 = this;
var G__52691 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__52691) : self__.wrap_fn.call(null,G__52691));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k52634){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k52634);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__52633){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__52699 = cljs.core.keyword_identical_QMARK_;
var expr__52700 = k__4511__auto__;
if(cljs.core.truth_((pred__52699.cljs$core$IFn$_invoke$arity$2 ? pred__52699.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__52700) : pred__52699.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__52700)))){
return (new rewrite_clj.node.seq.SeqNode(G__52633,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52699.cljs$core$IFn$_invoke$arity$2 ? pred__52699.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__52700) : pred__52699.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__52700)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__52633,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52699.cljs$core$IFn$_invoke$arity$2 ? pred__52699.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__52700) : pred__52699.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__52700)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__52633,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52699.cljs$core$IFn$_invoke$arity$2 ? pred__52699.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__52700) : pred__52699.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__52700)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__52633,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52699.cljs$core$IFn$_invoke$arity$2 ? pred__52699.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__52700) : pred__52699.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__52700)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__52633,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__52633),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__52633){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__52633,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__52637){
var extmap__4542__auto__ = (function (){var G__52702 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__52637,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__52637)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__52702);
} else {
return G__52702;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__52637),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__52637),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__52637),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__52637),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__52637),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__52703_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__52703_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__52704_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__52704_SHARP_);
}),children);
});
