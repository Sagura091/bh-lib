...
var clojure$test$check$random$IRandom$rand_long$dyn_73596 = (function (rng){
...
return (m__4551__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4551__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4551__auto__.call(null,rng));
} else {
var m__4549__auto__ = (clojure.test.check.random.rand_long["_"]);
if((!((m__4549__auto__ == null)))){
return (m__4549__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4549__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4549__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$rand_long$dyn_73596(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_73597 = (function (rng){
var x__4550__auto__ = (((rng == null))?null:rng);
var m__4551__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__4550__auto__)]);
if((!((m__4551__auto__ == null)))){
return (m__4551__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4551__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4551__auto__.call(null,rng));
} else {
var m__4549__auto__ = (clojure.test.check.random.rand_double["_"]);
if((!((m__4549__auto__ == null)))){
return (m__4549__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4549__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4549__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$rand_double$dyn_73597(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_73600 = (function (rng){
var x__4550__auto__ = (((rng == null))?null:rng);
var m__4551__auto__ = (clojure.test.check.random.split[goog.typeOf(x__4550__auto__)]);
if((!((m__4551__auto__ == null)))){
return (m__4551__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4551__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4551__auto__.call(null,rng));
} else {
var m__4549__auto__ = (clojure.test.check.random.split["_"]);
if((!((m__4549__auto__ == null)))){
return (m__4549__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4549__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4549__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$split$dyn_73600(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_73601 = (function (rng,n){
var x__4550__auto__ = (((rng == null))?null:rng);
var m__4551__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__4550__auto__)]);
if((!((m__4551__auto__ == null)))){
return (m__4551__auto__.cljs$core$IFn$_invoke$arity$2 ? m__4551__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__4551__auto__.call(null,rng,n));
} else {
var m__4549__auto__ = (clojure.test.check.random.split_n["_"]);
if((!((m__4549__auto__ == null)))){
return (m__4549__auto__.cljs$core$IFn$_invoke$arity$2 ? m__4549__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__4549__auto__.call(null,rng,n));
} else {
...
return clojure$test$check$random$IRandom$split_n$dyn_73601(rng,n);
}
});
...
var G__73566 = z;
if(((24) > (function (){var G__73567 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__73567) : clojure.test.check.random.longs.bit_count.call(null,G__73567));
})())){
return clojure.test.check.random.longs.bit_xor(G__73566,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__73566;
}
});
...
var G__73603 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__73604 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__73603;
ret = G__73604;
continue;
}
...
(clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
}));
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__4253__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__73585){
var map__73586 = p__73585;
var map__73586__$1 = cljs.core.__destructure_map(map__73586);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73586__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__73588 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73588,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73588,(1),null);
