...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23260 = c;
var G__23260__$1 = (((G__23260 == null))?null:G__23260.prototype);
if((G__23260__$1 == null)){
return null;
} else {
return G__23260__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23261 = c;
var G__23261__$1 = (((G__23261 == null))?null:G__23261.prototype);
if((G__23261__$1 == null)){
return null;
} else {
return G__23261__$1.render;
}
})() == null)))));
});
...
G__23350.cljs$lang$applyTo = (function (arglist__23353){
...
var or__4253__auto__ = (function (){var G__23299 = c;
var G__23299__$1 = (((G__23299 == null))?null:G__23299.constructor);
if((G__23299__$1 == null)){
return null;
} else {
return G__23299__$1.displayName;
}
})();
...
var G__23300 = c;
var G__23300__$1 = (((G__23300 == null))?null:G__23300.constructor);
if((G__23300__$1 == null)){
return null;
} else {
return G__23300__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__23324 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23325 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23325);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23324);
}});
...
var c = this;
var G__23339_23357 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__23339_23357 == null)){
} else {
reagent.ratom.dispose_BANG_(G__23339_23357);
}
...
var renders_23358 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_23359 = cljs.core.first(cljs.core.vals(renders_23358));
...
if((cljs.core.count(renders_23358) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_23358))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_23359)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_23359], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__23340 = o;
reagent.impl.component.goog$module$goog$object.set(G__23340,cljs.core.name(k),v);
...
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).warn(["Warning: ","Using native React classes directly in Hiccup forms ","is not supported. Use create-element or ","adapt-react-class instead: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__4253__auto__ = reagent.impl.util.fun_name(f);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return f;
...
return (function() { 
var G__23361__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__23361 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__23362__i = 0, G__23362__a = new Array(arguments.length -  0);
while (G__23362__i < G__23362__a.length) {G__23362__a[G__23362__i] = arguments[G__23362__i + 0]; ++G__23362__i;}
  args = new cljs.core.IndexedSeq(G__23362__a,0,null);
} 
return G__23361__delegate.call(this,args);};
G__23361.cljs$lang$maxFixedArity = 0;
G__23361.cljs$lang$applyTo = (function (arglist__23363){
var args = cljs.core.seq(arglist__23363);
return G__23361__delegate(args);
});
G__23361.cljs$core$IFn$_invoke$arity$variadic = G__23361__delegate;
return G__23361;
})()
...
var _STAR_current_component_STAR__orig_val__23341 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23342 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23342);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23341);
}});
...
var vec__23343 = shadow.js.shim.module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23343,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23343,(1),null);
...
var G__23346 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__23346 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__23346);
}
});
}),[]);
