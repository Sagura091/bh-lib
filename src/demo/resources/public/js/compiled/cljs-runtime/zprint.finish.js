...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__51769_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__51769_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__51769_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__51770){
var vec__51773 = p__51770;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51773,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51773,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__51776,s,color,element,idx){
var map__51777 = p__51776;
var map__51777__$1 = cljs.core.__destructure_map(map__51777);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51777__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51777__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51777__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__51780 = (function (){var or__4253__auto__ = color;
...
var fexpr__51779 = (function (){var G__51781 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__51781) : style_map.call(null,G__51781));
})();
return (fexpr__51779.cljs$core$IFn$_invoke$arity$1 ? fexpr__51779.cljs$core$IFn$_invoke$arity$1(G__51780) : fexpr__51779.call(null,G__51780));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__51782){
var vec__51783 = p__51782;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51783,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51783,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51783,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__51786){
var vec__51787 = p__51786;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51787,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51787,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51787,(2),null);
...
var G__51862 = cljs.core.next(ssv);
var G__51863 = (this_ssv == null);
var G__51864 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__51865 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__51862;
doing_nil_QMARK_ = G__51863;
last_elide = G__51864;
out = G__51865;
continue;
}
...
var vec__51800 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51800,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51800,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51800,(2),null);
...
var G__51866 = cljs.core.next(remaining_cvec);
var G__51867 = new_idx;
var G__51868 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__51866;
idx = G__51867;
out = G__51868;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__51814,cursor_vec){
var vec__51815 = p__51814;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51815,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51815,(1),null);
var focus_vec = vec__51815;
...
var vec__51818 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51818,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51818,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__51821){
var vec__51823 = p__51821;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51823,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51823,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__51830,existing_count){
var vec__51831 = p__51830;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51831,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51831,(1),null);
...
return cljs.core.filterv((function (p1__51826_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__51826_SHARP_))));
...
var vec__51839 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51839,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51839,(1),null);
var cvec_element = vec__51839;
if((cvec_element == null)){
var G__51877 = cljs.core.next(cvec_nl);
var G__51878 = (idx + (1));
var G__51879 = start;
var G__51880 = out;
cvec_nl = G__51877;
...
var G__51881 = cljs.core.next(cvec_nl);
var G__51882 = (idx + (1));
var G__51883 = idx;
var G__51884 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__51881;
idx = G__51882;
start = G__51883;
out = G__51884;
...
var G__51885 = cljs.core.next(cvec_nl);
var G__51886 = (idx + (1));
var G__51887 = (idx + (1));
var G__51888 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__51885;
idx = G__51886;
start = G__51887;
out = G__51888;
...
var G__51889 = cljs.core.next(cvec_nl);
var G__51890 = (idx + (1));
var G__51891 = idx;
var G__51892 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__51889;
idx = G__51890;
start = G__51891;
out = G__51892;
...
var G__51894 = cljs.core.next(cvec_nl);
var G__51895 = (idx + (1));
var G__51896 = start;
var G__51897 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__51894;
idx = G__51895;
start = G__51896;
out = G__51897;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__51844_SHARP_,p2__51843_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__51843_SHARP_)){
return cljs.core.reduced(p1__51844_SHARP_);
} else {
return (p1__51844_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__51846,p__51847){
var vec__51848 = p__51846;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51848,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51848,(1),null);
var vec__51851 = p__51847;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51851,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51851,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__51857,cvec,focus_vec){
var map__51858 = p__51857;
var map__51858__$1 = cljs.core.__destructure_map(map__51858);
var options = map__51858__$1;
var map__51859 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51858__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__51859__$1 = cljs.core.__destructure_map(map__51859);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51859__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51859__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51859__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51855_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__51855_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
