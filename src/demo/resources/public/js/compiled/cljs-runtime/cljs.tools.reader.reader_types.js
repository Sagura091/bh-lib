...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_22561 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_22561(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_22567 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_22567(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22568 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22568(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22569 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22569(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22570 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22570(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22571 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22571(reader);
}
});
...
var G__22581 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__22582 = s.append(c);
c = G__22581;
s = G__22582;
continue;
}
