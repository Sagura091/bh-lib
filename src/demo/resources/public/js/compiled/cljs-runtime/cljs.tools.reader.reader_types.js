...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_42646 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_42646(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_42647 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_42647(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42648 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42648(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42649 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42649(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42650 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42650(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42651 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42651(reader);
}
});
...
var G__42660 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__42661 = s.append(c);
c = G__42660;
s = G__42661;
continue;
}
