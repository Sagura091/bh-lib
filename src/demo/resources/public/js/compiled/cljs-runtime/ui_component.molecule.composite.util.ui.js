goog.provide('ui_component.molecule.composite.util.ui');
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"ui-component.molecule.composite.util.ui",null,11,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ui-component.molecule.composite.util.ui"], null);
}),null)),null,-2145858204,null);
ui_component.molecule.composite.util.ui.handle_style = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"width","width",-384071477),"8px",new cljs.core.Keyword(null,"height","height",1025178622),"8px",new cljs.core.Keyword(null,"borderRadius","borderRadius",-1505621083),"50%"], null);
ui_component.molecule.composite.util.ui.default_node_style = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"padding","padding",1660304693),"3px",new cljs.core.Keyword(null,"max-width","max-width",-1939924051),"180px",new cljs.core.Keyword(null,"borderRadius","borderRadius",-1505621083),"5px",new cljs.core.Keyword(null,"margin","margin",-995903681),new cljs.core.Keyword(null,"auto","auto",-566279492),new cljs.core.Keyword(null,"background","background",-863952629),new cljs.core.Keyword(null,"white","white",-483998618),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"black","black",1294279647)], null);
ui_component.molecule.composite.util.ui.node_style = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("ui","component","ui/component",1555933050),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background","background",-863952629),new cljs.core.Keyword(null,"green","green",-945526839),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"white","white",-483998618)], null),new cljs.core.Keyword("source","remote","source/remote",-1682682981),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background","background",-863952629),new cljs.core.Keyword(null,"orange","orange",73816386),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"black","black",1294279647)], null),new cljs.core.Keyword("source","local","source/local",-582398745),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background","background",-863952629),new cljs.core.Keyword(null,"blue","blue",-622100620),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"white","white",-483998618)], null),new cljs.core.Keyword("source","fn","source/fn",1803568239),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background","background",-863952629),new cljs.core.Keyword(null,"pink","pink",393815864),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"black","black",1294279647)], null)], null);
/**
 * 
 * 
 ...
 *   
 */
ui_component.molecule.composite.util.ui.input_output_handles = (function ui_component$molecule$composite$util$ui$input_output_handles(label,inputs,outputs){
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),shadow.js.shim.module$react_flow_renderer.Handle,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),target_port,new cljs.core.Keyword(null,"type","type",1174270348),"target",new cljs.core.Keyword(null,"position","position",-2011731912),"top",new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([ui_component.molecule.composite.util.ui.handle_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"left","left",-399115937),((20) + ((10) * idx))], null)], 0))], null)], null);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),shadow.js.shim.module$react_flow_renderer.Handle,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),source_port,new cljs.core.Keyword(null,"type","type",1174270348),"source",new cljs.core.Keyword(null,"position","position",-2011731912),"bottom",new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([ui_component.molecule.composite.util.ui.handle_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"left","left",-399115937),((20) + ((10) * idx))], null)], 0))], null)], null);
}),outputs)))], null);
});
ui_component.molecule.composite.util.ui.open_details = (function ui_component$molecule$composite$util$ui$open_details(open_details_QMARK_,node){
 ...
 *   
 */
ui_component.molecule.composite.util.ui.custom_node = (function ui_component$molecule$composite$util$ui$custom_node(var_args){
...
return ui_component.molecule.composite.util.ui.custom_node.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__4871__auto__);
});

(ui_component.molecule.composite.util.ui.custom_node.cljs$core$IFn$_invoke$arity$variadic = (function (node_type,open_details_QMARK_,d,extras_QMARK_){
...
var style = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([ui_component.molecule.composite.util.ui.default_node_style,(node_type.cljs$core$IFn$_invoke$arity$1 ? node_type.cljs$core$IFn$_invoke$arity$1(ui_component.molecule.composite.util.ui.node_style) : node_type.call(null,ui_component.molecule.composite.util.ui.node_style))], 0));
 ...
 *   
 */
ui_component.molecule.composite.util.ui.create_flow_node = (function ui_component$molecule$composite$util$ui$create_flow_node(configuration,node_id){
 ...
 *   
 */
ui_component.molecule.composite.util.ui.create_flow_edge = (function ui_component$molecule$composite$util$ui$create_flow_edge(configuration,idx,p__59132){
 ...
 *   
 */
ui_component.molecule.composite.util.ui.compute_edges = (function ui_component$molecule$composite$util$ui$compute_edges(configuration){
 ...
 *   
 */
ui_component.molecule.composite.util.ui.make_flow = (function ui_component$molecule$composite$util$ui$make_flow(configuration){
...
return ui_component.molecule.composite.util.ui.create_flow_node(configuration,p1__59151_SHARP_);
...
return ui_component.molecule.composite.util.ui.create_flow_edge(configuration,idx,node);
}),new cljs.core.Keyword(null,"edges","edges",-694791395).cljs$core$IFn$_invoke$arity$1(configuration))], null);
return ui_component.atom.diagram.diagram.dagre_support.build_layout.cljs$core$IFn$_invoke$arity$1(flow);
});
ui_component.molecule.composite.util.ui.prep_environment = (function ui_component$molecule$composite$util$ui$prep_environment(configuration,component_id,registry){
ui_component.molecule.composite.util.signals.process_components(configuration,new cljs.core.Keyword("source","remote","source/remote",-1682682981),registry,component_id);

ui_component.utils.locals.create_container_sub(component_id);

ui_component.utils.locals.create_container_local_sub(component_id,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"blackboard","blackboard",-1864070822)], null),cljs.core.PersistentArrayMap.EMPTY);

ui_component.molecule.composite.util.signals.process_components(configuration,new cljs.core.Keyword("source","local","source/local",-582398745),registry,component_id);

return ui_component.molecule.composite.util.signals.process_components(configuration,new cljs.core.Keyword("source","fn","source/fn",1803568239),registry,component_id);
});

//# sourceMappingURL=ui_component.molecule.composite.util.ui.js.map
