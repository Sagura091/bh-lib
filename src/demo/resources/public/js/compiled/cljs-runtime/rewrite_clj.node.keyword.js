...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k52156,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k52156,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__52161){
var vec__52162 = p__52161;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52162,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52162,(1),null);
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__52155){
var self__ = this;
var G__52155__$1 = this;
return (new cljs.core.RecordIter((0),G__52155__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k","k",-2146297393),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this52157,other52158){
var self__ = this;
var this52157__$1 = this;
return (((!((other52158 == null)))) && ((((this52157__$1.constructor === other52158.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52157__$1.k,other52158.k)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52157__$1.namespaced_QMARK_,other52158.namespaced_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52157__$1.__extmap,other52158.__extmap)))))))));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k52156){
var self__ = this;
var this__4509__auto____$1 = this;
var G__52175 = k52156;
var G__52175__$1 = (((G__52175 instanceof cljs.core.Keyword))?G__52175.fqn:null);
switch (G__52175__$1) {
case "k":
case "namespaced?":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k52156);

}
}));

(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__52155){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__52177 = cljs.core.keyword_identical_QMARK_;
var expr__52178 = k__4511__auto__;
if(cljs.core.truth_((pred__52177.cljs$core$IFn$_invoke$arity$2 ? pred__52177.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__52178) : pred__52177.call(null,new cljs.core.Keyword(null,"k","k",-2146297393),expr__52178)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__52155,self__.namespaced_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52177.cljs$core$IFn$_invoke$arity$2 ? pred__52177.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__52178) : pred__52177.call(null,new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__52178)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__52155,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__52155),null));
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__52155){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,G__52155,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__52159){
var extmap__4542__auto__ = (function (){var G__52201 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__52159,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], 0));
if(cljs.core.record_QMARK_(G__52159)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__52201);
} else {
return G__52201;
}
})();
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__52159),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877).cljs$core$IFn$_invoke$arity$1(G__52159),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
var len__4864__auto___52236 = arguments.length;
var i__4865__auto___52237 = (0);
while(true){
if((i__4865__auto___52237 < len__4864__auto___52236)){
args__4870__auto__.push((arguments[i__4865__auto___52237]));

var G__52238 = (i__4865__auto___52237 + (1));
i__4865__auto___52237 = G__52238;
continue;
} else {
}
break;
...
(rewrite_clj.node.keyword.keyword_node.cljs$core$IFn$_invoke$arity$variadic = (function (k,p__52210){
var vec__52214 = p__52210;
var namespaced_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52214,(0),null);
...
/** @this {Function} */
(rewrite_clj.node.keyword.keyword_node.cljs$lang$applyTo = (function (seq52202){
var G__52203 = cljs.core.first(seq52202);
var seq52202__$1 = cljs.core.next(seq52202);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52203,seq52202__$1);
}));
