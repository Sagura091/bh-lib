...
var len__4864__auto___48735 = arguments.length;
var i__4865__auto___48736 = (0);
while(true){
if((i__4865__auto___48736 < len__4864__auto___48735)){
args__4870__auto__.push((arguments[i__4865__auto___48736]));

var G__48737 = (i__4865__auto___48736 + (1));
i__4865__auto___48736 = G__48737;
continue;
} else {
}
break;
...
(woolybear.packs.tab_panel.mk_tab_panel_data.cljs$core$IFn$_invoke$arity$variadic = (function (path_in_db,p__48648){
var vec__48649 = p__48648;
var default_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48649,(0),null);
...
/** @this {Function} */
(woolybear.packs.tab_panel.mk_tab_panel_data.cljs$lang$applyTo = (function (seq48645){
var G__48646 = cljs.core.first(seq48645);
var seq48645__$1 = cljs.core.next(seq48645);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48646,seq48645__$1);
}));

if(day8.re_frame.tracing.is_trace_enabled_QMARK_()){
woolybear.packs.tab_panel.tab_panel_on_click_handler = (function woolybear$packs$tab_panel$tab_panel_on_click_handler(db,p__48658){
var vec__48659 = p__48658;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48659,(0),null);
var data_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48659,(1),null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48659,(2),null);
...
})(),(function (){var result__35734__auto__ = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var result__35734__auto__ = data_path;
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"num-seen","num-seen",-1576518431),2,new cljs.core.Keyword(null,"syntax-order","syntax-order",-990682045),(4),new cljs.core.Keyword(null,"result","result",1415092211),result__35734__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol(null,"data-path","data-path",-1979633588,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(2)], null));

return result__35734__auto__;
})(),new cljs.core.Keyword(null,"value","value",305978217));
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"num-seen","num-seen",-1576518431),1,new cljs.core.Keyword(null,"syntax-order","syntax-order",-990682045),(3),new cljs.core.Keyword(null,"result","result",1415092211),result__35734__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"conj","conj",-1127293942,null),new cljs.core.Symbol(null,"data-path","data-path",-1979633588,null),new cljs.core.Keyword(null,"value","value",305978217)),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__35734__auto__;
})(),(function (){var result__35734__auto__ = new_value;
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"num-seen","num-seen",-1576518431),2,new cljs.core.Keyword(null,"syntax-order","syntax-order",-990682045),(6),new cljs.core.Keyword(null,"result","result",1415092211),result__35734__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol(null,"new-value","new-value",-1567397401,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));
 ...
 */
woolybear.packs.tab_panel.tab_panel_on_click_handler = (function woolybear$packs$tab_panel$tab_panel_on_click_handler(db,p__48669){
var vec__48670 = p__48669;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48670,(0),null);
var data_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48670,(1),null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48670,(2),null);
...
cljs.spec.alpha.def_impl(new cljs.core.Keyword("tab-bar","options","tab-bar/options",966523590),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","keys","cljs.spec.alpha/keys",1109346032,null),new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ad","subscribe-to-component-data","ad/subscribe-to-component-data",1210013749)], null),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ad","extra-classes","ad/extra-classes",-630830756),new cljs.core.Keyword("ad","subscribe-to-classes","ad/subscribe-to-classes",173180261)], null)),cljs.spec.alpha.map_spec_impl(cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ad","subscribe-to-component-data","ad/subscribe-to-component-data",1210013749)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ad","extra-classes","ad/extra-classes",-630830756),new cljs.core.Keyword("ad","subscribe-to-classes","ad/subscribe-to-classes",173180261)], null),null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__48674){
return cljs.core.map_QMARK_(G__48674);
}),(function (G__48674){
return cljs.core.contains_QMARK_(G__48674,new cljs.core.Keyword(null,"subscribe-to-component-data","subscribe-to-component-data",1209998418));
})], null),(function (G__48674){
return ((cljs.core.map_QMARK_(G__48674)) && (cljs.core.contains_QMARK_(G__48674,new cljs.core.Keyword(null,"subscribe-to-component-data","subscribe-to-component-data",1209998418))));
...
var vec__48675 = child;
var seq__48676 = cljs.core.seq(vec__48675);
var first__48677 = cljs.core.first(seq__48676);
var seq__48676__$1 = cljs.core.next(seq__48676);
var tag = first__48677;
var first__48677__$1 = cljs.core.first(seq__48676__$1);
var seq__48676__$2 = cljs.core.next(seq__48676__$1);
var opts = first__48677__$1;
var more = seq__48676__$2;
...
var args__4870__auto__ = [];
var len__4864__auto___48742 = arguments.length;
var i__4865__auto___48743 = (0);
while(true){
if((i__4865__auto___48743 < len__4864__auto___48742)){
args__4870__auto__.push((arguments[i__4865__auto___48743]));

var G__48744 = (i__4865__auto___48743 + (1));
i__4865__auto___48743 = G__48744;
continue;
} else {
}
break;
...
var subscribe_to_component_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48680__$1,new cljs.core.Keyword(null,"subscribe-to-component-data","subscribe-to-component-data",1209998418));
var extra_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48680__$1,new cljs.core.Keyword(null,"extra-classes","extra-classes",-630819843));
var subscribe_to_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48680__$1,new cljs.core.Keyword(null,"subscribe-to-classes","subscribe-to-classes",173193596));
...
return (function() { 
var G__48745__delegate = function (_,___$1){
...
cljs.core.chunk_append(b__48684,((active_QMARK_)?woolybear.ad.utils.add_option(button,new cljs.core.Keyword(null,"active?","active?",459499776),true):button));

var G__48746 = (i__48683 + (1));
i__48683 = G__48746;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48684),woolybear$packs$tab_panel$iter__48681(cljs.core.chunk_rest(s__48682__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48684),null);
}
} else {
var button = cljs.core.first(s__48682__$2);
var active_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(current_panel_id,woolybear.ad.utils.get_option(button,new cljs.core.Keyword(null,"panel-id","panel-id",2118466015)));
return cljs.core.cons(((active_QMARK_)?woolybear.ad.utils.add_option(button,new cljs.core.Keyword(null,"active?","active?",459499776),true):button),woolybear$packs$tab_panel$iter__48681(cljs.core.rest(s__48682__$2)));
}
} else {
return null;
}
...
var G__48745 = function (_,var_args){
var ___$1 = null;
if (arguments.length > 1) {
var G__48747__i = 0, G__48747__a = new Array(arguments.length -  1);
while (G__48747__i < G__48747__a.length) {G__48747__a[G__48747__i] = arguments[G__48747__i + 1]; ++G__48747__i;}
  ___$1 = new cljs.core.IndexedSeq(G__48747__a,0,null);
} 
return G__48745__delegate.call(this,_,___$1);};
G__48745.cljs$lang$maxFixedArity = 1;
G__48745.cljs$lang$applyTo = (function (arglist__48748){
var _ = cljs.core.first(arglist__48748);
var ___$1 = cljs.core.rest(arglist__48748);
return G__48745__delegate(_,___$1);
});
...
/** @this {Function} */
(woolybear.packs.tab_panel.tab_bar.cljs$lang$applyTo = (function (seq48678){
var G__48679 = cljs.core.first(seq48678);
var seq48678__$1 = cljs.core.next(seq48678);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48679,seq48678__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___48749 = arguments.length;
var i__4865__auto___48750 = (0);
while(true){
if((i__4865__auto___48750 < len__4864__auto___48749)){
args__4870__auto__.push((arguments[i__4865__auto___48750]));

var G__48751 = (i__4865__auto___48750 + (1));
i__4865__auto___48750 = G__48751;
continue;
} else {
}
break;
...
var extra_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48693__$1,new cljs.core.Keyword(null,"extra-classes","extra-classes",-630819843));
var subscribe_to_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48693__$1,new cljs.core.Keyword(null,"subscribe-to-classes","subscribe-to-classes",173193596));
var classes_sub = woolybear.ad.utils.subscribe_to(subscribe_to_classes);
return (function() { 
var G__48752__delegate = function (___$1,children){
...
var G__48752 = function (___$1,var_args){
var children = null;
if (arguments.length > 1) {
var G__48753__i = 0, G__48753__a = new Array(arguments.length -  1);
while (G__48753__i < G__48753__a.length) {G__48753__a[G__48753__i] = arguments[G__48753__i + 1]; ++G__48753__i;}
  children = new cljs.core.IndexedSeq(G__48753__a,0,null);
} 
return G__48752__delegate.call(this,___$1,children);};
G__48752.cljs$lang$maxFixedArity = 1;
G__48752.cljs$lang$applyTo = (function (arglist__48754){
var ___$1 = cljs.core.first(arglist__48754);
var children = cljs.core.rest(arglist__48754);
return G__48752__delegate(___$1,children);
});
...
/** @this {Function} */
(woolybear.packs.tab_panel.sub_panel.cljs$lang$applyTo = (function (seq48691){
var G__48692 = cljs.core.first(seq48691);
var seq48691__$1 = cljs.core.next(seq48691);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48692,seq48691__$1);
}));
...
var extra_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48720__$1,new cljs.core.Keyword(null,"extra-classes","extra-classes",-630819843));
var subscribe_to_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48720__$1,new cljs.core.Keyword(null,"subscribe-to-classes","subscribe-to-classes",173193596));
var subscribe_to_selected_tab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48720__$1,new cljs.core.Keyword(null,"subscribe-to-selected-tab","subscribe-to-selected-tab",138020659));
var classes_sub = woolybear.ad.utils.subscribe_to(subscribe_to_classes);
...
return (function() { 
var G__48758__delegate = function (_,___$1){
var dynamic_classes = cljs.core.deref(classes_sub);
...
var G__48758 = function (_,var_args){
var ___$1 = null;
if (arguments.length > 1) {
var G__48759__i = 0, G__48759__a = new Array(arguments.length -  1);
while (G__48759__i < G__48759__a.length) {G__48759__a[G__48759__i] = arguments[G__48759__i + 1]; ++G__48759__i;}
  ___$1 = new cljs.core.IndexedSeq(G__48759__a,0,null);
} 
return G__48758__delegate.call(this,_,___$1);};
G__48758.cljs$lang$maxFixedArity = 1;
G__48758.cljs$lang$applyTo = (function (arglist__48760){
var _ = cljs.core.first(arglist__48760);
var ___$1 = cljs.core.rest(arglist__48760);
return G__48758__delegate(_,___$1);
});
...
/** @this {Function} */
(woolybear.packs.tab_panel.tab_panel.cljs$lang$applyTo = (function (seq48713){
var G__48715 = cljs.core.first(seq48713);
var seq48713__$1 = cljs.core.next(seq48713);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48715,seq48713__$1);
}));
