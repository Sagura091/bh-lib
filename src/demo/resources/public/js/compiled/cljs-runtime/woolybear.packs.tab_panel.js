...
var len__4864__auto___70996 = arguments.length;
var i__4865__auto___70997 = (0);
while(true){
if((i__4865__auto___70997 < len__4864__auto___70996)){
args__4870__auto__.push((arguments[i__4865__auto___70997]));

var G__70998 = (i__4865__auto___70997 + (1));
i__4865__auto___70997 = G__70998;
continue;
} else {
}
break;
...
(woolybear.packs.tab_panel.mk_tab_panel_data.cljs$core$IFn$_invoke$arity$variadic = (function (path_in_db,p__70874){
var vec__70875 = p__70874;
var default_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70875,(0),null);
...
/** @this {Function} */
(woolybear.packs.tab_panel.mk_tab_panel_data.cljs$lang$applyTo = (function (seq70872){
var G__70873 = cljs.core.first(seq70872);
var seq70872__$1 = cljs.core.next(seq70872);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70873,seq70872__$1);
}));

if(day8.re_frame.tracing.is_trace_enabled_QMARK_()){
woolybear.packs.tab_panel.tab_panel_on_click_handler = (function woolybear$packs$tab_panel$tab_panel_on_click_handler(db,p__70882){
var vec__70883 = p__70882;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70883,(0),null);
var data_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70883,(1),null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70883,(2),null);
 ...
 */
woolybear.packs.tab_panel.tab_panel_on_click_handler = (function woolybear$packs$tab_panel$tab_panel_on_click_handler(db,p__70890){
var vec__70892 = p__70890;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70892,(0),null);
var data_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70892,(1),null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70892,(2),null);
...
cljs.spec.alpha.def_impl(new cljs.core.Keyword("tab-bar","options","tab-bar/options",966523590),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","keys","cljs.spec.alpha/keys",1109346032,null),new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ad","subscribe-to-component-data","ad/subscribe-to-component-data",1210013749)], null),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ad","extra-classes","ad/extra-classes",-630830756),new cljs.core.Keyword("ad","subscribe-to-classes","ad/subscribe-to-classes",173180261)], null)),cljs.spec.alpha.map_spec_impl(cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ad","subscribe-to-component-data","ad/subscribe-to-component-data",1210013749)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ad","extra-classes","ad/extra-classes",-630830756),new cljs.core.Keyword("ad","subscribe-to-classes","ad/subscribe-to-classes",173180261)], null),null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__70895){
return cljs.core.map_QMARK_(G__70895);
}),(function (G__70895){
return cljs.core.contains_QMARK_(G__70895,new cljs.core.Keyword(null,"subscribe-to-component-data","subscribe-to-component-data",1209998418));
})], null),(function (G__70895){
return ((cljs.core.map_QMARK_(G__70895)) && (cljs.core.contains_QMARK_(G__70895,new cljs.core.Keyword(null,"subscribe-to-component-data","subscribe-to-component-data",1209998418))));
...
var vec__70913 = child;
var seq__70914 = cljs.core.seq(vec__70913);
var first__70915 = cljs.core.first(seq__70914);
var seq__70914__$1 = cljs.core.next(seq__70914);
var tag = first__70915;
var first__70915__$1 = cljs.core.first(seq__70914__$1);
var seq__70914__$2 = cljs.core.next(seq__70914__$1);
var opts = first__70915__$1;
var more = seq__70914__$2;
...
var args__4870__auto__ = [];
var len__4864__auto___71004 = arguments.length;
var i__4865__auto___71005 = (0);
while(true){
if((i__4865__auto___71005 < len__4864__auto___71004)){
args__4870__auto__.push((arguments[i__4865__auto___71005]));

var G__71006 = (i__4865__auto___71005 + (1));
i__4865__auto___71005 = G__71006;
continue;
} else {
}
break;
...
var map__70932 = opts;
var map__70932__$1 = cljs.core.__destructure_map(map__70932);
var subscribe_to_component_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70932__$1,new cljs.core.Keyword(null,"subscribe-to-component-data","subscribe-to-component-data",1209998418));
var extra_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70932__$1,new cljs.core.Keyword(null,"extra-classes","extra-classes",-630819843));
var subscribe_to_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70932__$1,new cljs.core.Keyword(null,"subscribe-to-classes","subscribe-to-classes",173193596));
...
return (function() { 
var G__71007__delegate = function (_,___$1){
...
cljs.core.chunk_append(b__70938,((active_QMARK_)?woolybear.ad.utils.add_option(button,new cljs.core.Keyword(null,"active?","active?",459499776),true):button));

var G__71008 = (i__70937 + (1));
i__70937 = G__71008;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70938),woolybear$packs$tab_panel$iter__70935(cljs.core.chunk_rest(s__70936__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70938),null);
}
} else {
var button = cljs.core.first(s__70936__$2);
var active_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(current_panel_id,woolybear.ad.utils.get_option(button,new cljs.core.Keyword(null,"panel-id","panel-id",2118466015)));
return cljs.core.cons(((active_QMARK_)?woolybear.ad.utils.add_option(button,new cljs.core.Keyword(null,"active?","active?",459499776),true):button),woolybear$packs$tab_panel$iter__70935(cljs.core.rest(s__70936__$2)));
}
} else {
return null;
}
...
var G__71007 = function (_,var_args){
var ___$1 = null;
if (arguments.length > 1) {
var G__71009__i = 0, G__71009__a = new Array(arguments.length -  1);
while (G__71009__i < G__71009__a.length) {G__71009__a[G__71009__i] = arguments[G__71009__i + 1]; ++G__71009__i;}
  ___$1 = new cljs.core.IndexedSeq(G__71009__a,0,null);
} 
return G__71007__delegate.call(this,_,___$1);};
G__71007.cljs$lang$maxFixedArity = 1;
G__71007.cljs$lang$applyTo = (function (arglist__71010){
var _ = cljs.core.first(arglist__71010);
var ___$1 = cljs.core.rest(arglist__71010);
return G__71007__delegate(_,___$1);
});
G__71007.cljs$core$IFn$_invoke$arity$variadic = G__71007__delegate;
return G__71007;
})()
;
}));
...
/** @this {Function} */
(woolybear.packs.tab_panel.tab_bar.cljs$lang$applyTo = (function (seq70923){
var G__70924 = cljs.core.first(seq70923);
var seq70923__$1 = cljs.core.next(seq70923);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70924,seq70923__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___71011 = arguments.length;
var i__4865__auto___71012 = (0);
while(true){
if((i__4865__auto___71012 < len__4864__auto___71011)){
args__4870__auto__.push((arguments[i__4865__auto___71012]));

var G__71013 = (i__4865__auto___71012 + (1));
i__4865__auto___71012 = G__71013;
continue;
} else {
}
break;
...
var extra_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70977__$1,new cljs.core.Keyword(null,"extra-classes","extra-classes",-630819843));
var subscribe_to_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70977__$1,new cljs.core.Keyword(null,"subscribe-to-classes","subscribe-to-classes",173193596));
var classes_sub = woolybear.ad.utils.subscribe_to(subscribe_to_classes);
return (function() { 
var G__71014__delegate = function (___$1,children){
...
var G__71014 = function (___$1,var_args){
var children = null;
if (arguments.length > 1) {
var G__71015__i = 0, G__71015__a = new Array(arguments.length -  1);
while (G__71015__i < G__71015__a.length) {G__71015__a[G__71015__i] = arguments[G__71015__i + 1]; ++G__71015__i;}
  children = new cljs.core.IndexedSeq(G__71015__a,0,null);
} 
return G__71014__delegate.call(this,___$1,children);};
G__71014.cljs$lang$maxFixedArity = 1;
G__71014.cljs$lang$applyTo = (function (arglist__71016){
var ___$1 = cljs.core.first(arglist__71016);
var children = cljs.core.rest(arglist__71016);
return G__71014__delegate(___$1,children);
});
G__71014.cljs$core$IFn$_invoke$arity$variadic = G__71014__delegate;
return G__71014;
})()
;
}));
...
/** @this {Function} */
(woolybear.packs.tab_panel.sub_panel.cljs$lang$applyTo = (function (seq70975){
var G__70976 = cljs.core.first(seq70975);
var seq70975__$1 = cljs.core.next(seq70975);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70976,seq70975__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___71017 = arguments.length;
var i__4865__auto___71018 = (0);
while(true){
if((i__4865__auto___71018 < len__4864__auto___71017)){
args__4870__auto__.push((arguments[i__4865__auto___71018]));

var G__71019 = (i__4865__auto___71018 + (1));
i__4865__auto___71018 = G__71019;
continue;
} else {
}
break;
...
var extra_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70990__$1,new cljs.core.Keyword(null,"extra-classes","extra-classes",-630819843));
var subscribe_to_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70990__$1,new cljs.core.Keyword(null,"subscribe-to-classes","subscribe-to-classes",173193596));
var subscribe_to_selected_tab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70990__$1,new cljs.core.Keyword(null,"subscribe-to-selected-tab","subscribe-to-selected-tab",138020659));
var classes_sub = woolybear.ad.utils.subscribe_to(subscribe_to_classes);
...
return (function() { 
var G__71020__delegate = function (_,___$1){
var dynamic_classes = cljs.core.deref(classes_sub);
...
var G__71020 = function (_,var_args){
var ___$1 = null;
if (arguments.length > 1) {
var G__71021__i = 0, G__71021__a = new Array(arguments.length -  1);
while (G__71021__i < G__71021__a.length) {G__71021__a[G__71021__i] = arguments[G__71021__i + 1]; ++G__71021__i;}
  ___$1 = new cljs.core.IndexedSeq(G__71021__a,0,null);
} 
return G__71020__delegate.call(this,_,___$1);};
G__71020.cljs$lang$maxFixedArity = 1;
G__71020.cljs$lang$applyTo = (function (arglist__71022){
var _ = cljs.core.first(arglist__71022);
var ___$1 = cljs.core.rest(arglist__71022);
return G__71020__delegate(_,___$1);
});
G__71020.cljs$core$IFn$_invoke$arity$variadic = G__71020__delegate;
return G__71020;
})()
;
}));
...
/** @this {Function} */
(woolybear.packs.tab_panel.tab_panel.cljs$lang$applyTo = (function (seq70988){
var G__70989 = cljs.core.first(seq70988);
var seq70988__$1 = cljs.core.next(seq70988);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70989,seq70988__$1);
}));
