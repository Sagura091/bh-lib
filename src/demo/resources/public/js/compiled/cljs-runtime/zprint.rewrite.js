...
var G__31156 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__31156;
continue;
} else {
var G__31157 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__31157;
continue;
}
} else {
var G__31158 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__31158;
continue;
}
}
...
var G__31124 = zloc;
var G__31125 = (function (){var G__31126 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__31127 = zloc;
var G__31127__$1 = (((G__31127 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__31127) : rewrite_clj.zip.node.call(null,G__31127)));
if((G__31127__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__31127__$1) : zprint.zutil.edn_STAR_.call(null,G__31127__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__31126) : rewrite_clj.zip.root.call(null,G__31126));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__31124,G__31125) : rewrite_clj.zip.replace.call(null,G__31124,G__31125));
});
/**
...
var G__31162 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__31162;
continue;
}
break;
...
var G__31163 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__31164 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__31163;
out = G__31164;
continue;
} else {
...
var G__31165 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__31166 = cljs.core.next(new_loc);
var G__31167 = replaced_loc;
nloc = G__31165;
new_loc = G__31166;
last_loc = G__31167;
continue;
...
return zprint.rewrite.sort_val((function (){var G__31143 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__31143) : rewrite_clj.zip.down.call(null,G__31143));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__31144_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__31144_SHARP_) : rewrite_clj.zip.tag.call(null,p1__31144_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__31144_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__31144_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
