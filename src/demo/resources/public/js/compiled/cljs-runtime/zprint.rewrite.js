...
var G__53749 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__53749;
continue;
} else {
var G__53750 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__53750;
continue;
}
} else {
var G__53751 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__53751;
continue;
}
}
...
var G__53712 = zloc;
var G__53713 = (function (){var G__53714 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__53715 = zloc;
var G__53715__$1 = (((G__53715 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__53715) : rewrite_clj.zip.node.call(null,G__53715)));
if((G__53715__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__53715__$1) : zprint.zutil.edn_STAR_.call(null,G__53715__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__53714) : rewrite_clj.zip.root.call(null,G__53714));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__53712,G__53713) : rewrite_clj.zip.replace.call(null,G__53712,G__53713));
});
/**
...
var G__53752 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__53752;
continue;
}
break;
...
var G__53754 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__53755 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__53754;
out = G__53755;
continue;
} else {
...
var G__53756 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__53757 = cljs.core.next(new_loc);
var G__53758 = replaced_loc;
nloc = G__53756;
new_loc = G__53757;
last_loc = G__53758;
continue;
...
return zprint.rewrite.sort_val((function (){var G__53738 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__53738) : rewrite_clj.zip.down.call(null,G__53738));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__53745_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__53745_SHARP_) : rewrite_clj.zip.tag.call(null,p1__53745_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__53745_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__53745_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
