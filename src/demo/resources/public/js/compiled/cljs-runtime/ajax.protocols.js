...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_65678 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_65678(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_65681 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_65681(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_65685 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_65685(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_65686 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_65686(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_65688 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_65688(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_65693 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_65693(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_65695 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_65695(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_65703 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_65703(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_65704 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_65704(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_65705 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_65705(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k65528,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__65537 = k65528;
var G__65537__$1 = (((G__65537 instanceof cljs.core.Keyword))?G__65537.fqn:null);
switch (G__65537__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65528,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__65545){
var vec__65548 = p__65545;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65548,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65548,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__65527){
var self__ = this;
var G__65527__$1 = this;
return (new cljs.core.RecordIter((0),G__65527__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65529,other65530){
var self__ = this;
var this65529__$1 = this;
return (((!((other65530 == null)))) && ((((this65529__$1.constructor === other65530.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65529__$1.status,other65530.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65529__$1.body,other65530.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65529__$1.status_text,other65530.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65529__$1.headers,other65530.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65529__$1.was_aborted,other65530.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65529__$1.__extmap,other65530.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k65528){
var self__ = this;
var this__4509__auto____$1 = this;
var G__65620 = k65528;
var G__65620__$1 = (((G__65620 instanceof cljs.core.Keyword))?G__65620.fqn:null);
switch (G__65620__$1) {
case "status":
case "body":
case "status-text":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k65528);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__65527){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__65626 = cljs.core.keyword_identical_QMARK_;
var expr__65627 = k__4511__auto__;
if(cljs.core.truth_((pred__65626.cljs$core$IFn$_invoke$arity$2 ? pred__65626.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__65627) : pred__65626.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__65627)))){
return (new ajax.protocols.Response(G__65527,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65626.cljs$core$IFn$_invoke$arity$2 ? pred__65626.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__65627) : pred__65626.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__65627)))){
return (new ajax.protocols.Response(self__.status,G__65527,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65626.cljs$core$IFn$_invoke$arity$2 ? pred__65626.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__65627) : pred__65626.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__65627)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__65527,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65626.cljs$core$IFn$_invoke$arity$2 ? pred__65626.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__65627) : pred__65626.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__65627)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__65527,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65626.cljs$core$IFn$_invoke$arity$2 ? pred__65626.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__65627) : pred__65626.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__65627)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__65527,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__65527),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__65527){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__65527,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__65531){
var extmap__4542__auto__ = (function (){var G__65674 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65531,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__65531)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65674);
} else {
return G__65674;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__65531),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__65531),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__65531),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__65531),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__65531),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
