...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_69099 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_69099(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_69100 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_69100(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_69101 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_69101(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_69102 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_69102(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_69103 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_69103(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_69104 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_69104(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_69105 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_69105(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_69110 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_69110(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_69111 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_69111(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_69112 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_69112(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k69064,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__69074 = k69064;
var G__69074__$1 = (((G__69074 instanceof cljs.core.Keyword))?G__69074.fqn:null);
switch (G__69074__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k69064,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__69078){
var vec__69079 = p__69078;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69079,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69079,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__69063){
var self__ = this;
var G__69063__$1 = this;
return (new cljs.core.RecordIter((0),G__69063__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this69065,other69066){
var self__ = this;
var this69065__$1 = this;
return (((!((other69066 == null)))) && ((((this69065__$1.constructor === other69066.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this69065__$1.status,other69066.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this69065__$1.body,other69066.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this69065__$1.status_text,other69066.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this69065__$1.headers,other69066.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this69065__$1.was_aborted,other69066.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this69065__$1.__extmap,other69066.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k69064){
var self__ = this;
var this__4509__auto____$1 = this;
var G__69086 = k69064;
var G__69086__$1 = (((G__69086 instanceof cljs.core.Keyword))?G__69086.fqn:null);
switch (G__69086__$1) {
case "status":
case "body":
case "status-text":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k69064);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__69063){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__69087 = cljs.core.keyword_identical_QMARK_;
var expr__69088 = k__4511__auto__;
if(cljs.core.truth_((pred__69087.cljs$core$IFn$_invoke$arity$2 ? pred__69087.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__69088) : pred__69087.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__69088)))){
return (new ajax.protocols.Response(G__69063,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__69087.cljs$core$IFn$_invoke$arity$2 ? pred__69087.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__69088) : pred__69087.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__69088)))){
return (new ajax.protocols.Response(self__.status,G__69063,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__69087.cljs$core$IFn$_invoke$arity$2 ? pred__69087.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__69088) : pred__69087.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__69088)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__69063,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__69087.cljs$core$IFn$_invoke$arity$2 ? pred__69087.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__69088) : pred__69087.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__69088)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__69063,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__69087.cljs$core$IFn$_invoke$arity$2 ? pred__69087.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__69088) : pred__69087.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__69088)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__69063,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__69063),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__69063){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__69063,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__69067){
var extmap__4542__auto__ = (function (){var G__69093 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__69067,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__69067)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__69093);
} else {
return G__69093;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__69067),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__69067),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__69067),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__69067),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__69067),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
