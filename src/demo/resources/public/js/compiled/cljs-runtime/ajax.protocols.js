...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_41857 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_41857(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_41867 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_41867(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_41877 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_41877(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_41885 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_41885(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_41890 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_41890(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_41898 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_41898(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_41914 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_41914(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_41931 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_41931(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_41934 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_41934(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_41935 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_41935(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k41775,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k41775,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__41780){
var vec__41781 = p__41780;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41781,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41781,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__41774){
var self__ = this;
var G__41774__$1 = this;
return (new cljs.core.RecordIter((0),G__41774__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this41776,other41777){
var self__ = this;
var this41776__$1 = this;
return (((!((other41777 == null)))) && ((((this41776__$1.constructor === other41777.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41776__$1.status,other41777.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41776__$1.body,other41777.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41776__$1.status_text,other41777.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41776__$1.headers,other41777.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41776__$1.was_aborted,other41777.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41776__$1.__extmap,other41777.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k41775){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k41775);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__41774){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__41788 = cljs.core.keyword_identical_QMARK_;
var expr__41789 = k__4511__auto__;
if(cljs.core.truth_((pred__41788.cljs$core$IFn$_invoke$arity$2 ? pred__41788.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__41789) : pred__41788.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__41789)))){
return (new ajax.protocols.Response(G__41774,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41788.cljs$core$IFn$_invoke$arity$2 ? pred__41788.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__41789) : pred__41788.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__41789)))){
return (new ajax.protocols.Response(self__.status,G__41774,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41788.cljs$core$IFn$_invoke$arity$2 ? pred__41788.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__41789) : pred__41788.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__41789)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__41774,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41788.cljs$core$IFn$_invoke$arity$2 ? pred__41788.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__41789) : pred__41788.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__41789)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__41774,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41788.cljs$core$IFn$_invoke$arity$2 ? pred__41788.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__41789) : pred__41788.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__41789)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__41774,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__41774),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__41774){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__41774,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__41778){
var extmap__4542__auto__ = (function (){var G__41828 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__41778,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__41778)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__41828);
} else {
return G__41828;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__41778),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__41778),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__41778),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__41778),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__41778),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
