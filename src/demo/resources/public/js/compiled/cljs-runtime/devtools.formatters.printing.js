...
var len__4864__auto___42207 = arguments.length;
var i__4865__auto___42208 = (0);
while(true){
if((i__4865__auto___42208 < len__4864__auto___42207)){
args__4870__auto__.push((arguments[i__4865__auto___42208]));

var G__42209 = (i__4865__auto___42208 + (1));
i__4865__auto___42208 = G__42209;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42171){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42172,G__42173,seq42171__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42183_SHARP_){
return (!((cljs.core.meta(p1__42183_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42194__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42195){var _e__39660__auto__ = e42195;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e42197){var _e__39660__auto__ = e42197;
return false;
}}
})())){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42203__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
var temp__5751__auto___42211 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___42211)){
var managed_print_level_42212 = temp__5751__auto___42211;
var _STAR_print_level_STAR__orig_val__42205_42213 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42206_42214 = managed_print_level_42212;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42206_42214);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42204_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42204_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42205_42213);
}} else {
job_fn();
}
