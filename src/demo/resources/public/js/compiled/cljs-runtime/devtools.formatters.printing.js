...
var len__4864__auto___42217 = arguments.length;
var i__4865__auto___42218 = (0);
while(true){
if((i__4865__auto___42218 < len__4864__auto___42217)){
args__4870__auto__.push((arguments[i__4865__auto___42218]));

var G__42219 = (i__4865__auto___42218 + (1));
i__4865__auto___42218 = G__42219;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42073){
var G__42074 = cljs.core.first(seq42073);
var seq42073__$1 = cljs.core.next(seq42073);
var G__42075 = cljs.core.first(seq42073__$1);
var seq42073__$2 = cljs.core.next(seq42073__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42074,G__42075,seq42073__$2);
}));
...
if(cljs.core.truth_((function (){var or__4253__auto__ = devtools.formatters.helpers.directly_printable_QMARK_(value);
if(or__4253__auto__){
...
return cljs.core._write(writer__4492__auto__,"devtools.formatters.printing/TemplateWriter");
}));
...
if(cljs.core.truth_((function (){var and__4251__auto__ = cljs.core.not(devtools.formatters.printing.already_reference_QMARK_(group));
if(and__4251__auto__){
var or__4253__auto__ = devtools.formatters.helpers.expandable_QMARK_(obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42172_SHARP_){
return (!((cljs.core.meta(p1__42172_SHARP_) == null)));
})))){
...
if(cljs.core.truth_((function (){var and__4251__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"render-path-annotations","render-path-annotations",-1890931512));
...
var map__42196 = opts;
var map__42196__$1 = cljs.core.__destructure_map(map__42196);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42196__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42197){var _e__39827__auto__ = e42197;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e42199){var _e__39827__auto__ = e42199;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42201 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42202 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42202);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42204__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42201);
}});
...
var temp__5751__auto___42225 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___42225)){
var managed_print_level_42227 = temp__5751__auto___42225;
var _STAR_print_level_STAR__orig_val__42206_42228 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42207_42229 = managed_print_level_42227;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42207_42229);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42205_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42205_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42206_42228);
}} else {
job_fn();
}
