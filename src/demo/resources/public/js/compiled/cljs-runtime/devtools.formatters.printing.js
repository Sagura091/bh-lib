...
var len__4864__auto___22120 = arguments.length;
var i__4865__auto___22121 = (0);
while(true){
if((i__4865__auto___22121 < len__4864__auto___22120)){
args__4870__auto__.push((arguments[i__4865__auto___22121]));

var G__22122 = (i__4865__auto___22121 + (1));
i__4865__auto___22121 = G__22122;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22010){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22011,G__22012,seq22010__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22089_SHARP_){
return (!((cljs.core.meta(p1__22089_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22098__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22099){var _e__19648__auto__ = e22099;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e22101){var _e__19648__auto__ = e22101;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22105 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22106 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22106);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22109__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22105);
}});
...
var temp__5751__auto___22126 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___22126)){
var managed_print_level_22130 = temp__5751__auto___22126;
var _STAR_print_level_STAR__orig_val__22111_22131 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22112_22132 = managed_print_level_22130;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22112_22132);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__22110_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__22110_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22111_22131);
}} else {
job_fn();
}
