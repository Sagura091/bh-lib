...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52117_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__52117_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52120_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52120_SHARP_)));
}),row));
});
...
var G__52123 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__52131 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__52123,G__52131) : expound.printer.format.call(null,G__52123,G__52131));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52134_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52134_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52135_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52135_SHARP_)).length),"="));
}),header);
...
var iter__4652__auto__ = (function expound$printer$multirow_$_iter__52138(s__52139){
return (new cljs.core.LazySeq(null,(function (){
var s__52139__$1 = s__52139;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__52139__$1);
if(temp__5753__auto__){
var s__52139__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__52139__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__52139__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__52141 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__52140 = (0);
while(true){
if((i__52140 < size__4651__auto__)){
var row_idx = cljs.core._nth(c__4650__auto__,i__52140);
cljs.core.chunk_append(b__52141,(function (){var iter__4652__auto__ = ((function (i__52140,row_idx,c__4650__auto__,size__4651__auto__,b__52141,s__52139__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__52138_$_iter__52144(s__52145){
return (new cljs.core.LazySeq(null,((function (i__52140,row_idx,c__4650__auto__,size__4651__auto__,b__52141,s__52139__$2,temp__5753__auto__,split_row_contents){
return (function (){
var s__52145__$1 = s__52145;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__52145__$1);
if(temp__5753__auto____$1){
var s__52145__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__52145__$2)){
var c__4650__auto____$1 = cljs.core.chunk_first(s__52145__$2);
var size__4651__auto____$1 = cljs.core.count(c__4650__auto____$1);
var b__52147 = cljs.core.chunk_buffer(size__4651__auto____$1);
if((function (){var i__52146 = (0);
while(true){
if((i__52146 < size__4651__auto____$1)){
var col_idx = cljs.core._nth(c__4650__auto____$1,i__52146);
cljs.core.chunk_append(b__52147,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__52327 = (i__52146 + (1));
i__52146 = G__52327;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52147),expound$printer$multirow_$_iter__52138_$_iter__52144(cljs.core.chunk_rest(s__52145__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52147),null);
}
} else {
var col_idx = cljs.core.first(s__52145__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__52138_$_iter__52144(cljs.core.rest(s__52145__$2)));
}
} else {
return null;
}
...
});})(i__52140,row_idx,c__4650__auto__,size__4651__auto__,b__52141,s__52139__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__52140,row_idx,c__4650__auto__,size__4651__auto__,b__52141,s__52139__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52141),expound$printer$multirow_$_iter__52138(cljs.core.chunk_rest(s__52139__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52141),null);
}
} else {
var row_idx = cljs.core.first(s__52139__$2);
return cljs.core.cons((function (){var iter__4652__auto__ = ((function (row_idx,s__52139__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__52138_$_iter__52151(s__52152){
return (new cljs.core.LazySeq(null,(function (){
var s__52152__$1 = s__52152;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__52152__$1);
if(temp__5753__auto____$1){
var s__52152__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__52152__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__52152__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__52154 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__52153 = (0);
while(true){
if((i__52153 < size__4651__auto__)){
var col_idx = cljs.core._nth(c__4650__auto__,i__52153);
cljs.core.chunk_append(b__52154,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__52329 = (i__52153 + (1));
i__52153 = G__52329;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52154),expound$printer$multirow_$_iter__52138_$_iter__52151(cljs.core.chunk_rest(s__52152__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52154),null);
}
} else {
var col_idx = cljs.core.first(s__52152__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__52138_$_iter__52151(cljs.core.rest(s__52152__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__52139__$2,temp__5753__auto__,split_row_contents))
;
return iter__4652__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__52138(cljs.core.rest(s__52139__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52157_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__52157_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__52189 = via;
var G__52189__$1 = (((G__52189 == null))?null:cljs.core.last(G__52189));
if((G__52189__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__52189__$1);
}
})();
var keys_specs = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52187_SHARP_){
return cljs.spec.alpha.valid_QMARK_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__52187_SHARP_);
...
}),cljs.core.tree_seq(cljs.core.coll_QMARK_,cljs.core.seq,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"clauses","clauses",1454841241),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52188_SHARP_){
return cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__52188_SHARP_);
}),keys_specs)], 0))], 0))))));
}
});
expound.printer.key__GT_spec = (function expound$printer$key__GT_spec(keys,problems){
var seq__52191_52334 = cljs.core.seq(problems);
var chunk__52192_52335 = null;
var count__52193_52336 = (0);
var i__52194_52337 = (0);
while(true){
if((i__52194_52337 < count__52193_52336)){
var p_52338 = chunk__52192_52335.cljs$core$IIndexed$_nth$arity$2(null,i__52194_52337);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_52338) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__52339 = seq__52191_52334;
var G__52340 = chunk__52192_52335;
var G__52341 = count__52193_52336;
var G__52342 = (i__52194_52337 + (1));
seq__52191_52334 = G__52339;
chunk__52192_52335 = G__52340;
count__52193_52336 = G__52341;
i__52194_52337 = G__52342;
continue;
} else {
var temp__5753__auto___52343 = cljs.core.seq(seq__52191_52334);
if(temp__5753__auto___52343){
var seq__52191_52344__$1 = temp__5753__auto___52343;
if(cljs.core.chunked_seq_QMARK_(seq__52191_52344__$1)){
var c__4679__auto___52345 = cljs.core.chunk_first(seq__52191_52344__$1);
var G__52346 = cljs.core.chunk_rest(seq__52191_52344__$1);
var G__52347 = c__4679__auto___52345;
var G__52348 = cljs.core.count(c__4679__auto___52345);
var G__52349 = (0);
seq__52191_52334 = G__52346;
chunk__52192_52335 = G__52347;
count__52193_52336 = G__52348;
i__52194_52337 = G__52349;
continue;
} else {
var p_52350 = cljs.core.first(seq__52191_52344__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_52350) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__52352 = cljs.core.next(seq__52191_52344__$1);
var G__52353 = null;
var G__52354 = (0);
var G__52355 = (0);
seq__52191_52334 = G__52352;
chunk__52192_52335 = G__52353;
count__52193_52336 = G__52354;
i__52194_52337 = G__52355;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4253__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52190_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__52190_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__52204){
var vec__52206 = p__52204;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52206,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52206,(1),null);
var G__52209 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52209__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__52211 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52211,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52211,(1),null);
var G__52214 = branch;
var G__52214__$1 = (((G__52214 instanceof cljs.core.Keyword))?G__52214.fqn:null);
switch (G__52214__$1) {
case "simple":
return new cljs.core.Keyword(null,"kw","kw",1158308175).cljs$core$IFn$_invoke$arity$1(match);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52214__$1)].join('')));
...
var len__4864__auto___52363 = arguments.length;
var i__4865__auto___52364 = (0);
while(true){
if((i__4865__auto___52364 < len__4864__auto___52363)){
args__4870__auto__.push((arguments[i__4865__auto___52364]));

var G__52365 = (i__4865__auto___52364 + (1));
i__4865__auto___52364 = G__52365;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq52222){
var G__52223 = cljs.core.first(seq52222);
var seq52222__$1 = cljs.core.next(seq52222);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52223,seq52222__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52233_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__52233_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__52234_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__52234_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52236){
var vec__52237 = p__52236;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52237,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52237,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52243_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__52243_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__52272 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
var seq__52273 = cljs.core.seq(vec__52272);
var first__52274 = cljs.core.first(seq__52273);
var seq__52273__$1 = cljs.core.next(seq__52273);
var line = first__52274;
var lines = seq__52273__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52269_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52269_SHARP_)].join('');
}),lines)));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__52286 = show_valid_values_QMARK_;
var G__52287 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__52288 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__52286,G__52287,G__52288) : expound.printer.summary_form.call(null,G__52286,G__52287,G__52288));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__52367 = show_valid_values_QMARK_;
var G__52368 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__52369 = rst__$1;
show_valid_values_QMARK_ = G__52367;
form = G__52368;
in$ = G__52369;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__52289 = show_valid_values_QMARK_;
var G__52290 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__52291 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__52289,G__52290,G__52291) : expound.printer.summary_form.call(null,G__52289,G__52290,G__52291));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__52294 = show_valid_values_QMARK_;
var G__52295 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__52296 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__52294,G__52295,G__52296) : expound.printer.summary_form.call(null,G__52294,G__52295,G__52296));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__52297 = show_valid_values_QMARK_;
var G__52298 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__52299 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__52297,G__52298,G__52299) : expound.printer.summary_form.call(null,G__52297,G__52298,G__52299));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__52301 = show_valid_values_QMARK_;
var G__52302 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__52303 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__52301,G__52302,G__52303) : expound.printer.summary_form.call(null,G__52301,G__52302,G__52303));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52305_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52305_SHARP_)).length);
...
var map__52308 = problem;
var map__52308__$1 = cljs.core.__destructure_map(map__52308);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52308__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52308__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__52309 = opts;
var map__52309__$1 = cljs.core.__destructure_map(map__52309);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52309__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__52313 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__52314 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__52314);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__52313);
}})();
var vec__52310 = cljs.core.re_find(regex,s);
var seq__52311 = cljs.core.seq(vec__52310);
var first__52312 = cljs.core.first(seq__52311);
var seq__52311__$1 = cljs.core.next(seq__52311);
var line = first__52312;
var first__52312__$1 = cljs.core.first(seq__52311__$1);
var seq__52311__$2 = cljs.core.next(seq__52311__$1);
var prefix = first__52312__$1;
var _more = seq__52311__$2;
