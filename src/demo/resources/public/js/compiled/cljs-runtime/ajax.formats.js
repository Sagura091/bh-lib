...
var G__69630 = request;
var G__69631 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__69630,G__69631) : ajax.formats.get_format.call(null,G__69630,G__69631));
} else {
...
return cljs.core.some((function (p1__69642_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__69642_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__69643){
var map__69644 = p__69643;
var map__69644__$1 = cljs.core.__destructure_map(map__69644);
var request = map__69644__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69644__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__69652 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__69652.cljs$core$IFn$_invoke$arity$1 ? fexpr__69652.cljs$core$IFn$_invoke$arity$1(response) : fexpr__69652.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__69654){
var map__69655 = p__69654;
var map__69655__$1 = cljs.core.__destructure_map(map__69655);
var request = map__69655__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69655__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__69653_SHARP_){
return ajax.formats.get_accept_entries(request,p1__69653_SHARP_);
