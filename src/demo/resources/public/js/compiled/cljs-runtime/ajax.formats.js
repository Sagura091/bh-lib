...
var G__42425 = request;
var G__42426 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__42425,G__42426) : ajax.formats.get_format.call(null,G__42425,G__42426));
} else {
...
return cljs.core.some((function (p1__42477_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__42477_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__42479){
var map__42480 = p__42479;
var map__42480__$1 = cljs.core.__destructure_map(map__42480);
var request = map__42480__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42480__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__42486 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__42486.cljs$core$IFn$_invoke$arity$1 ? fexpr__42486.cljs$core$IFn$_invoke$arity$1(response) : fexpr__42486.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__42490){
var map__42491 = p__42490;
var map__42491__$1 = cljs.core.__destructure_map(map__42491);
var request = map__42491__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42491__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__42488_SHARP_){
return ajax.formats.get_accept_entries(request,p1__42488_SHARP_);
