...
var G__69520 = request;
var G__69521 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__69520,G__69521) : ajax.formats.get_format.call(null,G__69520,G__69521));
} else {
...
return cljs.core.some((function (p1__69532_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__69532_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__69540){
var map__69541 = p__69540;
var map__69541__$1 = cljs.core.__destructure_map(map__69541);
var request = map__69541__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69541__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__69550 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__69550.cljs$core$IFn$_invoke$arity$1 ? fexpr__69550.cljs$core$IFn$_invoke$arity$1(response) : fexpr__69550.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__69562){
var map__69564 = p__69562;
var map__69564__$1 = cljs.core.__destructure_map(map__69564);
var request = map__69564__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69564__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__69553_SHARP_){
return ajax.formats.get_accept_entries(request,p1__69553_SHARP_);
