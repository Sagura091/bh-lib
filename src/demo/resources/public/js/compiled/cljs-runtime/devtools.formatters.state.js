...
var len__4864__auto___41942 = arguments.length;
var i__4865__auto___41943 = (0);
while(true){
if((i__4865__auto___41943 < len__4864__auto___41942)){
args__4870__auto__.push((arguments[i__4865__auto___41943]));

var G__41944 = (i__4865__auto___41943 + (1));
i__4865__auto___41943 = G__41944;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq41866){
var G__41867 = cljs.core.first(seq41866);
var seq41866__$1 = cljs.core.next(seq41866);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41867,seq41866__$1);
}));
...
return cljs.core.some((function (p1__41878_SHARP_){
return (p1__41878_SHARP_ === object);
}),history);
});
...
var args__4870__auto__ = [];
var len__4864__auto___41945 = arguments.length;
var i__4865__auto___41946 = (0);
while(true){
if((i__4865__auto___41946 < len__4864__auto___41945)){
args__4870__auto__.push((arguments[i__4865__auto___41946]));

var G__41947 = (i__4865__auto___41946 + (1));
i__4865__auto___41946 = G__41947;
continue;
} else {
}
break;
...
(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__41892){
var vec__41893 = p__41892;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41893,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq41882){
var G__41883 = cljs.core.first(seq41882);
var seq41882__$1 = cljs.core.next(seq41882);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41883,seq41882__$1);
}));

devtools.formatters.state.seek_path_segment = (function devtools$formatters$state$seek_path_segment(var_args){
var args__4870__auto__ = [];
var len__4864__auto___41949 = arguments.length;
var i__4865__auto___41950 = (0);
while(true){
if((i__4865__auto___41950 < len__4864__auto___41949)){
args__4870__auto__.push((arguments[i__4865__auto___41950]));

var G__41951 = (i__4865__auto___41950 + (1));
i__4865__auto___41950 = G__41951;
continue;
} else {
}
break;
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__41918){
var vec__41919 = p__41918;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41919,(0),null);
...
var _STAR_ = (function (p__41922){
var vec__41923 = p__41922;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41923,(0),null);
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq41907){
var G__41908 = cljs.core.first(seq41907);
var seq41907__$1 = cljs.core.next(seq41907);
var G__41909 = cljs.core.first(seq41907__$1);
var seq41907__$2 = cljs.core.next(seq41907__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41908,G__41909,seq41907__$2);
}));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4253__auto__ = path;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return cljs.core.PersistentVector.EMPTY;
...
var or__4253__auto__ = devtools.formatters.state.ignore_path_in_fake_vector(parent_object,object,path_info);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var or__4253__auto____$1 = devtools.formatters.state.find_path_in_fake_vector(parent_object,path_info);
if(cljs.core.truth_(or__4253__auto____$1)){
return or__4253__auto____$1;
} else {
var or__4253__auto____$2 = devtools.formatters.state.find_path(parent_object,object,path_info);
