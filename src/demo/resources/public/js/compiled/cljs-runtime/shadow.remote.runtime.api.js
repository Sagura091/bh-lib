...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_60861 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_60861(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_60862 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_60862(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_60863 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_60863(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_60864 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_60864(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_60865 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_60865(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_60866 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_60866(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__60852,callback){
var map__60853 = p__60852;
var map__60853__$1 = cljs.core.__destructure_map(map__60853);
var input = map__60853__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60853__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60853__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
