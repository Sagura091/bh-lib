...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__50451_SHARP_,p2__50452_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__50451_SHARP_,p2__50452_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function re_com$tour$initialise_tour_$_iter__50456(s__50457){
return (new cljs.core.LazySeq(null,(function (){
var s__50457__$1 = s__50457;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__50457__$1);
if(temp__5753__auto__){
var s__50457__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50457__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__50457__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__50459 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__50458 = (0);
while(true){
if((i__50458 < size__4651__auto__)){
var step = cljs.core._nth(c__4650__auto__,i__50458);
cljs.core.chunk_append(b__50459,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__50475 = (i__50458 + (1));
i__50458 = G__50475;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50459),re_com$tour$initialise_tour_$_iter__50456(cljs.core.chunk_rest(s__50457__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50459),null);
}
} else {
var step = cljs.core.first(s__50457__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__50456(cljs.core.rest(s__50457__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__50464 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__50464.cljs$core$IFn$_invoke$arity$1 ? fexpr__50464.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__50464.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__50465 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__50465.cljs$core$IFn$_invoke$arity$1 ? fexpr__50465.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__50465.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__50466 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__50466.cljs$core$IFn$_invoke$arity$1 ? fexpr__50466.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__50466.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__50470 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__50470.cljs$core$IFn$_invoke$arity$1 ? fexpr__50470.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__50470.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__50471 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__50471.cljs$core$IFn$_invoke$arity$1 ? fexpr__50471.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__50471.call(null,tour));
})(),true);
} else {
return null;
}
