goog.provide('rccst_ui_component.atom.example.misc.bh.meta_bh_table');
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"rccst-ui-component.atom.example.misc.bh.meta-bh-table",null,12,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["rccst-ui-component.atom.example.misc.meta-bh-table"], null);
}),null)),null,-754019303,null);
...
return cljs.core.reset_BANG_(rccst_ui_component.atom.example.misc.bh.meta_bh_table.data,ui_component.atom.bhui.table.sample_meta_data);
...
return cljs.core.reset_BANG_(rccst_ui_component.atom.example.misc.bh.meta_bh_table.data,(ui_component.atom.bhui.table.random_data_meta.cljs$core$IFn$_invoke$arity$0 ? ui_component.atom.bhui.table.random_data_meta.cljs$core$IFn$_invoke$arity$0() : ui_component.atom.bhui.table.random_data_meta.call(null)));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(rccst_ui_component.atom.example.misc.bh.meta_bh_table.data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),(0),new cljs.core.Keyword(null,"uv","uv",-1197749379)], null),(10000));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(rccst_ui_component.atom.example.misc.bh.meta_bh_table.data,cljs.core.assoc,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(rccst_ui_component.atom.example.misc.bh.meta_bh_table.data)),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"Page Q",new cljs.core.Keyword(null,"uv","uv",-1197749379),(1100),new cljs.core.Keyword(null,"pv","pv",55024340),(1100),new cljs.core.Keyword(null,"tv","tv",-1805207359),(1100),new cljs.core.Keyword(null,"amt","amt",-1785711538),(1100)], null)));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(rccst_ui_component.atom.example.misc.bh.meta_bh_table.data,cljs.core.assoc,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2((2),new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(rccst_ui_component.atom.example.misc.bh.meta_bh_table.data)))));
...
}),new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(rccst_ui_component.atom.example.misc.bh.meta_bh_table.data))))));
}),new cljs.core.Keyword(null,"label","label",1718410804),"Add :new-item"], null)], null)], null);
});
rccst_ui_component.atom.example.misc.bh.meta_bh_table.data_update_example = (function rccst_ui_component$atom$example$misc$bh$meta_bh_table$data_update_example(var_args){
...
return rccst_ui_component.atom.example.misc.bh.meta_bh_table.data_update_example.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});

(rccst_ui_component.atom.example.misc.bh.meta_bh_table.data_update_example.cljs$core$IFn$_invoke$arity$variadic = (function (p__59501){
var map__59502 = p__59501;
var map__59502__$1 = cljs.core.__destructure_map(map__59502);
var params = map__59502__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59502__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var container_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59502__$1,new cljs.core.Keyword(null,"container-id","container-id",1274665684));
var component_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59502__$1,new cljs.core.Keyword(null,"component-id","component-id",1551113783));
var d = ui_component.utils.helpers.resolve_value(data);
return (function (){
return new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"src","src",-1651076051),(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"rccst_ui_component/atom/example/misc/bh/meta_bh_table.cljs",new cljs.core.Keyword(null,"line","line",212345235),49], null)),new cljs.core.Keyword(null,"class","class",-2030961996),"data-update-example",new cljs.core.Keyword(null,"gap","gap",80255254),"10px",new cljs.core.Keyword(null,"width","width",-384071477),"100%",new cljs.core.Keyword(null,"height","height",1025178622),"100%",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.chart-part","div.chart-part",1045862618),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),"100%",new cljs.core.Keyword(null,"height","height",1025178622),"90%"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [ui_component.atom.bhui.table.table,new cljs.core.Keyword(null,"data","data",-232669377),d], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.data-tools-part","div.data-tools-part",1281903232),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"width","width",-384071477),"100%"], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [rccst_ui_component.atom.example.misc.bh.meta_bh_table.data_tools], null)], null)], null)], null);
});
}));

(rccst_ui_component.atom.example.misc.bh.meta_bh_table.data_update_example.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(rccst_ui_component.atom.example.misc.bh.meta_bh_table.data_update_example.cljs$lang$applyTo = (function (seq59500){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq59500));
}));

rccst_ui_component.atom.example.misc.bh.meta_bh_table.example = (function rccst_ui_component$atom$example$misc$bh$meta_bh_table$example(){
var component_id = "table-with-meta-demo";
return woolybear.ad.demo.src.catalog.utils.demo.cljs$core$IFn$_invoke$arity$variadic("Basic Table with meta-data",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Table using HTML tags. Data is provided in a ratom.\n\nNow with meta-data!\n\n> This example also takes advantage of the component's ability to present data that it gets\n> from it's parent either\n> directly, via a Clojure [atom](https://clojure.org/reference/atoms), or via a\n> re-frame [subscription](https://day8.github.io/re-frame/subscriptions/) to state held\n> by the parent (container).\n\n> Feel free to use the controls at the bottom to change the data and see how the Table responds.",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [woolybear.ad.layout.centered,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"extra-classes","extra-classes",-630819843),new cljs.core.Keyword(null,"width-50","width-50",718512332)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [rccst_ui_component.atom.example.misc.bh.meta_bh_table.data_update_example,new cljs.core.Keyword(null,"data","data",-232669377),rccst_ui_component.atom.example.misc.bh.meta_bh_table.data], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol("table","table","table/table",1267492441,null),new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Symbol("table","sample-meta-data","table/sample-meta-data",-2018103256,null)], null)], 0));
});

//# sourceMappingURL=rccst_ui_component.atom.example.misc.bh.meta_bh_table.js.map
