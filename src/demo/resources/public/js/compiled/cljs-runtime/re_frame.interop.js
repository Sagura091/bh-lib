...
return [(function (){var pred__23576 = cljs.core.instance_QMARK_;
var expr__23577 = reactive_val;
if(cljs.core.truth_((pred__23576.cljs$core$IFn$_invoke$arity$2 ? pred__23576.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__23577) : pred__23576.call(null,reagent.ratom.RAtom,expr__23577)))){
return "ra";
} else {
if(cljs.core.truth_((pred__23576.cljs$core$IFn$_invoke$arity$2 ? pred__23576.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__23577) : pred__23576.call(null,reagent.ratom.RCursor,expr__23577)))){
return "rc";
} else {
if(cljs.core.truth_((pred__23576.cljs$core$IFn$_invoke$arity$2 ? pred__23576.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__23577) : pred__23576.call(null,reagent.ratom.Reaction,expr__23577)))){
return "rx";
} else {
if(cljs.core.truth_((pred__23576.cljs$core$IFn$_invoke$arity$2 ? pred__23576.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__23577) : pred__23576.call(null,reagent.ratom.Track,expr__23577)))){
return "tr";
} else {
return "other";
}
