...
}catch (e42522){var _e__39827__auto__ = e42522;
return false;
...
}catch (e42524){var _e__39827__auto__ = e42524;
return false;
...
}catch (e42526){var _e__39827__auto__ = e42526;
return false;
...
}catch (e42528){var _e__39827__auto__ = e42528;
return false;
...
}catch (e42530){var _e__39827__auto__ = e42530;
return false;
}})())){
...
}catch (e42536){var _e__39827__auto__ = e42536;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__42538 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42539 = (function (){var or__4253__auto__ = config;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42539);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42538);
}});
});
...
while (G__42560__i < G__42560__a.length) {G__42560__a[G__42560__i] = arguments[G__42560__i + 0]; ++G__42560__i;}
  args = new cljs.core.IndexedSeq(G__42560__a,0,null);
} 
