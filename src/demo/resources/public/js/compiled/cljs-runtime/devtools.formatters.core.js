...
var and__4251__auto__ = cljs.core.not(devtools.formatters.state.prevent_recursion_QMARK_());
if(and__4251__auto__){
var or__4253__auto__ = devtools.formatters.helpers.cljs_value_QMARK_(value);
...
}catch (e42522){var _e__39660__auto__ = e42522;
return false;
...
}catch (e42524){var _e__39660__auto__ = e42524;
return false;
...
}catch (e42526){var _e__39660__auto__ = e42526;
return false;
...
}catch (e42528){var _e__39660__auto__ = e42528;
return false;
...
}catch (e42530){var _e__39660__auto__ = e42530;
return false;
}})())){
...
}catch (e42532){var _e__39660__auto__ = e42532;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__42534 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42535 = (function (){var or__4253__auto__ = config;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42535);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42534);
}});
});
...
return (function() { 
var G__42547__delegate = function (args){
...
var G__42547 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__42550__i = 0, G__42550__a = new Array(arguments.length -  0);
while (G__42550__i < G__42550__a.length) {G__42550__a[G__42550__i] = arguments[G__42550__i + 0]; ++G__42550__i;}
  args = new cljs.core.IndexedSeq(G__42550__a,0,null);
} 
return G__42547__delegate.call(this,args);};
G__42547.cljs$lang$maxFixedArity = 0;
G__42547.cljs$lang$applyTo = (function (arglist__42551){
var args = cljs.core.seq(arglist__42551);
return G__42547__delegate(args);
});
G__42547.cljs$core$IFn$_invoke$arity$variadic = G__42547__delegate;
return G__42547;
})()
;
});
...
var pre_handler = (function (){var or__4253__auto__ = devtools.prefs.pref(pre_handler_key);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
var post_handler = (function (){var or__4253__auto__ = devtools.prefs.pref(post_handler_key);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return cljs.core.identity;
