(ns demo.catalog.technologies.overview.re-frame
  (:require [demo.catalog.technologies.overview.overview :as o]))

(defn overview []
      (o/overview "Re-frame"

"#### _A framework for building Modern Web Apps in ClojureScript_
...
functions you provide. Each iteration of the re-frame loop has 6 stages, and these stages happen one after another. These
stages are: 
