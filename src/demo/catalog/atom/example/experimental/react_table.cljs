...
(def data {:meta-data {:table-type :standard  ;specify table type, :standard or :expandable
...
(def group-data {:meta-data {:table-type :expandable  ;specify table type, :standard or :expandable
                  ...
                  :data      [{:Symbol "#FFFF00" :time 0 :include false :AoI "Fire-prst-001"}
...
(defn standard-table []
  (acu/demo
    ...
    [layout/centered {:extra-classes :width-50}
     [react-table/table-component :config config :data data]]))

(defn expandable-table []
  (acu/demo
    "React-Table Expandable Table"
    [layout/centered {:extra-classes :width-50}
     [react-table/table-component :config config  :data group-data]]))