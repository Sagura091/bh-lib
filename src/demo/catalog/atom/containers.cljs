(ns demo.catalog.atom.containers
  "demo.catalog and demonstrations of available container components."
...
; TODO: do we need this in an RCCST namespace, or can we just grab it from woolybear/demo.catalog?
