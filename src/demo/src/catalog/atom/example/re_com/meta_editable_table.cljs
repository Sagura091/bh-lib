(ns demo.src.catalog.atom.example.re-com.meta-editable-table
...
(log/info "demo.src.catalog.atom.example.re-com.meta-editable-table")


(defonce data table/meta-sample-data)
