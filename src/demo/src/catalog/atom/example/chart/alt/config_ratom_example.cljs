(ns demo.src.catalog.atom.example.chart.alt.config-ratom-example
  (:require [bh-ui.atom.chart.utils :as chart-utils]
            [demo.src.catalog.atom.utils :as example]
...
(log/info "demo.src.catalog.atom.example.chart.alt.config-ratom-example")
