(ns demo.src.catalog.atom.example.forms.error-text-input
    ...
    [layout/padded
     [forms/field-group
      ...
      [forms/text-input {:id                          "demo-4-a"
                         ...
                         :component-data-path         [:demo.src.catalog :forms-demo "4a"]
     ...
     [forms/field-group
      ...
      [forms/text-input {:id                          "demo-4-b"
                         ...
                         :component-data-path         [:demo.src.catalog :forms-demo "4b"]
     ...
     [forms/field-group
      ...
      [forms/text-input {:id                          "demo-4-c"
                         ...
                         :component-data-path         [:demo.src.catalog :forms-demo "4c"]
