(ns demo.src.catalog.atom.all
  "atom and acu/demonstrations of all available UI components."
  (:require [re-com.core :as rc]

            [demo.src.catalog.atom.example.layout.page :as page]
            ...
            [demo.src.catalog.atom.example.icons.simple-image :as simple-image]
            ...
            [demo.src.catalog.atom.example.forms.simple-form-label :as simple-label]
            [demo.src.catalog.atom.example.forms.required-form-label :as required-label]
            [demo.src.catalog.atom.example.forms.text-input :as text-input]
            [demo.src.catalog.atom.example.forms.password-input :as pass-input]
            [demo.src.catalog.atom.example.forms.placeholder-text-input :as place-text-input]
            [demo.src.catalog.atom.example.forms.disabled-text-input :as disabled-text-input]
            [demo.src.catalog.atom.example.forms.error-text-input :as error-text-input]
            [demo.src.catalog.atom.example.forms.simple-select-input :as simple-select-input]
            [demo.src.catalog.atom.example.forms.custom-select-input :as custom-select-input]
            [demo.src.catalog.atom.example.forms.disabled-select-input :as disabled-select-input]
            [demo.src.catalog.atom.example.forms.multi-select-input :as multi-select-input]
            [demo.src.catalog.atom.example.forms.checkbox :as checkbox]
            [demo.src.catalog.atom.example.forms.disabled-checkbox :as disabled-checkbox]
            ...
            ;[demo.src.catalog.atom.example.chart.colored-pie-chart :as colored-piechart]

            [demo.src.catalog.atom.example.re-com.table :as table]
            [demo.src.catalog.atom.example.re-com.alert-box :as alert-box]
            [demo.src.catalog.atom.example.re-com.line :as line]))
